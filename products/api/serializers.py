...
from products.models import Product, ProductImage, Category, Brand # Removed Seller from here
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'stock', 'available', 'weight', 'image', # Changed from primary_image_url to image
            'category', 'brand', 'seller', 'is_discounted' # Added category, brand, seller, is_discounted
        ]
