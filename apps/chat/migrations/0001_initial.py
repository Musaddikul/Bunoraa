# Generated by Django 5.2.1 on 2026-01-07 07:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bot_avatar', models.ImageField(blank=True, null=True, storage=storages.backends.s3.S3Storage(), upload_to='chat/bot/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('agent', models.ForeignKey(blank=True, help_text='Null = shared across all agents', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='canned_responses', to='chat.chatagent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('agent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='conversations', to='chat.chatagent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_type', models.CharField(choices=[('text', 'Text'), ('image', 'Image'), ('file', 'File'), ('system', 'System Message'), ('ai', 'AI Response'), ('canned', 'Canned Response')], default='text', max_length=20)),
                ('content', models.TextField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('file', models.FileField(storage=storages.backends.s3.S3Storage(), upload_to='chat/attachments/%Y/%m/')),
                ('file_name', models.CharField(max_length=255)),
                ('file_type', models.CharField(max_length=100)),
                ('file_size', models.PositiveIntegerField()),
                ('thumbnail', models.ImageField(blank=True, null=True, storage=storages.backends.s3.S3Storage(), upload_to='chat/thumbnails/%Y/%m/')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['is_online', 'is_accepting_chats'], name='chat_chatag_is_onli_bb1593_idx'),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['customer', 'status'], name='chat_conver_custome_1205e5_idx'),
        ),
        migrations.AddIndex(
            model_name='conversation',
