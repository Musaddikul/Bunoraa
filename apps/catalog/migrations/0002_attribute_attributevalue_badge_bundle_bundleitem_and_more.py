...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="ecocertification",
            index=models.Index(fields=["slug"], name="catalog_eco_slug_4772c3_idx"),
        ),
        migrations.AddIndex(
            model_name="facet",
            index=models.Index(fields=["slug"], name="catalog_fac_slug_d51371_idx"),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="products", to="catalog.ecocertification"
            ),
        ),
        migrations.AddField(
            model_name="product",
        ...
        migrations.AddField(
            ...
            name="products",
            field=models.ManyToManyField(related_name="compares", to="catalog.product"),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="value",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="catalog.attributevalue"
            ),
        ),
        migrations.AddField(
            model_name="product",
        ...
        migrations.AddField(
            ...
            name="currency",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="catalog.currency"
            ),
        ),
        migrations.AddField(
            model_name="productprice",
        ...
        migrations.AddIndex(
            model_name="shippingmaterial",
            index=models.Index(fields=["name"], name="catalog_shi_name_05374a_idx"),
        ),
        migrations.AddField(
            model_name="product",
        ...
        migrations.AddField(
            ...
            name="option_value",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="catalog.optionvalue"
            ),
        ),
        migrations.AddField(
            model_name="variantoptionvalue",
