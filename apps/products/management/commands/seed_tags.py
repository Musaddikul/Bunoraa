"""Management command to seed Tag objects from a JSON or newline-separated file.

Usage:
  python manage.py seed_tags --file=apps/products/data/tags.json
  python manage.py seed_tags           # uses built-in defaults
  python manage.py seed_tags --file=... --overwrite   # delete existing tags first
...
class Command(BaseCommand):
    help = 'Seed product tags from a JSON array or newline-separated text file. If no file is provided inserts a small default list.'
