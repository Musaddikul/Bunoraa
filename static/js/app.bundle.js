(()=>{var Xs=Object.create;var pe=Object.defineProperty;var Ks=Object.getOwnPropertyDescriptor;var Zs=Object.getOwnPropertyNames;var er=Object.getPrototypeOf,tr=Object.prototype.hasOwnProperty;var Ge=n=>e=>{var t=n[e];if(t)return t();throw new Error("Module not found in bundle: "+e)};var Q=(n,e)=>()=>(n&&(e=n(n=0)),e);var Je=(n,e)=>()=>(e||n((e={exports:{}}).exports,e),e.exports),J=(n,e)=>{for(var t in e)pe(n,t,{get:e[t],enumerable:!0})},sr=(n,e,t,o)=>{if(e&&typeof e=="object"||typeof e=="function")for(let g of Zs(e))!tr.call(n,g)&&g!==t&&pe(n,g,{get:()=>e[g],enumerable:!(o=Ks(e,g))||o.enumerable});return n};var rr=(n,e,t)=>(t=n!=null?Xs(er(n)):{},sr(e||!n||!n.__esModule?pe(t,"default",{value:n,enumerable:!0}):t,n));function H(...n){return n.flat().filter(e=>e&&typeof e=="string").join(" ")}function F(n="div",{id:e="",className:t="",attrs:o={},html:g="",text:b=""}={}){let k=document.createElement(n);return e&&(k.id=e),t&&(k.className=t),b&&(k.textContent=b),g&&(k.innerHTML=g),Object.entries(o).forEach(([A,q])=>{q===!0?k.setAttribute(A,""):q!==!1&&q!==null&&k.setAttribute(A,q)}),k}function Xe(n,e,t,o={}){if(n)return n.addEventListener(e,t,o),()=>n.removeEventListener(e,t,o)}function ce(n){let e=n.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'),t=e[0],o=e[e.length-1];return{init(){n.addEventListener("keydown",g=>{g.key==="Tab"&&(g.shiftKey?document.activeElement===t&&(g.preventDefault(),o.focus()):document.activeElement===o&&(g.preventDefault(),t.focus()))})},destroy(){}}}function Ke(){return"id-"+Math.random().toString(36).substr(2,9)+Date.now().toString(36)}function ie(n=""){return F("div",{className:H("fixed inset-0 bg-black bg-opacity-50 z-40 transition-opacity duration-200",n),attrs:{"data-backdrop":"true"}})}var ue,K=Q(()=>{ue={isEnter:n=>n.key==="Enter",isEscape:n=>n.key==="Escape",isArrowUp:n=>n.key==="ArrowUp",isArrowDown:n=>n.key==="ArrowDown",isArrowLeft:n=>n.key==="ArrowLeft",isArrowRight:n=>n.key==="ArrowRight",isSpace:n=>n.key===" ",isTab:n=>n.key==="Tab"}});var z,Z=Q(()=>{K();z=class n{constructor(e={}){this.id=e.id||Ke(),this.element=null,this.listeners=[],this.isInitialized=!1,this.config=e}create(e="div",{className:t="",attrs:o={},html:g=""}={}){return this.element=F(e,{id:this.id,className:t,attrs:o,html:g}),this.element}mount(e){if(!this.element)return!1;let t=typeof e=="string"?document.querySelector(e):e;return t?(t.appendChild(this.element),this.isInitialized=!0,!0):!1}on(e,t,o={}){if(!this.element)return;let g=Xe(this.element,e,t,o);return this.listeners.push(g),g}delegate(e,t,o){if(!this.element)return;let g=b=>{let k=b.target.closest(e);k&&o.call(k,b)};this.element.addEventListener(t,g),this.listeners.push(()=>this.element.removeEventListener(t,g))}addClass(...e){this.element&&this.element.classList.add(...e)}removeClass(...e){this.element&&this.element.classList.remove(...e)}toggleClass(e,t){this.element&&this.element.classList.toggle(e,t)}hasClass(e){return this.element?.classList.contains(e)??!1}attr(e,t){if(this.element){if(t===void 0)return this.element.getAttribute(e);t===null||t===!1?this.element.removeAttribute(e):t===!0?this.element.setAttribute(e,""):this.element.setAttribute(e,t)}}attrs(e){Object.entries(e).forEach(([t,o])=>{this.attr(t,o)})}text(e){this.element&&(this.element.textContent=e)}html(e){this.element&&(this.element.innerHTML=e)}append(e){this.element&&e&&this.element.appendChild(e instanceof n?e.element:e)}prepend(e){this.element&&e&&this.element.prepend(e instanceof n?e.element:e)}show(){this.element&&(this.element.style.display="",this.element.removeAttribute("hidden"))}hide(){this.element&&(this.element.style.display="none")}toggle(e){this.element&&(e===void 0&&(e=this.element.style.display==="none"),e?this.show():this.hide())}getStyle(e){return this.element?window.getComputedStyle(this.element).getPropertyValue(e):null}setStyle(e,t){this.element&&(this.element.style[e]=t)}setStyles(e){Object.entries(e).forEach(([t,o])=>{this.setStyle(t,o)})}focus(e){if(this.element)try{typeof e>"u"?this.element.focus({preventScroll:!0}):this.element.focus(e)}catch{try{this.element.focus()}catch{}}}blur(){this.element&&this.element.blur()}getPosition(){return this.element?this.element.getBoundingClientRect():null}destroy(){this.listeners.forEach(e=>e?.()),this.listeners=[],this.element?.parentNode&&this.element.parentNode.removeChild(this.element),this.element=null,this.isInitialized=!1}init(){this.element&&!this.isInitialized&&(this.isInitialized=!0)}render(){return this.element}}});var Ze={};J(Ze,{Alert:()=>ge});var ge,et=Q(()=>{Z();K();ge=class extends z{constructor(e={}){super(e),this.title=e.title||"",this.message=e.message||"",this.type=e.type||"default",this.icon=e.icon||null,this.closeable=e.closeable||!1,this.className=e.className||""}create(){let e={default:{bg:"bg-blue-50",border:"border-blue-200",title:"text-blue-900",message:"text-blue-800",icon:"\u24D8"},success:{bg:"bg-green-50",border:"border-green-200",title:"text-green-900",message:"text-green-800",icon:"\u2713"},warning:{bg:"bg-yellow-50",border:"border-yellow-200",title:"text-yellow-900",message:"text-yellow-800",icon:"\u26A0"},error:{bg:"bg-red-50",border:"border-red-200",title:"text-red-900",message:"text-red-800",icon:"\u2715"},info:{bg:"bg-cyan-50",border:"border-cyan-200",title:"text-cyan-900",message:"text-cyan-800",icon:"\u2139"}},t=e[this.type]||e.default,g=super.create("div",{className:H("p-4 rounded-lg border-2",t.bg,t.border,this.className),attrs:{role:"alert"}}),b="";return(this.title||this.icon)&&(b+='<div class="flex items-center gap-3 mb-2">',this.icon,b+=`<span class="text-xl font-bold ${t.title}">${this.icon||t.icon}</span>`,this.title&&(b+=`<h4 class="font-semibold ${t.title}">${this.title}</h4>`),b+="</div>"),this.message&&(b+=`<p class="${t.message}">${this.message}</p>`),this.closeable&&(b+='<button class="absolute top-4 right-4 text-gray-400 hover:text-gray-600" aria-label="Close alert">\xD7</button>'),g.innerHTML=b,this.closeable&&g.querySelector("button")?.addEventListener("click",()=>{this.destroy()}),g}setMessage(e){if(this.message=e,this.element){let t=this.element.querySelector("p");t&&(t.textContent=e)}}}});var tt={};J(tt,{AlertDialog:()=>he});var he,st=Q(()=>{Z();K();he=class extends z{constructor(e={}){super(e),this.title=e.title||"",this.message=e.message||"",this.confirmText=e.confirmText||"Confirm",this.cancelText=e.cancelText||"Cancel",this.type=e.type||"warning",this.onConfirm=e.onConfirm||null,this.onCancel=e.onCancel||null,this.open=e.open||!1}create(){let e=super.create("div",{className:H("fixed inset-0 z-50 flex items-center justify-center",this.open?"":"hidden"),attrs:{role:"alertdialog","aria-modal":"true","aria-labelledby":`${this.id}-title`,"aria-describedby":`${this.id}-message`}}),t=ie();e.appendChild(t);let o=document.createElement("div");o.className="bg-white rounded-lg shadow-lg relative z-50 w-full max-w-md mx-4";let g=document.createElement("div");g.className="px-6 py-4 border-b border-gray-200";let b=document.createElement("h2");b.id=`${this.id}-title`,b.className="text-lg font-semibold text-gray-900",b.textContent=this.title,g.appendChild(b),o.appendChild(g);let k=document.createElement("div");k.id=`${this.id}-message`,k.className="px-6 py-4 text-gray-700",k.textContent=this.message,o.appendChild(k);let A=document.createElement("div");A.className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex gap-3 justify-end rounded-b-lg";let q=document.createElement("button");q.className="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-100 transition-colors duration-200",q.textContent=this.cancelText,q.addEventListener("click",()=>this.handleCancel()),A.appendChild(q);let R=document.createElement("button"),Y=this.type==="danger"?"bg-red-600 text-white hover:bg-red-700":"bg-blue-600 text-white hover:bg-blue-700";return R.className=H("px-4 py-2 rounded-md transition-colors duration-200",Y),R.textContent=this.confirmText,R.addEventListener("click",()=>this.handleConfirm()),A.appendChild(R),o.appendChild(A),e.appendChild(o),this.focusTrap=ce(o),e}open(){this.element||this.create(),this.open=!0,this.element.classList.remove("hidden"),this.focusTrap.init(),document.body.style.overflow="hidden"}close(){this.open=!1,this.element?.classList.add("hidden"),document.body.style.overflow=""}handleConfirm(){this.onConfirm&&this.onConfirm(),this.close()}handleCancel(){this.onCancel&&this.onCancel(),this.close()}}});var rt={};J(rt,{Avatar:()=>fe});var fe,at=Q(()=>{Z();K();fe=class extends z{constructor(e={}){super(e),this.src=e.src||"",this.alt=e.alt||"",this.initials=e.initials||"",this.size=e.size||"md",this.className=e.className||"",this.fallbackBg=e.fallbackBg||"bg-blue-600"}create(){let e={xs:"w-6 h-6 text-xs",sm:"w-8 h-8 text-sm",md:"w-10 h-10 text-base",lg:"w-12 h-12 text-lg",xl:"w-16 h-16 text-xl"},t="rounded-full overflow-hidden flex items-center justify-center flex-shrink-0 font-semibold";return this.src?super.create("img",{className:H(t,e[this.size],this.className),attrs:{src:this.src,alt:this.alt,role:"img"}}):this.initials?super.create("div",{className:H(t,e[this.size],"text-white",this.fallbackBg,this.className),text:this.initials.toUpperCase()}):super.create("div",{className:H(t,e[this.size],"bg-gray-300",this.className),html:'<svg class="w-full h-full text-gray-500" fill="currentColor" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>'})}setSrc(e,t=""){this.src=e,this.alt=t,this.element&&this.element.tagName==="IMG"&&(this.element.src=e,this.element.alt=t)}setInitials(e,t=""){if(this.initials=e,t&&(this.fallbackBg=t),this.element&&(this.element.textContent=e.toUpperCase(),t&&this.element.className.includes("bg-"))){let o=this.element.className.match(/bg-\S+/)[0];this.element.classList.remove(o),this.element.classList.add(t)}}}});var nt={};J(nt,{Badge:()=>xe});var xe,ot=Q(()=>{Z();K();xe=class extends z{constructor(e={}){super(e),this.label=e.label||"Badge",this.variant=e.variant||"default",this.size=e.size||"md",this.className=e.className||""}create(){let e="inline-flex items-center rounded font-semibold whitespace-nowrap",t={default:"bg-gray-100 text-gray-800",primary:"bg-blue-100 text-blue-800",success:"bg-green-100 text-green-800",warning:"bg-yellow-100 text-yellow-800",destructive:"bg-red-100 text-red-800",outline:"border border-gray-300 text-gray-700"},o={sm:"px-2 py-1 text-xs",md:"px-3 py-1 text-sm",lg:"px-4 py-2 text-base"},g=super.create("span",{className:H(e,t[this.variant],o[this.size],this.className)});return g.textContent=this.label,g}setLabel(e){this.label=e,this.element&&(this.element.textContent=e)}}});var it={};J(it,{Button:()=>be});var be,lt=Q(()=>{Z();K();be=class extends z{constructor(e={}){super(e),this.label=e.label||"Button",this.variant=e.variant||"default",this.size=e.size||"md",this.disabled=e.disabled||!1,this.onClick=e.onClick||null,this.className=e.className||""}create(){let e="px-4 py-2 font-medium rounded transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-2",t={default:"bg-gray-200 text-gray-900 hover:bg-gray-300",primary:"bg-blue-600 text-white hover:bg-blue-700 focus:ring-blue-500",secondary:"bg-green-600 text-white hover:bg-green-700 focus:ring-green-500",destructive:"bg-red-600 text-white hover:bg-red-700 focus:ring-red-500",outline:"border-2 border-gray-300 text-gray-900 hover:bg-gray-50",ghost:"text-gray-900 hover:bg-gray-100"},o={sm:"px-2 py-1 text-sm",md:"px-4 py-2 text-base",lg:"px-6 py-3 text-lg"},g=super.create("button",{className:H(e,t[this.variant],o[this.size],this.className),attrs:{disabled:this.disabled}});return g.textContent=this.label,this.onClick&&this.on("click",this.onClick),g}setLabel(e){this.label=e,this.element&&(this.element.textContent=e)}setDisabled(e){this.disabled=e,this.attr("disabled",e?"":null)}setLoading(e){this.setDisabled(e),e?this.html('<span class="flex items-center gap-2"><span class="inline-block w-4 h-4 border-2 border-current border-t-transparent rounded-full animate-spin"></span>Loading...</span>'):this.text(this.label)}}});var dt={};J(dt,{ButtonGroup:()=>ve});var ve,ct=Q(()=>{Z();K();ve=class extends z{constructor(e={}){super(e),this.buttons=e.buttons||[],this.orientation=e.orientation||"horizontal",this.size=e.size||"md",this.className=e.className||""}create(){let e=this.orientation==="vertical"?"flex-col":"flex-row",o=super.create("div",{className:H("flex",e,"inline-flex border border-gray-300 rounded-md overflow-hidden",this.className),attrs:{role:"group"}});return this.buttons.forEach((g,b)=>{let k=document.createElement("button");k.textContent=g.label||"Button",k.className=H("px-4 py-2 font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-200",b>0?this.orientation==="vertical"?"border-t border-gray-300":"border-l border-gray-300":"",g.disabled?"opacity-50 cursor-not-allowed":""),k.disabled=g.disabled||!1,g.onClick&&k.addEventListener("click",g.onClick),o.appendChild(k)}),o}addButton(e,t){if(this.element){let o=document.createElement("button");o.textContent=e,o.className=H("px-4 py-2 font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-200 border-l border-gray-300"),t&&o.addEventListener("click",t),this.element.appendChild(o)}}}});var ut={};J(ut,{Breadcrumb:()=>ye});var ye,mt=Q(()=>{Z();K();ye=class extends z{constructor(e={}){super(e),this.items=e.items||[],this.className=e.className||""}create(){let t=super.create("nav",{className:H("flex items-center gap-2",this.className),attrs:{"aria-label":"Breadcrumb"}});return this.items.forEach((o,g)=>{if(g>0){let b=F("span",{className:"text-gray-400 mx-1",text:"/"});t.appendChild(b)}if(g===this.items.length-1){let b=F("span",{className:"text-gray-700 font-medium",text:o.label,attrs:{"aria-current":"page"}});t.appendChild(b)}else{let b=F("a",{className:"text-blue-600 hover:text-blue-800 hover:underline transition-colors duration-200",text:o.label,attrs:{href:o.href||"#"}});t.appendChild(b)}}),t}addItem(e,t="#"){if(this.element){if(this.element.children.length>0){let g=F("span",{className:"text-gray-400 mx-1",text:"/"});this.element.appendChild(g)}let o=F("a",{className:"text-blue-600 hover:text-blue-800 hover:underline transition-colors duration-200",text:e,attrs:{href:t}});this.element.appendChild(o),this.items.push({label:e,href:t})}}}});var pt={};J(pt,{Card:()=>we});var we,gt=Q(()=>{Z();K();we=class extends z{constructor(e={}){super(e),this.title=e.title||"",this.subtitle=e.subtitle||"",this.content=e.content||"",this.footer=e.footer||"",this.className=e.className||"",this.hoverable=e.hoverable!==!1}create(){let e="bg-white rounded-lg border border-gray-200 overflow-hidden",t=this.hoverable?"hover:shadow-lg transition-shadow duration-300":"",o=super.create("div",{className:H(e,t,this.className)});if(this.title){let g=F("div",{className:"px-6 py-4 border-b border-gray-200 bg-gray-50"}),b=`<h3 class="text-lg font-semibold text-gray-900">${this.title}</h3>`;this.subtitle&&(b+=`<p class="text-sm text-gray-600 mt-1">${this.subtitle}</p>`),g.innerHTML=b,o.appendChild(g)}if(this.content){let g=F("div",{className:"px-6 py-4",html:this.content});o.appendChild(g)}if(this.footer){let g=F("div",{className:"px-6 py-4 border-t border-gray-200 bg-gray-50",html:this.footer});o.appendChild(g)}return o}setContent(e){if(this.content=e,this.element){let t=this.element.querySelector(".px-6.py-4:not(.border-b):not(.border-t)");t&&(t.innerHTML=e)}}addContent(e){if(this.element){let t=this.element.querySelector(".px-6.py-4:not(.border-b):not(.border-t)");t&&t.appendChild(e instanceof z?e.element:e)}}}});var ht={};J(ht,{Carousel:()=>ke});var ke,ft=Q(()=>{Z();K();ke=class extends z{constructor(e={}){super(e),this.items=e.items||[],this.autoplay=e.autoplay||!0,this.interval=e.interval||5e3,this.className=e.className||"",this.currentIndex=0,this.autoplayTimer=null}create(){let e=super.create("div",{className:H("relative w-full bg-black rounded-lg overflow-hidden",this.className)}),t=F("div",{className:"relative w-full h-96 overflow-hidden"});this.items.forEach((k,A)=>{let q=F("div",{className:H("absolute inset-0 transition-opacity duration-500",A===this.currentIndex?"opacity-100":"opacity-0")}),R=document.createElement("img");if(R.src=k.src,R.alt=k.alt||"",R.className="w-full h-full object-cover",q.appendChild(R),k.title){let Y=F("div",{className:"absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4",html:`<p class="text-white font-semibold">${k.title}</p>`});q.appendChild(Y)}t.appendChild(q)}),e.appendChild(t);let o=F("button",{className:"absolute left-4 top-1/2 transform -translate-y-1/2 z-10 bg-black bg-opacity-50 text-white p-2 rounded-full hover:bg-opacity-75 transition-all",html:"\u276E"});o.addEventListener("click",()=>{this.previous()});let g=F("button",{className:"absolute right-4 top-1/2 transform -translate-y-1/2 z-10 bg-black bg-opacity-50 text-white p-2 rounded-full hover:bg-opacity-75 transition-all",html:"\u276F"});g.addEventListener("click",()=>{this.next()}),e.appendChild(o),e.appendChild(g);let b=F("div",{className:"absolute bottom-4 left-1/2 transform -translate-x-1/2 flex gap-2 z-10"});return this.items.forEach((k,A)=>{let q=F("button",{className:H("w-2 h-2 rounded-full transition-all",A===this.currentIndex?"bg-white w-8":"bg-gray-500"),attrs:{"data-index":A}});q.addEventListener("click",()=>{this.goTo(A)}),b.appendChild(q)}),e.appendChild(b),this.slidesElement=t,this.dotsElement=b,this.autoplay&&this.startAutoplay(),e}next(){this.currentIndex=(this.currentIndex+1)%this.items.length,this.updateSlides()}previous(){this.currentIndex=(this.currentIndex-1+this.items.length)%this.items.length,this.updateSlides()}goTo(e){this.currentIndex=e,this.updateSlides(),this.autoplay&&this.resetAutoplay()}updateSlides(){let e=this.slidesElement.querySelectorAll("div"),t=this.dotsElement.querySelectorAll("button");e.forEach((o,g)=>{o.className=H("absolute inset-0 transition-opacity duration-500",g===this.currentIndex?"opacity-100":"opacity-0")}),t.forEach((o,g)=>{o.className=H("w-2 h-2 rounded-full transition-all",g===this.currentIndex?"bg-white w-8":"bg-gray-500")})}startAutoplay(){this.autoplayTimer=setInterval(()=>{this.next()},this.interval)}stopAutoplay(){this.autoplayTimer&&clearInterval(this.autoplayTimer)}resetAutoplay(){this.stopAutoplay(),this.autoplay&&this.startAutoplay()}destroy(){this.stopAutoplay(),super.destroy()}}});var xt={};J(xt,{Chart:()=>Ce});var Ce,bt=Q(()=>{Z();K();Ce=class extends z{constructor(e={}){super(e),this.type=e.type||"bar",this.data=e.data||[],this.title=e.title||"",this.height=e.height||"300px",this.className=e.className||""}create(){let e=super.create("div",{className:H("bg-white rounded-lg border border-gray-200 p-4",this.className)});if(this.title){let o=F("h3",{className:"text-lg font-semibold text-gray-900 mb-4",text:this.title});e.appendChild(o)}let t=this.createSVG();return e.appendChild(t),e}createSVG(){let e=Math.max(...this.data.map(k=>k.value)),t=400,o=200,g=40,b=document.createElementNS("http://www.w3.org/2000/svg","svg");if(b.setAttribute("viewBox",`0 0 ${t} ${o}`),b.setAttribute("class","w-full"),this.type==="bar"){let k=(t-g*2)/this.data.length;this.data.forEach((A,q)=>{let R=A.value/e*(o-g*2),Y=g+q*k+k*.25,j=o-g-R,y=document.createElementNS("http://www.w3.org/2000/svg","rect");y.setAttribute("x",Y),y.setAttribute("y",j),y.setAttribute("width",k*.5),y.setAttribute("height",R),y.setAttribute("fill","#3b82f6"),y.setAttribute("class","hover:fill-blue-700 transition-colors"),b.appendChild(y);let M=document.createElementNS("http://www.w3.org/2000/svg","text");M.setAttribute("x",Y+k*.25),M.setAttribute("y",o-10),M.setAttribute("text-anchor","middle"),M.setAttribute("font-size","12"),M.setAttribute("fill","#6b7280"),M.textContent=A.label,b.appendChild(M)})}return b}setData(e){if(this.data=e,this.element&&this.element.parentNode){let t=this.create();this.element.parentNode.replaceChild(t,this.element),this.element=t}}}});var vt={};J(vt,{Checkbox:()=>Ee});var Ee,yt=Q(()=>{Z();K();Ee=class extends z{constructor(e={}){super(e),this.label=e.label||"",this.checked=e.checked||!1,this.disabled=e.disabled||!1,this.required=e.required||!1,this.name=e.name||"",this.className=e.className||"",this.onChange=e.onChange||null}create(){let t=super.create("div",{className:H("flex items-center gap-2",this.className)}),o="w-5 h-5 border-2 border-gray-300 rounded cursor-pointer transition-colors duration-200 checked:bg-blue-600 checked:border-blue-600 disabled:opacity-50 disabled:cursor-not-allowed",g=document.createElement("input");if(g.type="checkbox",g.className=o,g.checked=this.checked,g.disabled=this.disabled,g.required=this.required,this.name&&(g.name=this.name),t.appendChild(g),this.label){let b=document.createElement("label");b.className="cursor-pointer select-none",b.textContent=this.label,t.appendChild(b),b.addEventListener("click",()=>{g.click()})}return this.onChange&&g.addEventListener("change",this.onChange),this.inputElement=g,t}isChecked(){return this.inputElement?.checked||!1}setChecked(e){this.checked=e,this.inputElement&&(this.inputElement.checked=e)}setDisabled(e){this.disabled=e,this.inputElement&&(this.inputElement.disabled=e)}toggle(){this.setChecked(!this.isChecked())}}});var wt={};J(wt,{Collapsible:()=>Le});var Le,kt=Q(()=>{Z();K();Le=class extends z{constructor(e={}){super(e),this.title=e.title||"",this.content=e.content||"",this.open=e.open||!1,this.className=e.className||"",this.onChange=e.onChange||null}create(){let e=super.create("div",{className:H("border border-gray-200 rounded-lg overflow-hidden",this.className)}),t=F("button",{className:H("w-full px-4 py-3 flex items-center justify-between","hover:bg-gray-50 transition-colors duration-200 text-left"),attrs:{"aria-expanded":this.open}}),o=F("span",{className:"font-semibold text-gray-900",text:this.title}),g=F("span",{className:H("w-5 h-5 transition-transform duration-300",this.open?"rotate-180":""),html:"\u25BC"});t.appendChild(o),t.appendChild(g),t.addEventListener("click",()=>{this.toggle()}),e.appendChild(t);let b=F("div",{className:H("overflow-hidden transition-all duration-300",this.open?"max-h-96":"max-h-0","border-t border-gray-200")}),k=F("div",{className:"px-4 py-3",html:this.content});return b.appendChild(k),e.appendChild(b),this.triggerElement=t,this.contentElement=b,this.chevron=g,e}toggle(){this.open=!this.open,this.updateUI(),this.onChange&&this.onChange(this.open)}open(){this.open||(this.open=!0,this.updateUI(),this.onChange&&this.onChange(!0))}close(){this.open&&(this.open=!1,this.updateUI(),this.onChange&&this.onChange(!1))}updateUI(){this.triggerElement.setAttribute("aria-expanded",this.open),this.contentElement.className=H("overflow-hidden transition-all duration-300",this.open?"max-h-96":"max-h-0","border-t border-gray-200"),this.chevron.className=H("w-5 h-5 transition-transform duration-300",this.open?"rotate-180":"")}setContent(e){if(this.content=e,this.contentElement){let t=this.contentElement.querySelector("div");t&&(t.innerHTML=e)}}}});var Ct={};J(Ct,{Command:()=>$e});var $e,Et=Q(()=>{Z();K();$e=class extends z{constructor(e={}){super(e),this.commands=e.commands||[],this.placeholder=e.placeholder||"Type a command...",this.className=e.className||"",this.open=!1}create(){let e=super.create("div",{className:H("fixed inset-0 z-50 hidden flex items-start justify-center pt-20",this.open?"flex":"")}),t=F("div",{className:"absolute inset-0 bg-black bg-opacity-50"});e.appendChild(t),t.addEventListener("click",()=>this.close());let o=F("div",{className:"relative w-full max-w-md bg-white rounded-lg shadow-lg z-50"}),g=document.createElement("input");g.type="text",g.placeholder=this.placeholder,g.className="w-full px-4 py-3 border-b border-gray-200 focus:outline-none",g.autofocus=!0,o.appendChild(g);let b=F("div",{className:"max-h-96 overflow-y-auto"}),k=(A="")=>{b.innerHTML="";let q=A?this.commands.filter(Y=>Y.label.toLowerCase().includes(A.toLowerCase())):this.commands;if(q.length===0){let Y=F("div",{className:"px-4 py-3 text-sm text-gray-500",text:"No commands found"});b.appendChild(Y);return}let R="";q.forEach(Y=>{if(Y.category&&Y.category!==R){R=Y.category;let M=F("div",{className:"px-4 py-2 text-xs font-semibold text-gray-600 bg-gray-50 uppercase",text:R});b.appendChild(M)}let j=F("div",{className:H("px-4 py-2 cursor-pointer hover:bg-blue-50 transition-colors flex items-center justify-between group")}),y=F("span",{text:Y.label,className:"text-sm text-gray-900"});if(j.appendChild(y),Y.shortcut){let M=F("span",{className:"text-xs text-gray-500 group-hover:text-gray-700",text:Y.shortcut});j.appendChild(M)}j.addEventListener("click",()=>{Y.action&&Y.action(),this.close()}),b.appendChild(j)})};return g.addEventListener("input",A=>{k(A.target.value)}),o.appendChild(b),e.appendChild(o),g.addEventListener("keydown",A=>{A.key==="Escape"&&this.close()}),k(),this.containerElement=e,e}open(){this.element||this.create(),this.open=!0,this.element.classList.remove("hidden"),this.element.classList.add("flex")}close(){this.open=!1,this.element?.classList.remove("flex"),this.element?.classList.add("hidden")}toggle(){this.open?this.close():this.open()}}});var Lt={};J(Lt,{Combobox:()=>Te});var Te,$t=Q(()=>{Z();K();Te=class extends z{constructor(e={}){super(e),this.items=e.items||[],this.value=e.value||"",this.placeholder=e.placeholder||"Search...",this.className=e.className||"",this.onChange=e.onChange||null,this.open=!1}create(){let e=super.create("div",{className:"relative w-full"}),t=document.createElement("input");t.type="text",t.placeholder=this.placeholder,t.value=this.value,t.className=H("w-full px-3 py-2 border border-gray-300 rounded-md","focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent");let o=F("div",{className:H("absolute hidden top-full left-0 right-0 mt-1 bg-white border border-gray-300 rounded-md shadow-lg z-50","max-h-64 overflow-y-auto")}),g=(b="")=>{o.innerHTML="";let k=this.items.filter(A=>A.label.toLowerCase().includes(b.toLowerCase()));if(k.length===0){let A=F("div",{className:"px-3 py-2 text-gray-500",text:"No results found"});o.appendChild(A);return}k.forEach(A=>{let q=F("div",{className:H("px-3 py-2 cursor-pointer hover:bg-blue-50 transition-colors",A.value===this.value?"bg-blue-100":""),text:A.label,attrs:{"data-value":A.value}});q.addEventListener("click",()=>{this.value=A.value,t.value=A.label,o.classList.add("hidden"),this.onChange&&this.onChange(this.value,A)}),o.appendChild(q)})};return t.addEventListener("input",b=>{g(b.target.value),o.classList.remove("hidden")}),t.addEventListener("focus",()=>{g(t.value),o.classList.remove("hidden")}),t.addEventListener("blur",()=>{setTimeout(()=>{o.classList.add("hidden")},150)}),e.appendChild(t),e.appendChild(o),document.addEventListener("click",b=>{e.contains(b.target)||o.classList.add("hidden")}),this.inputElement=t,this.listElement=o,g(),e}getValue(){return this.value}setValue(e){this.value=e;let t=this.items.find(o=>o.value===e);t&&this.inputElement&&(this.inputElement.value=t.label)}}});var Tt={};J(Tt,{ContextMenu:()=>Ie});var Ie,It=Q(()=>{Z();K();Ie=class extends z{constructor(e={}){super(e),this.items=e.items||[],this.className=e.className||"",this.visible=!1}create(){let e=super.create("div",{className:"relative inline-block w-full"}),t=document.createElement("div");return t.className=H("absolute hidden bg-white border border-gray-200 rounded-lg shadow-lg py-1 z-50 min-w-max",this.className),this.items.forEach(o=>{let g=F("button",{className:H("w-full text-left px-4 py-2 hover:bg-gray-100 transition-colors duration-200 flex items-center gap-2",o.disabled?"opacity-50 cursor-not-allowed":"cursor-pointer"),attrs:{disabled:o.disabled?"":null,"data-action":o.label}});if(o.icon){let k=document.createElement("span");k.innerHTML=o.icon,g.appendChild(k)}let b=document.createElement("span");b.textContent=o.label,g.appendChild(b),g.addEventListener("click",()=>{!o.disabled&&o.onClick&&o.onClick(),this.hide()}),t.appendChild(g)}),e.appendChild(t),e.addEventListener("contextmenu",o=>{o.preventDefault(),this.showAt(o.clientX,o.clientY,t)}),document.addEventListener("click",()=>{this.visible&&this.hide()}),this.menuElement=t,e}showAt(e,t,o){o&&(this.visible=!0,o.classList.remove("hidden"),o.style.position="fixed",o.style.left=e+"px",o.style.top=t+"px")}hide(){this.visible=!1,this.menuElement&&(this.menuElement.classList.add("hidden"),this.menuElement.style.position="absolute")}addItem(e,t,o=null){let g={label:e,onClick:t,icon:o};if(this.items.push(g),this.menuElement){let b=F("button",{className:"w-full text-left px-4 py-2 hover:bg-gray-100 transition-colors duration-200 flex items-center gap-2"});if(o){let k=document.createElement("span");k.innerHTML=o,b.appendChild(k)}b.textContent=e,b.addEventListener("click",()=>{t(),this.hide()}),this.menuElement.appendChild(b)}}}});var Bt={};J(Bt,{DatePicker:()=>Be});var Be,St=Q(()=>{Z();K();Be=class extends z{constructor(e={}){super(e),this.value=e.value||"",this.placeholder=e.placeholder||"Select date...",this.format=e.format||"yyyy-mm-dd",this.className=e.className||"",this.onChange=e.onChange||null,this.open=!1}create(){let e=super.create("div",{className:"relative w-full"}),t=document.createElement("input");t.type="text",t.placeholder=this.placeholder,t.value=this.value,t.className=H("w-full px-3 py-2 border border-gray-300 rounded-md","focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"),t.addEventListener("click",()=>{this.openPicker()}),t.addEventListener("change",g=>{this.value=g.target.value,this.onChange&&this.onChange(this.value)}),e.appendChild(t);let o=document.createElement("input");return o.type="date",o.style.display="none",o.value=this.value,o.addEventListener("change",g=>{let b=new Date(g.target.value);this.value=this.formatDate(b),t.value=this.value,this.onChange&&this.onChange(this.value)}),e.appendChild(o),this.inputElement=t,this.nativeInput=o,e}openPicker(){this.nativeInput.click()}formatDate(e){let t=e.getFullYear(),o=String(e.getMonth()+1).padStart(2,"0"),g=String(e.getDate()).padStart(2,"0");return this.format==="dd/mm/yyyy"?`${g}/${o}/${t}`:`${t}-${o}-${g}`}getValue(){return this.value}setValue(e){this.value=e,this.inputElement&&(this.inputElement.value=e)}}});var _t={};J(_t,{Dialog:()=>Se});var Se,At=Q(()=>{Z();K();Se=class extends z{constructor(e={}){super(e),this.title=e.title||"",this.content=e.content||"",this.size=e.size||"md",this.open=e.open||!1,this.onClose=e.onClose||null,this.closeButton=e.closeButton!==!1,this.closeOnBackdrop=e.closeOnBackdrop!==!1,this.closeOnEscape=e.closeOnEscape!==!1}create(){let e=super.create("div",{className:H("fixed inset-0 z-50 flex items-center justify-center",this.open?"":"hidden"),attrs:{role:"dialog","aria-modal":"true","aria-labelledby":`${this.id}-title`,"aria-describedby":`${this.id}-description`}}),t=ie("dialog-backdrop");e.appendChild(t),this.closeOnBackdrop&&t.addEventListener("click",()=>this.close());let o={sm:"w-full max-w-sm",md:"w-full max-w-md",lg:"w-full max-w-lg",xl:"w-full max-w-xl"},g=document.createElement("div");if(g.className=H("bg-white rounded-lg shadow-lg relative z-50",o[this.size],"mx-4 max-h-[90vh] overflow-y-auto"),this.title){let b=document.createElement("div");b.className="px-6 py-4 border-b border-gray-200 flex items-center justify-between";let k=document.createElement("h2");if(k.id=`${this.id}-title`,k.className="text-xl font-semibold text-gray-900",k.textContent=this.title,b.appendChild(k),this.closeButton){let A=document.createElement("button");A.className="text-gray-500 hover:text-gray-700 transition-colors duration-200",A.innerHTML="\xD7",A.setAttribute("aria-label","Close"),A.addEventListener("click",()=>this.close()),b.appendChild(A)}g.appendChild(b)}if(this.content){let b=document.createElement("div");b.id=`${this.id}-description`,b.className="px-6 py-4",b.innerHTML=this.content,g.appendChild(b)}return e.appendChild(g),this.on("keydown",b=>{ue.isEscape(b)&&this.closeOnEscape&&this.close()},{once:!1}),this.backdrop=t,this.dialogElement=g,this.focusTrap=ce(g),e}open(){this.element||this.create(),this.open=!0,this.element.classList.remove("hidden"),this.focusTrap.init(),document.body.style.overflow="hidden"}close(){this.open=!1,this.element?.classList.add("hidden"),document.body.style.overflow="",this.onClose&&this.onClose()}toggle(){this.open?this.close():this.open()}setContent(e){if(this.content=e,this.dialogElement){let t=this.dialogElement.querySelector(`#${this.id}-description`);t&&(t.innerHTML=e)}}}});var Mt={};J(Mt,{DropdownMenu:()=>_e});var _e,qt=Q(()=>{Z();K();_e=class extends z{constructor(e={}){super(e),this.trigger=e.trigger||"Menu",this.items=e.items||[],this.position=e.position||"bottom",this.align=e.align||"left",this.className=e.className||"",this.open=!1}create(){let e=super.create("div",{className:"relative inline-block"}),t=document.createElement("button");t.className="px-4 py-2 bg-gray-100 text-gray-900 rounded hover:bg-gray-200 transition-colors duration-200 flex items-center gap-2",t.innerHTML=`${this.trigger} <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path></svg>`,t.addEventListener("click",()=>this.toggle()),e.appendChild(t);let o=this.position==="top"?"bottom-full mb-2":"top-full mt-2",g=this.align==="right"?"right-0":"left-0",b=document.createElement("div");return b.className=H("absolute hidden bg-white border border-gray-200 rounded-lg shadow-lg py-1 z-50 min-w-max",o,g,this.className),this.items.forEach(k=>{if(k.divider){let R=document.createElement("div");R.className="border-t border-gray-200 my-1",b.appendChild(R);return}let A=F("button",{className:H("w-full text-left px-4 py-2 hover:bg-gray-100 transition-colors duration-200 flex items-center gap-2",k.disabled?"opacity-50 cursor-not-allowed":"cursor-pointer"),attrs:{disabled:k.disabled?"":null}});if(k.icon){let R=document.createElement("span");R.innerHTML=k.icon,R.className="w-4 h-4",A.appendChild(R)}let q=document.createElement("span");q.textContent=k.label,A.appendChild(q),A.addEventListener("click",()=>{!k.disabled&&k.onClick&&k.onClick(),this.close()}),b.appendChild(A)}),e.appendChild(b),document.addEventListener("click",k=>{!e.contains(k.target)&&this.open&&this.close()}),this.triggerBtn=t,this.menuElement=b,e}toggle(){this.open?this.close():this.open()}open(){this.open=!0,this.menuElement.classList.remove("hidden")}close(){this.open=!1,this.menuElement.classList.add("hidden")}addItem(e,t,o=null){let g={label:e,onClick:t,icon:o};if(this.items.push(g),this.menuElement){let b=F("button",{className:"w-full text-left px-4 py-2 hover:bg-gray-100 transition-colors duration-200 flex items-center gap-2"});if(o){let A=document.createElement("span");A.innerHTML=o,A.className="w-4 h-4",b.appendChild(A)}let k=document.createElement("span");k.textContent=e,b.appendChild(k),b.addEventListener("click",()=>{t(),this.close()}),this.menuElement.appendChild(b)}}}});var Ht={};J(Ht,{Drawer:()=>Ae});var Ae,Pt=Q(()=>{Z();K();Ae=class extends z{constructor(e={}){super(e),this.title=e.title||"",this.content=e.content||"",this.position=e.position||"right",this.open=e.open||!1,this.onClose=e.onClose||null,this.closeButton=e.closeButton!==!1,this.closeOnBackdrop=e.closeOnBackdrop!==!1,this.closeOnEscape=e.closeOnEscape!==!1}create(){let e=super.create("div",{className:H("fixed inset-0 z-50",this.open?"":"hidden")}),t=ie();e.appendChild(t),this.closeOnBackdrop&&t.addEventListener("click",()=>this.close());let o=this.position==="left"?"left-0":"right-0",g=document.createElement("div");if(g.className=H("absolute top-0 h-full w-96 bg-white shadow-lg transition-transform duration-300 flex flex-col z-50",o,this.open?"translate-x-0":this.position==="left"?"-translate-x-full":"translate-x-full"),this.title){let k=document.createElement("div");k.className="px-6 py-4 border-b border-gray-200 flex items-center justify-between";let A=document.createElement("h2");if(A.className="text-xl font-semibold text-gray-900",A.textContent=this.title,k.appendChild(A),this.closeButton){let q=document.createElement("button");q.className="text-gray-500 hover:text-gray-700 transition-colors duration-200",q.innerHTML="\xD7",q.addEventListener("click",()=>this.close()),k.appendChild(q)}g.appendChild(k)}let b=document.createElement("div");return b.className="flex-1 overflow-y-auto px-6 py-4",b.innerHTML=this.content,g.appendChild(b),e.appendChild(g),this.on("keydown",k=>{ue.isEscape(k)&&this.closeOnEscape&&this.close()},{once:!1}),this.backdrop=t,this.drawerElement=g,e}open(){this.element||this.create(),this.open=!0,this.element.classList.remove("hidden"),this.drawerElement.classList.remove("-translate-x-full","translate-x-full"),this.drawerElement.classList.add("translate-x-0"),document.body.style.overflow="hidden"}close(){this.open=!1;let e=this.position==="left"?"-translate-x-full":"translate-x-full";this.drawerElement.classList.remove("translate-x-0"),this.drawerElement.classList.add(e),setTimeout(()=>{this.element?.parentNode&&this.element.classList.add("hidden"),document.body.style.overflow=""},300),this.onClose&&this.onClose()}toggle(){this.open?this.close():this.open()}}});var jt={};J(jt,{Empty:()=>Me});var Me,Nt=Q(()=>{Z();K();Me=class extends z{constructor(e={}){super(e),this.icon=e.icon||"\u{1F4E6}",this.title=e.title||"No data",this.message=e.message||"There is no data to display",this.action=e.action||null,this.className=e.className||""}create(){let e=super.create("div",{className:H("flex flex-col items-center justify-center p-8 text-center",this.className)}),t=F("div",{className:"text-6xl mb-4",text:this.icon});e.appendChild(t);let o=F("h3",{className:"text-lg font-semibold text-gray-900 mb-2",text:this.title});e.appendChild(o);let g=F("p",{className:"text-gray-500 mb-4",text:this.message});if(e.appendChild(g),this.action){let b=F("button",{className:"px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors",text:this.action.label});b.addEventListener("click",this.action.onClick),e.appendChild(b)}return e}}});var Ft={};J(Ft,{Form:()=>qe});var qe,zt=Q(()=>{Z();K();qe=class extends z{constructor(e={}){super(e),this.fields=e.fields||[],this.onSubmit=e.onSubmit||null,this.submitText=e.submitText||"Submit",this.className=e.className||""}create(){let e=super.create("form",{className:H("space-y-6",this.className)});e.addEventListener("submit",o=>{o.preventDefault(),this.handleSubmit()}),this.fieldElements={},this.fields.forEach(o=>{let g=F("div",{className:"space-y-2"});if(o.label){let A=F("label",{className:"block text-sm font-medium text-gray-700",text:o.label,attrs:{for:o.name}});g.appendChild(A)}let b=document.createElement(o.type==="textarea"?"textarea":"input");b.id=o.name,b.name=o.name,b.className=H("w-full px-3 py-2 border border-gray-300 rounded-md","focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"),o.type!=="textarea"&&(b.type=o.type||"text"),o.placeholder&&(b.placeholder=o.placeholder),o.required&&(b.required=!0),o.disabled&&(b.disabled=!0),b.value=o.value||"",g.appendChild(b);let k=F("div",{className:"text-sm text-red-600 hidden",attrs:{"data-error":o.name}});g.appendChild(k),e.appendChild(g),this.fieldElements[o.name]=b});let t=F("button",{className:H("w-full px-4 py-2 bg-blue-600 text-white font-medium rounded","hover:bg-blue-700 transition-colors duration-200"),text:this.submitText,attrs:{type:"submit"}});return e.appendChild(t),e}handleSubmit(){let e={};Object.entries(this.fieldElements).forEach(([t,o])=>{e[t]=o.value}),this.onSubmit&&this.onSubmit(e)}getValues(){let e={};return Object.entries(this.fieldElements).forEach(([t,o])=>{e[t]=o.value}),e}setValues(e){Object.entries(e).forEach(([t,o])=>{this.fieldElements[t]&&(this.fieldElements[t].value=o)})}setError(e,t){let o=this.element.querySelector(`[data-error="${e}"]`);o&&(o.textContent=t,o.classList.remove("hidden"))}clearError(e){let t=this.element.querySelector(`[data-error="${e}"]`);t&&(t.textContent="",t.classList.add("hidden"))}reset(){this.element&&this.element.reset()}}});var Ot={};J(Ot,{HoverCard:()=>He});var He,Rt=Q(()=>{Z();K();He=class extends z{constructor(e={}){super(e),this.trigger=e.trigger||"Hover me",this.content=e.content||"",this.position=e.position||"bottom",this.delay=e.delay||200,this.className=e.className||"",this.visible=!1,this.timeoutId=null}create(){let e=super.create("div",{className:"relative inline-block"}),t=document.createElement("div");t.className="cursor-pointer px-3 py-2 rounded hover:bg-gray-100 transition-colors duration-200",t.textContent=this.trigger,e.appendChild(t);let o=document.createElement("div");return o.className=H("absolute hidden bg-white border border-gray-200 rounded-lg shadow-lg p-4 z-50","min-w-max max-w-sm",this.getPositionClasses(),this.className),o.innerHTML=this.content,e.appendChild(o),e.addEventListener("mouseenter",()=>this.show(o)),e.addEventListener("mouseleave",()=>this.hide(o)),this.cardElement=o,e}getPositionClasses(){let e={top:"bottom-full left-0 mb-2",bottom:"top-full left-0 mt-2",left:"right-full top-0 mr-2",right:"left-full top-0 ml-2"};return e[this.position]||e.bottom}show(e=this.cardElement){this.visible||!e||(this.timeoutId=setTimeout(()=>{this.visible=!0,e.classList.remove("hidden"),e.classList.add("opacity-100","transition-opacity","duration-200")},this.delay))}hide(e=this.cardElement){!this.visible||!e||(clearTimeout(this.timeoutId),this.visible=!1,e.classList.add("hidden"),e.classList.remove("opacity-100"))}setContent(e){this.content=e,this.cardElement&&(this.cardElement.innerHTML=e)}}});var Dt={};J(Dt,{Input:()=>Pe});var Pe,Vt=Q(()=>{Z();K();Pe=class extends z{constructor(e={}){super(e),this.type=e.type||"text",this.placeholder=e.placeholder||"",this.value=e.value||"",this.name=e.name||"",this.disabled=e.disabled||!1,this.required=e.required||!1,this.className=e.className||"",this.onChange=e.onChange||null}create(){let t=super.create("input",{className:H("w-full px-3 py-2 border border-gray-300 rounded-md text-gray-900 placeholder-gray-500 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-100 disabled:cursor-not-allowed",this.className),attrs:{type:this.type,placeholder:this.placeholder,value:this.value,name:this.name,disabled:this.disabled?"":null,required:this.required?"":null}});return this.onChange&&(this.on("change",this.onChange),this.on("input",this.onChange)),t}getValue(){return this.element?.value||""}setValue(e){this.value=e,this.element&&(this.element.value=e)}setDisabled(e){this.disabled=e,this.attr("disabled",e?"":null)}setPlaceholder(e){this.placeholder=e,this.element&&(this.element.placeholder=e)}focus(){super.focus()}clear(){this.setValue("")}}});var Ut={};J(Ut,{InputGroup:()=>je});var je,Wt=Q(()=>{Z();K();je=class extends z{constructor(e={}){super(e),this.prefix=e.prefix||null,this.suffix=e.suffix||null,this.input=e.input||null,this.className=e.className||""}create(){let t=super.create("div",{className:H("flex items-center border border-gray-300 rounded-md overflow-hidden focus-within:ring-2 focus-within:ring-blue-500",this.className)});if(this.prefix){let o=F("div",{className:"px-3 py-2 bg-gray-50 text-gray-700 font-medium text-sm",html:this.prefix});t.appendChild(o)}if(this.input){let o=this.input.element||this.input.create();o.classList.remove("border","focus:ring-2","focus:ring-blue-500"),t.appendChild(o)}if(this.suffix){let o=F("div",{className:"px-3 py-2 bg-gray-50 text-gray-700 font-medium text-sm",html:this.suffix});t.appendChild(o)}return t}}});var Yt={};J(Yt,{InputOTP:()=>Ne});var Ne,Qt=Q(()=>{Z();K();Ne=class extends z{constructor(e={}){super(e),this.length=e.length||6,this.value=e.value||"",this.className=e.className||"",this.onChange=e.onChange||null,this.onComplete=e.onComplete||null}create(){let e=super.create("div",{className:H("flex gap-2",this.className)});this.inputs=[];for(let t=0;t<this.length;t++){let o=document.createElement("input");o.type="text",o.maxLength="1",o.inputMode="numeric",o.className=H("w-12 h-12 text-center border-2 border-gray-300 rounded-lg font-semibold text-lg","focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-200","transition-colors duration-200"),this.value&&this.value[t]&&(o.value=this.value[t]),o.addEventListener("input",g=>{let b=g.target.value;if(!/^\d*$/.test(b)){g.target.value="";return}b&&t<this.length-1&&this.inputs[t+1].focus(),this.updateValue()}),o.addEventListener("keydown",g=>{g.key==="Backspace"?!o.value&&t>0&&this.inputs[t-1].focus():g.key==="ArrowLeft"&&t>0?this.inputs[t-1].focus():g.key==="ArrowRight"&&t<this.length-1&&this.inputs[t+1].focus()}),this.inputs.push(o),e.appendChild(o)}return e}updateValue(){this.value=this.inputs.map(e=>e.value).join(""),this.onChange&&this.onChange(this.value),this.value.length===this.length&&this.onComplete&&this.onComplete(this.value)}getValue(){return this.value}setValue(e){this.value=e;for(let t=0;t<this.length;t++)this.inputs[t].value=e[t]||""}clear(){this.inputs.forEach(e=>{e.value=""}),this.value=""}focus(){this.inputs.length>0&&this.inputs[0].focus()}}});var Gt={};J(Gt,{Item:()=>Fe});var Fe,Jt=Q(()=>{Z();K();Fe=class extends z{constructor(e={}){super(e),this.label=e.label||"",this.value=e.value||"",this.icon=e.icon||null,this.className=e.className||"",this.selected=e.selected||!1,this.disabled=e.disabled||!1}create(){let e="flex items-center gap-2 px-3 py-2 rounded cursor-pointer transition-colors duration-200 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed",t=this.selected?"bg-blue-50 text-blue-600":"text-gray-900",o=super.create("div",{className:H(e,t,this.className),attrs:{role:"option","aria-selected":this.selected,disabled:this.disabled?"":null,"data-value":this.value}}),g="";return this.icon&&(g+=`<span class="flex-shrink-0">${this.icon}</span>`),g+=`<span>${this.label}</span>`,o.innerHTML=g,o}setSelected(e){this.selected=e,this.element&&(this.attr("aria-selected",e),this.toggleClass("bg-blue-50 text-blue-600",e))}setDisabled(e){this.disabled=e,this.attr("disabled",e?"":null)}}});var Xt={};J(Xt,{Label:()=>ze});var ze,Kt=Q(()=>{Z();K();ze=class extends z{constructor(e={}){super(e),this.text=e.text||"",this.htmlFor=e.htmlFor||"",this.required=e.required||!1,this.className=e.className||""}create(){let t=super.create("label",{className:H("block text-sm font-medium text-gray-700 mb-1",this.className),attrs:{for:this.htmlFor}}),o=this.text;return this.required&&(o+=' <span class="text-red-500 ml-1">*</span>'),t.innerHTML=o,t}setText(e){if(this.text=e,this.element){let t=e;this.required&&(t+=' <span class="text-red-500 ml-1">*</span>'),this.element.innerHTML=t}}setRequired(e){if(this.required=e,this.element){let t=this.element.querySelector('[class*="text-red"]');e&&!t?this.element.innerHTML+=' <span class="text-red-500 ml-1">*</span>':!e&&t&&t.remove()}}}});var Zt={};J(Zt,{Kbd:()=>Oe});var Oe,es=Q(()=>{Z();K();Oe=class extends z{constructor(e={}){super(e),this.label=e.label||"K",this.className=e.className||""}create(){let t=super.create("kbd",{className:H("px-2 py-1 bg-gray-100 border border-gray-300 rounded text-xs font-semibold text-gray-900 inline-block font-mono",this.className)});return t.textContent=this.label,t}setLabel(e){this.label=e,this.element&&(this.element.textContent=e)}}});var ts={};J(ts,{NativeSelect:()=>Re});var Re,ss=Q(()=>{Z();K();Re=class extends z{constructor(e={}){super(e),this.items=e.items||[],this.selected=e.selected||"",this.placeholder=e.placeholder||"Select...",this.disabled=e.disabled||!1,this.required=e.required||!1,this.name=e.name||"",this.className=e.className||"",this.onChange=e.onChange||null}create(){let t=super.create("select",{className:H("w-full px-3 py-2 border border-gray-300 rounded-md text-gray-900 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-100 disabled:cursor-not-allowed bg-white appearance-none cursor-pointer",this.className),attrs:{disabled:this.disabled?"":null,required:this.required?"":null,...this.name&&{name:this.name}}});if(this.placeholder){let o=document.createElement("option");o.value="",o.textContent=this.placeholder,o.disabled=!0,t.appendChild(o)}return this.items.forEach(o=>{let g=document.createElement("option");g.value=o.value,g.textContent=o.label,o.value===this.selected&&(g.selected=!0),t.appendChild(g)}),this.onChange&&this.on("change",this.onChange),t}getValue(){return this.element?.value||""}setValue(e){this.selected=e,this.element&&(this.element.value=e)}setDisabled(e){this.disabled=e,this.attr("disabled",e?"":null)}addItem(e,t){if(this.element){let o=document.createElement("option");o.value=t,o.textContent=e,this.element.appendChild(o)}}removeItem(e){if(this.element){let t=this.element.querySelector(`option[value="${e}"]`);t&&t.remove()}}}});var rs={};J(rs,{Tooltip:()=>De});var De,as=Q(()=>{Z();K();De=class extends z{constructor(e={}){super(e),this.content=e.content||"",this.position=e.position||"top",this.delay=e.delay||200,this.trigger=e.trigger||"hover",this.className=e.className||"",this.visible=!1,this.timeoutId=null}create(){let e=super.create("div",{className:"relative inline-block"}),t=document.createElement("div");t.className=H("absolute hidden bg-gray-900 text-white px-3 py-2 rounded text-sm whitespace-nowrap z-50","opacity-0 transition-opacity duration-200",this.getPositionClasses(),this.className),t.textContent=this.content;let o=document.createElement("div");return o.className=H("absolute w-2 h-2 bg-gray-900 transform rotate-45",this.getArrowClasses()),t.appendChild(o),e.appendChild(t),this.tooltipElement=t,this.trigger==="hover"?(e.addEventListener("mouseenter",()=>this.show()),e.addEventListener("mouseleave",()=>this.hide())):this.trigger==="focus"&&(e.addEventListener("focus",()=>this.show(),!0),e.addEventListener("blur",()=>this.hide(),!0)),e}getPositionClasses(){let e={top:"bottom-full left-1/2 transform -translate-x-1/2 mb-2",bottom:"top-full left-1/2 transform -translate-x-1/2 mt-2",left:"right-full top-1/2 transform -translate-y-1/2 mr-2",right:"left-full top-1/2 transform -translate-y-1/2 ml-2"};return e[this.position]||e.top}getArrowClasses(){let e={top:"top-full left-1/2 transform -translate-x-1/2 -translate-y-1/2",bottom:"bottom-full left-1/2 transform -translate-x-1/2 translate-y-1/2",left:"left-full top-1/2 transform translate-x-1/2 -translate-y-1/2",right:"right-full top-1/2 transform -translate-x-1/2 -translate-y-1/2"};return e[this.position]||e.top}show(){this.visible||(this.timeoutId=setTimeout(()=>{this.visible=!0,this.tooltipElement.classList.remove("hidden"),this.tooltipElement.classList.add("opacity-100")},this.delay))}hide(){this.visible&&(clearTimeout(this.timeoutId),this.visible=!1,this.tooltipElement.classList.remove("opacity-100"),this.tooltipElement.classList.add("hidden"))}setContent(e){this.content=e,this.tooltipElement&&(this.tooltipElement.textContent=e)}}});var ns={};J(ns,{Toggle:()=>Ve});var Ve,os=Q(()=>{Z();K();Ve=class extends z{constructor(e={}){super(e),this.label=e.label||"",this.pressed=e.pressed||!1,this.disabled=e.disabled||!1,this.variant=e.variant||"default",this.size=e.size||"md",this.className=e.className||"",this.onChange=e.onChange||null}create(){let e="px-4 py-2 font-medium rounded transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed",t={default:this.pressed?"bg-gray-900 text-white":"bg-gray-100 text-gray-900 hover:bg-gray-200",outline:this.pressed?"border-2 border-gray-900 bg-gray-900 text-white":"border-2 border-gray-300 text-gray-900 hover:bg-gray-50"},o={sm:"px-2 py-1 text-sm",md:"px-4 py-2 text-base",lg:"px-6 py-3 text-lg"},g=super.create("button",{className:H(e,t[this.variant],o[this.size],this.className),attrs:{"aria-pressed":this.pressed,disabled:this.disabled?"":null}});return g.textContent=this.label,this.on("click",()=>{this.toggle()}),g}isPressed(){return this.pressed}setPressed(e){this.pressed=e,this.element&&(this.attr("aria-pressed",e),this.toggleClass("bg-gray-900 text-white",e),this.onChange&&this.onChange(e))}toggle(){this.setPressed(!this.pressed)}setDisabled(e){this.disabled=e,this.attr("disabled",e?"":null)}}});var is={};J(is,{ToggleGroup:()=>Ue});var Ue,ls=Q(()=>{Z();K();Ue=class extends z{constructor(e={}){super(e),this.items=e.items||[],this.selected=e.selected||null,this.multiple=e.multiple||!1,this.orientation=e.orientation||"horizontal",this.className=e.className||"",this.onChange=e.onChange||null}create(){let e=this.orientation==="vertical"?"flex-col":"flex-row",o=super.create("div",{className:H("flex",e,"inline-flex border border-gray-300 rounded-md overflow-hidden",this.className),attrs:{role:"group"}});return this.toggleButtons=[],this.items.forEach((g,b)=>{let k=this.multiple?Array.isArray(this.selected)&&this.selected.includes(g.value):g.value===this.selected,A=H("flex-1 px-4 py-2 font-medium transition-colors duration-200",k?"bg-blue-600 text-white":"bg-white text-gray-700 hover:bg-gray-50",b>0?this.orientation==="vertical"?"border-t border-gray-300":"border-l border-gray-300":""),q=F("button",{className:A,text:g.label,attrs:{"data-value":g.value,"aria-pressed":k,type:"button"}});q.addEventListener("click",()=>{if(this.multiple){Array.isArray(this.selected)||(this.selected=[]);let R=this.selected.indexOf(g.value);R>-1?this.selected.splice(R,1):this.selected.push(g.value)}else this.selected=g.value;this.updateView(),this.onChange&&this.onChange(this.selected)}),o.appendChild(q),this.toggleButtons.push(q)}),o}updateView(){this.toggleButtons.forEach(e=>{let t=e.getAttribute("data-value"),o=this.multiple?Array.isArray(this.selected)&&this.selected.includes(t):t===this.selected;e.setAttribute("aria-pressed",o),e.className=H("flex-1 px-4 py-2 font-medium transition-colors duration-200",o?"bg-blue-600 text-white":"bg-white text-gray-700 hover:bg-gray-50")})}getValue(){return this.selected}setValue(e){this.selected=e,this.updateView()}}});var ds={};J(ds,{Toast:()=>We});var We,cs=Q(()=>{Z();K();We=class n extends z{constructor(e={}){super(e),this.message=e.message||"",this.type=e.type||"default",typeof e.duration<"u"?this.duration=e.duration:this.duration=typeof window<"u"&&window.innerWidth<640?2500:3e3,this.position=e.position||"top-right",this.className=e.className||"",this.onClose=e.onClose||null}destroy(){if(!this.element)return;let e=this.element;e.classList.add(this.getExitAnimationClass());let t=()=>{e.removeEventListener("animationend",t),super.destroy();let o=n.getContainer(this.position);o&&o.childElementCount===0&&o.parentNode&&(o.parentNode.removeChild(o),n._containers&&delete n._containers[this.position||"top-right"])};e.addEventListener("animationend",t),setTimeout(t,320)}static getContainer(e){let t=e||"top-right";if(this._containers||(this._containers={}),this._containers[t]&&document.body.contains(this._containers[t]))return this._containers[t];let o=F("div",{className:H("fixed z-50 p-2 flex flex-col gap-2 pointer-events-none",this.getPositionClassesForContainer(t))});return document.body.appendChild(o),this._containers[t]=o,o}static getPositionClassesForContainer(e){switch(e){case"top-left":return"top-4 left-4 items-start";case"top-right":return"top-4 right-4 items-end";case"bottom-left":return"bottom-4 left-4 items-start";case"bottom-right":return"bottom-4 right-4 items-end";case"top-center":return"top-4 left-1/2 -translate-x-1/2 items-center transform";default:return"top-4 right-4 items-end"}}create(){let e=n.getContainer(this.position),t=F("div",{className:H("rounded-lg shadow-lg p-2.5 flex items-center gap-2 min-w-0 max-w-[90vw] sm:max-w-sm bg-opacity-95",this.getEnterAnimationClass(),this.getTypeClasses(),this.className)}),o=F("span",{className:"text-base flex-shrink-0",text:this.getIcon()});t.appendChild(o);let g=F("span",{text:this.message,className:"flex-1 text-sm sm:text-base"});t.appendChild(g),t.setAttribute("role",this.type==="error"?"alert":"status"),t.setAttribute("aria-live",this.type==="error"?"assertive":"polite");let b=F("button",{className:"text-base hover:opacity-70 transition-opacity flex-shrink-0",text:"\xD7"});for(b.setAttribute("aria-label","Dismiss notification"),b.addEventListener("click",()=>{this.destroy()}),t.appendChild(b),this.element=t,e.appendChild(this.element);e.children.length>3;)e.removeChild(e.firstElementChild);return this.duration>0&&setTimeout(()=>{this.destroy()},this.duration),this.element}getEnterAnimationClass(){let e=this.position||"top-right";return e==="top-right"||e==="bottom-right"?"animate-slide-in-right transition-all duration-300 pointer-events-auto":e==="top-left"||e==="bottom-left"?"animate-slide-in-left transition-all duration-300 pointer-events-auto":"animate-slide-in-top transition-all duration-300 pointer-events-auto"}getExitAnimationClass(){let e=this.position||"top-right";return e==="top-right"||e==="bottom-right"?"animate-slide-out-right":e==="top-left"||e==="bottom-left"?"animate-slide-out-left":"animate-slide-out-top"}getPositionClasses(){let e={"top-left":"top-4 left-4","top-right":"top-4 right-4","bottom-left":"bottom-4 left-4","bottom-right":"bottom-4 right-4","top-center":"top-4 left-1/2 -translate-x-1/2 transform"};return e[this.position]||e["bottom-right"]}getTypeClasses(){let e={default:"bg-gray-900 text-white",success:"bg-green-600 text-white",error:"bg-red-600 text-white",warning:"bg-yellow-600 text-white",info:"bg-blue-600 text-white"};return e[this.type]||e.default}getIcon(){let e={default:"\u2139",success:"\u2713",error:"\u2715",warning:"\u26A0",info:"\u2139"};return e[this.type]||e.default}static show(e,t={}){let o=new n({message:e,...t}),g=o.create();return o}static success(e,t={}){return this.show(e,{...t,type:"success"})}static error(e,t={}){return this.show(e,{...t,type:"error",position:t.position||"top-right"})}static info(e,t={}){return this.show(e,{...t,type:"info"})}static warning(e,t={}){return this.show(e,{...t,type:"warning"})}};if(!document.querySelector("style[data-toast]")){let n=document.createElement("style");n.setAttribute("data-toast","true"),n.textContent=`
  ...
  `,document.head.appendChild(n)}});function us({root:n=document,selector:e="[data-hydrate]",threshold:t=.15}={}){if(typeof IntersectionObserver>"u")return;let o=new IntersectionObserver(async(g,b)=>{for(let k of g){if(!k.isIntersecting)continue;let A=k.target,q=A.dataset.hydrate||"",[R,Y="init"]=q.split("#");if(!R){b.unobserve(A);continue}try{let j=null,y=ar[R];if(typeof y=="function")j=await y();else throw new Error("Module not registered for lazy hydration: "+R);let M=j[Y]||j.default||null;if(typeof M=="function")try{M(A)}catch(D){console.error("hydrate init failed",D)}}catch(j){console.error("lazy hydrate import failed for",R,j)}finally{b.unobserve(A)}}},{threshold:t});n.querySelectorAll(e).forEach(g=>o.observe(g))}var ar,ms=Q(()=>{ar={"components/Alert.js":()=>Promise.resolve().then(()=>(et(),Ze)),"components/AlertDialog.js":()=>Promise.resolve().then(()=>(st(),tt)),"components/Avatar.js":()=>Promise.resolve().then(()=>(at(),rt)),"components/Badge.js":()=>Promise.resolve().then(()=>(ot(),nt)),"components/Button.js":()=>Promise.resolve().then(()=>(lt(),it)),"components/ButtonGroup.js":()=>Promise.resolve().then(()=>(ct(),dt)),"components/Breadcrumb.js":()=>Promise.resolve().then(()=>(mt(),ut)),"components/Card.js":()=>Promise.resolve().then(()=>(gt(),pt)),"components/Carousel.js":()=>Promise.resolve().then(()=>(ft(),ht)),"components/Chart.js":()=>Promise.resolve().then(()=>(bt(),xt)),"components/Checkbox.js":()=>Promise.resolve().then(()=>(yt(),vt)),"components/Collapsible.js":()=>Promise.resolve().then(()=>(kt(),wt)),"components/Command.js":()=>Promise.resolve().then(()=>(Et(),Ct)),"components/Combobox.js":()=>Promise.resolve().then(()=>($t(),Lt)),"components/ContextMenu.js":()=>Promise.resolve().then(()=>(It(),Tt)),"components/DatePicker.js":()=>Promise.resolve().then(()=>(St(),Bt)),"components/Dialog.js":()=>Promise.resolve().then(()=>(At(),_t)),"components/DropdownMenu.js":()=>Promise.resolve().then(()=>(qt(),Mt)),"components/Drawer.js":()=>Promise.resolve().then(()=>(Pt(),Ht)),"components/Empty.js":()=>Promise.resolve().then(()=>(Nt(),jt)),"components/Form.js":()=>Promise.resolve().then(()=>(zt(),Ft)),"components/HoverCard.js":()=>Promise.resolve().then(()=>(Rt(),Ot)),"components/Input.js":()=>Promise.resolve().then(()=>(Vt(),Dt)),"components/InputGroup.js":()=>Promise.resolve().then(()=>(Wt(),Ut)),"components/InputOTP.js":()=>Promise.resolve().then(()=>(Qt(),Yt)),"components/Item.js":()=>Promise.resolve().then(()=>(Jt(),Gt)),"components/Label.js":()=>Promise.resolve().then(()=>(Kt(),Xt)),"components/Kbd.js":()=>Promise.resolve().then(()=>(es(),Zt)),"components/NativeSelect.js":()=>Promise.resolve().then(()=>(ss(),ts)),"components/Tooltip.js":()=>Promise.resolve().then(()=>(as(),rs)),"components/Toggle.js":()=>Promise.resolve().then(()=>(os(),ns)),"components/ToggleGroup.js":()=>Promise.resolve().then(()=>(ls(),is)),"components/Toast.js":()=>Promise.resolve().then(()=>(cs(),ds))}});var gs={};J(gs,{default:()=>nr});var ps,nr,hs=Q(()=>{ps=(function(){"use strict";let n=null;async function e(){if(AuthGuard.protectPage()){await R();try{D()}catch{}Y(),M(),_(),C(),t()}}function t(){o(),g(),b(),k(),A(),q()}function o(){let r=document.getElementById("loyalty-points");if(!r)return;let s=n?.loyalty_points||Math.floor(Math.random()*500)+100,i=s>=500?"Gold":s>=200?"Silver":"Bronze",c={Bronze:"from-amber-600 to-amber-700",Silver:"from-gray-400 to-gray-500",Gold:"from-yellow-400 to-yellow-500"},u=i==="Gold"?null:i==="Silver"?"Gold":"Silver",m=i==="Gold"?0:i==="Silver"?500:200,l=u?Math.min(100,s/m*100):100;r.innerHTML=`
            <div class="bg-gradient-to-br ${c[i]} rounded-2xl p-6 text-white relative overflow-hidden">
                    ...
                    ${u?`
                        <div class="mt-4">
                            <div class="flex justify-between text-sm mb-1">
                                <span>${m-s} points to ${u}</span>
                                <span>${Math.round(l)}%</span>
                            </div>
                            <div class="w-full bg-white/30 rounded-full h-2">
                                <div class="bg-white h-2 rounded-full transition-all duration-500" style="width: ${l}%"></div>
                            </div>
                        </div>
        ...
        `}async function b(){let r=document.getElementById("recent-activity");if(r)try{let i=(await OrdersApi.getAll({limit:3})).data||[];if(i.length===0){r.innerHTML=`
                ...
                <div class="bg-white dark:bg-stone-800 rounded-xl border border-gray-100 dark:border-stone-700 overflow-hidden">
                    ...
                    <div class="divide-y divide-gray-100 dark:divide-stone-700">
                        ${i.map(c=>{let m={pending:"text-yellow-600 dark:text-yellow-400",processing:"text-blue-600 dark:text-blue-400",shipped:"text-indigo-600 dark:text-indigo-400",delivered:"text-green-600 dark:text-green-400",cancelled:"text-red-600 dark:text-red-400"}[c.status]||"text-stone-600 dark:text-stone-400",l=c.items?.[0];return`
                                <a href="/orders/${c.id}/" class="flex items-center gap-4 p-4 hover:bg-stone-50 dark:hover:bg-stone-700/50 transition-colors">
                                    <div class="w-12 h-12 bg-stone-100 dark:bg-stone-700 rounded-lg overflow-hidden flex-shrink-0">
                                        ${l?.product?.image?`<img src="${l.product.image}" alt="" class="w-full h-full object-cover">`:`<div class="w-full h-full flex items-center justify-center text-stone-400">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="font-medium text-stone-900 dark:text-white truncate">Order #${Templates.escapeHtml(c.order_number||c.id)}</p>
                                        <p class="text-sm ${m}">${Templates.escapeHtml(c.status_display||c.status)}</p>
                                    </div>
                                    <div class="text-right">
                                        <p class="font-semibold text-stone-900 dark:text-white">${Templates.formatPrice(c.total)}</p>
                                        <p class="text-xs text-stone-500 dark:text-stone-400">${Templates.formatDate(c.created_at)}</p>
                                    </div>
                                </a>
                            `}).join("")}
                    </div>
                </div>
            `}catch{r.innerHTML=""}}function k(){let r=document.getElementById("notification-preferences");if(!r)return;let s=JSON.parse(localStorage.getItem("notificationPreferences")||"{}"),c={...{orderUpdates:!0,promotions:!0,newArrivals:!1,priceDrops:!0,newsletter:!1},...s};r.innerHTML=`
            <div class="space-y-4">
                <div class="flex items-center justify-between">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" class="sr-only peer" data-pref="orderUpdates" ${c.orderUpdates?"checked":""}>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" class="sr-only peer" data-pref="promotions" ${c.promotions?"checked":""}>
                        <div class="w-11 h-6 bg-stone-200 dark:bg-stone-600 peer-focus:ring-2 peer-focus:ring-primary-300 dark:peer-focus:ring-amber-800 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-600 dark:peer-checked:bg-amber-500"></div>
                    </label>
                </div>
                <div class="flex items-center justify-between">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" class="sr-only peer" data-pref="priceDrops" ${c.priceDrops?"checked":""}>
                        <div class="w-11 h-6 bg-stone-200 dark:bg-stone-600 peer-focus:ring-2 peer-focus:ring-primary-300 dark:peer-focus:ring-amber-800 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-600 dark:peer-checked:bg-amber-500"></div>
                    </label>
                </div>
                <div class="flex items-center justify-between">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" class="sr-only peer" data-pref="newArrivals" ${c.newArrivals?"checked":""}>
                        <div class="w-11 h-6 bg-stone-200 dark:bg-stone-600 peer-focus:ring-2 peer-focus:ring-primary-300 dark:peer-focus:ring-amber-800 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-600 dark:peer-checked:bg-amber-500"></div>
                    </label>
                </div>
            </div>
        `,r.querySelectorAll("input[data-pref]").forEach(u=>{u.addEventListener("change",()=>{let m=u.dataset.pref,l=JSON.parse(localStorage.getItem("notificationPreferences")||"{}");l[m]=u.checked,localStorage.setItem("notificationPreferences",JSON.stringify(l)),Toast.success("Preference saved")})})}function A(){let r=document.getElementById("quick-reorder");if(!r)return;let s=JSON.parse(localStorage.getItem("recentlyOrdered")||"[]");if(s.length===0){r.classList.add("hidden");return}r.innerHTML=`
        ...
        `,r.querySelectorAll(".quick-reorder-btn").forEach(i=>{i.addEventListener("click",async()=>{let c=i.dataset.productId;i.disabled=!0;try{await CartApi.addItem(c,1),Toast.success("Added to cart!"),document.dispatchEvent(new CustomEvent("cart:updated"))}catch{Toast.error("Failed to add to cart")}finally{i.disabled=!1}})})}function q(){let r=document.getElementById("security-check");if(!r)return;let s=0,i=[],c=n?.email_verified!==!1;c&&(s+=25),i.push({label:"Email verified",completed:c});let u=!!n?.phone;u&&(s+=25),i.push({label:"Phone number added",completed:u});let m=n?.two_factor_enabled||!1;m&&(s+=25),i.push({label:"Two-factor authentication",completed:m});let l=!0;l&&(s+=25),i.push({label:"Strong password",completed:l});let f=s>=75?"text-green-600 dark:text-green-400":s>=50?"text-yellow-600 dark:text-yellow-400":"text-red-600 dark:text-red-400",I=s>=75?"bg-green-500":s>=50?"bg-yellow-500":"bg-red-500";r.innerHTML=`
            <div class="bg-white dark:bg-stone-800 rounded-xl border border-gray-100 dark:border-stone-700 p-4">
                <div class="flex items-center justify-between mb-4">
                ...
                <div class="space-y-2">
                    ${i.map($=>`
                        <div class="flex items-center gap-2 text-sm">
                            ${$.completed?'<svg class="w-4 h-4 text-green-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg>':'<svg class="w-4 h-4 text-stone-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke-width="2"/></svg>'}
                            <span class="${$.completed?"text-stone-700 dark:text-stone-300":"text-stone-500 dark:text-stone-400"}">${$.label}</span>
                        </div>
                    `).join("")}
                </div>
            </div>
        `}async function R(){if(AuthApi.isAuthenticated())try{n=(await AuthApi.getProfile()).data,j()}catch{Toast.error("Failed to load profile.")}}function Y(){let r=document.querySelectorAll("[data-profile-tab]"),s=document.querySelectorAll("[data-profile-panel]");if(!r.length||!s.length)return;let i=u=>{s.forEach(m=>{m.classList.toggle("hidden",m.dataset.profilePanel!==u)}),r.forEach(m=>{let l=m.dataset.profileTab===u;m.classList.toggle("bg-amber-600",l),m.classList.toggle("text-white",l),m.classList.toggle("shadow-sm",l),m.classList.toggle("text-stone-700",!l),m.classList.toggle("dark:text-stone-200",!l)}),localStorage.setItem("profileTab",u)},c=localStorage.getItem("profileTab")||"overview";i(c),r.forEach(u=>{u.addEventListener("click",()=>{i(u.dataset.profileTab)})})}function j(){let r=document.getElementById("profile-info");if(!r||!n)return;let s=`${Templates.escapeHtml(n.first_name||"")} ${Templates.escapeHtml(n.last_name||"")}`.trim()||Templates.escapeHtml(n.email||"User"),i=Templates.formatDate(n.created_at||n.date_joined),c=n.avatar?`<img id="avatar-preview" src="${n.avatar}" alt="Profile" class="w-full h-full object-cover">`:`
        ...
        `,D()}function y(){Tabs.init()}function M(){let r=document.getElementById("profile-form");if(!r||!n)return;let s=document.getElementById("profile-first-name"),i=document.getElementById("profile-last-name"),c=document.getElementById("profile-email"),u=document.getElementById("profile-phone");s&&(s.value=n.first_name||""),i&&(i.value=n.last_name||""),c&&(c.value=n.email||""),u&&(u.value=n.phone||""),r.addEventListener("submit",async m=>{m.preventDefault();let l=new FormData(r),f={first_name:l.get("first_name"),last_name:l.get("last_name"),phone:l.get("phone")},I=r.querySelector('button[type="submit"]');I.disabled=!0,I.textContent="Saving...";try{await AuthApi.updateProfile(f),Toast.success("Profile updated successfully!"),await R()}catch($){Toast.error($.message||"Failed to update profile.")}finally{I.disabled=!1,I.textContent="Save Changes"}})}function D(){let r=document.getElementById("avatar-input"),s=document.getElementById("change-avatar-btn"),i=document.getElementById("remove-avatar-btn");r||(r=document.createElement("input"),r.type="file",r.id="avatar-input",r.name="avatar",r.accept="image/*",r.className="hidden",document.body.appendChild(r)),document.querySelectorAll("#change-avatar-btn").forEach(m=>m.addEventListener("click",()=>r.click())),document.querySelectorAll("#remove-avatar-btn").forEach(m=>m.addEventListener("click",()=>{typeof window.removeAvatar=="function"&&window.removeAvatar()})),r.removeEventListener?.("change",window._avatarChangeHandler),window._avatarChangeHandler=async function(m){let l=m.target.files?.[0];if(l){if(!l.type.startsWith("image/")){Toast.error("Please select an image file.");return}if(l.size>5242880){Toast.error("Image must be smaller than 5MB.");return}try{await AuthApi.uploadAvatar(l),Toast.success("Avatar updated!"),await R()}catch(f){Toast.error(f.message||"Failed to update avatar.")}}},r.addEventListener("change",window._avatarChangeHandler)}function _(){let r=document.getElementById("password-form");r&&r.addEventListener("submit",async s=>{s.preventDefault();let i=new FormData(r),c=i.get("current_password"),u=i.get("new_password"),m=i.get("confirm_password");if(u!==m){Toast.error("Passwords do not match.");return}if(u.length<8){Toast.error("Password must be at least 8 characters.");return}let l=r.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Updating...";try{await AuthApi.changePassword(c,u),Toast.success("Password updated successfully!"),r.reset()}catch(f){Toast.error(f.message||"Failed to update password.")}finally{l.disabled=!1,l.textContent="Update Password"}})}function C(){v(),document.getElementById("add-address-btn")?.addEventListener("click",()=>{L()})}async function v(){let r=document.getElementById("addresses-list");if(r){Loader.show(r,"spinner");try{let i=(await AuthApi.getAddresses()).data||[];if(i.length===0){r.innerHTML=`
            ...
            `,confirmText:s?"Save Changes":"Add Address",onConfirm:async()=>{let i=document.getElementById("address-modal-form"),c=new FormData(i),u={first_name:c.get("first_name"),last_name:c.get("last_name"),phone:c.get("phone"),address_line_1:c.get("address_line_1"),address_line_2:c.get("address_line_2"),city:c.get("city"),state:c.get("state"),postal_code:c.get("postal_code"),country:c.get("country"),is_default:c.get("is_default")==="on"};try{return s?(await AuthApi.updateAddress(r.id,u),Toast.success("Address updated!")):(await AuthApi.addAddress(u),Toast.success("Address added!")),await v(),!0}catch(m){return Toast.error(m.message||"Failed to save address."),!1}}})}function h(){n=null}return{init:e,destroy:h}})();window.AccountPage=ps;nr=ps});var xs={};J(xs,{default:()=>or});var fs,or,bs=Q(()=>{fs=(function(){"use strict";let n=null,e=[],t=null,o=6e4;function g(){}function b(E){if(E==null||E==="")return 0;if(typeof E=="number"&&Number.isFinite(E))return E;let B=parseFloat(E);return Number.isFinite(B)?B:0}function k(E){let B=b(E);return Templates.formatPrice(B)}async function A(){await s(),$(),q()}function q(){R(),j(),_(),v(),S(),L(),r()}function R(){e=JSON.parse(localStorage.getItem("savedForLater")||"[]"),Y()}function Y(){let E=document.getElementById("saved-for-later");if(E){if(e.length===0){E.innerHTML="",E.classList.add("hidden");return}E.classList.remove("hidden"),E.innerHTML=`
        ...
        `,E.querySelectorAll(".move-to-cart-btn").forEach(B=>{B.addEventListener("click",async()=>{let O=B.closest(".saved-item")?.dataset.productId;if(O)try{await CartApi.addItem(O,1),e=e.filter(P=>P.id!==O),localStorage.setItem("savedForLater",JSON.stringify(e)),Toast.success("Item moved to cart"),await s(),Y()}catch{Toast.error("Failed to move item to cart")}})}),E.querySelectorAll(".remove-saved-btn").forEach(B=>{B.addEventListener("click",()=>{let O=B.closest(".saved-item")?.dataset.productId;O&&(e=e.filter(P=>P.id!==O),localStorage.setItem("savedForLater",JSON.stringify(e)),Y(),Toast.info("Item removed"))})}),document.getElementById("clear-saved-btn")?.addEventListener("click",()=>{e=[],localStorage.removeItem("savedForLater"),Y(),Toast.info("Saved items cleared")})}}function j(){let E=JSON.parse(localStorage.getItem("abandonedCart")||"null");E&&E.items?.length>0&&(!n||n.items?.length===0)&&M(E),y(),window.addEventListener("beforeunload",()=>{n&&n.items?.length>0&&localStorage.setItem("abandonedCart",JSON.stringify({items:n.items,savedAt:new Date().toISOString()}))})}function y(){let E=()=>{t&&clearTimeout(t),t=setTimeout(()=>{n&&n.items?.length>0&&D()},o)};["click","scroll","keypress","mousemove"].forEach(B=>{document.addEventListener(B,E,{passive:!0,once:!1})}),E()}function M(E){let B=document.createElement("div");B.id="abandoned-cart-modal",B.className="fixed inset-0 z-50 flex items-center justify-center p-4",B.innerHTML=`
            ...
            <div class="relative bg-white dark:bg-stone-800 rounded-2xl shadow-2xl max-w-md w-full p-6">
                ...
                <div class="text-center mb-6">
                    ...
                    <p class="text-stone-600 dark:text-stone-400">You left ${E.items.length} item(s) in your cart.</p>
                </div>
                <div class="max-h-48 overflow-y-auto mb-6 space-y-2">
                    ...
                    `).join("")}
                    ${E.items.length>3?`<p class="text-center text-sm text-stone-500 dark:text-stone-400">+${E.items.length-3} more items</p>`:""}
                </div>
        ...
        `,document.body.appendChild(B)}function D(){sessionStorage.getItem("cartReminderShown")||(Toast.info("Don't forget! You have items in your cart",{duration:8e3,action:{text:"Checkout",onClick:()=>window.location.href="/checkout/"}}),sessionStorage.setItem("cartReminderShown","true"))}function _(){C()}function C(){let E=document.getElementById("free-shipping-progress");if(!E||!n)return;let B=50,W=b(n.summary?.subtotal||n.subtotal||0),O=Math.max(0,B-W),P=Math.min(100,W/B*100);W>=B?E.innerHTML=`
            ...
            `}function v(){let E=document.getElementById("cart-delivery-estimate");if(!E)return;let B=new Date,W=3,O=7,P=new Date(B.getTime()+W*24*60*60*1e3),X=new Date(B.getTime()+O*24*60*60*1e3),ee=re=>re.toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric"});E.innerHTML=`
        ...
        `}async function S(){let E=document.getElementById("cart-recommendations");if(!(!E||!n||!n.items?.length))try{let B=n.items.map(P=>P.product?.id).filter(Boolean);if(!B.length)return;let W=await ProductsApi.getRelated(B[0],{limit:4}),O=W?.data||W?.results||[];if(!O.length)return;E.innerHTML=`
                <div class="mt-8">
            ...
            `,E.querySelectorAll(".quick-add-btn").forEach(P=>{P.addEventListener("click",async()=>{let X=P.dataset.productId;P.disabled=!0,P.textContent="Adding...";try{await CartApi.addItem(X,1),Toast.success("Added to cart"),await s()}catch{Toast.error("Failed to add item")}finally{P.disabled=!1,P.textContent="+ Add to Cart"}})})}catch(B){console.warn("Failed to load recommendations:",B)}}function L(){let E=document.getElementById("cart-note"),B=document.getElementById("gift-order");if(E){let W=localStorage.getItem("cartNote")||"";E.value=W,E.addEventListener("input",h(()=>{localStorage.setItem("cartNote",E.value)},500))}if(B){let W=localStorage.getItem("isGiftOrder")==="true";B.checked=W,B.addEventListener("change",()=>{localStorage.setItem("isGiftOrder",B.checked)})}}function h(E,B){let W;return function(...P){clearTimeout(W),W=setTimeout(()=>E(...P),B)}}function r(){let E=document.getElementById("express-checkout");E&&(E.innerHTML=`
        ...
        `,E.querySelectorAll(".express-pay-btn").forEach(B=>{B.addEventListener("click",()=>{Toast.info("Express checkout coming soon!")})}))}async function s(){let E=document.getElementById("cart-container");if(E){Loader.show(E,"skeleton");try{n=(await CartApi.getCart()).data,i(n)}catch(B){console.error("Failed to load cart:",B),E.innerHTML='<p class="text-red-500 text-center py-8">Failed to load cart. Please try again.</p>'}}}function i(E){let B=document.getElementById("cart-container");if(!B)return;let W=E?.items||[],O=E?.summary||{},P=O.subtotal??E?.subtotal??0,X=b(O.discount_amount??E?.discount_amount),ee=O.tax_amount??E?.tax_amount??0,re=O.total??E?.total??0,se=E?.coupon?.code||"";if(W.length===0){B.innerHTML=`
        ...
        `,u(),q()}function c(E){let B=E.product||{},W=E.variant,O=B.slug||"#",P=B.name||"Product",X=B.primary_image||B.image,ee=b(E.price_at_add),re=b(E.current_price),se=b(E.line_total)||re*(E.quantity||1),oe=ee>re;return`
            <div class="cart-item p-6 flex gap-4" data-item-id="${E.id}" data-product-id="${B.id}">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        ...
                        <div class="text-right">
                            ${oe?`
                                <span class="text-sm text-gray-400 dark:text-stone-500 line-through">${k(ee*E.quantity)}</span>
                            `:""}
        ...
        `}function u(){let E=document.getElementById("cart-items"),B=document.getElementById("clear-cart-btn"),W=document.getElementById("remove-coupon-btn");E?.addEventListener("click",async O=>{let P=O.target.closest(".cart-item");if(!P)return;let X=P.dataset.itemId,ee=P.dataset.productId,re=P.querySelector(".item-quantity");if(O.target.closest(".remove-item-btn"))await l(X);else if(O.target.closest(".save-for-later-btn"))await f(X,ee,P);else if(O.target.closest(".qty-decrease")){let se=parseInt(re.value)||1;se>1&&await m(X,se-1)}else if(O.target.closest(".qty-increase")){let se=parseInt(re.value)||1,oe=parseInt(re.max)||99;se<oe&&await m(X,se+1)}}),E?.addEventListener("change",async O=>{if(O.target.classList.contains("item-quantity")){let X=O.target.closest(".cart-item")?.dataset.itemId,ee=parseInt(O.target.value)||1;X&&ee>0&&await m(X,ee)}}),B?.addEventListener("click",async()=>{await Modal.confirm({title:"Clear Cart",message:"Are you sure you want to remove all items from your cart?",confirmText:"Clear Cart",cancelText:"Cancel"})&&await I()}),W?.addEventListener("click",async()=>{await N()})}async function m(E,B){try{await CartApi.updateItem(E,B),await s(),document.dispatchEvent(new CustomEvent("cart:updated"))}catch(W){Toast.error(W.message||"Failed to update quantity.")}}async function l(E){try{await CartApi.removeItem(E),Toast.success("Item removed from cart."),await s(),document.dispatchEvent(new CustomEvent("cart:updated"))}catch(B){Toast.error(B.message||"Failed to remove item.")}}async function f(E,B,W){try{let O=n?.items?.find(re=>String(re.id)===String(E));if(!O)return;let P=O.product||{},X={id:B,name:P.name||"Product",image:P.primary_image||P.image||"",price:O.current_price||P.price||0};e.findIndex(re=>re.id===B)===-1&&(e.push(X),localStorage.setItem("savedForLater",JSON.stringify(e))),await CartApi.removeItem(E),Toast.success("Item saved for later"),await s(),document.dispatchEvent(new CustomEvent("cart:updated"))}catch(O){Toast.error(O.message||"Failed to save item.")}}async function I(){try{await CartApi.clearCart(),Toast.success("Cart cleared."),await s(),document.dispatchEvent(new CustomEvent("cart:updated"))}catch(E){Toast.error(E.message||"Failed to clear cart.")}}function $(){let E=document.getElementById("coupon-form");E?.addEventListener("submit",async B=>{B.preventDefault();let O=document.getElementById("coupon-code")?.value.trim();if(!O){Toast.error("Please enter a coupon code.");return}let P=E.querySelector('button[type="submit"]');P.disabled=!0,P.textContent="Applying...";try{await CartApi.applyCoupon(O),Toast.success("Coupon applied!"),await s()}catch(X){Toast.error(X.message||"Invalid coupon code.")}finally{P.disabled=!1,P.textContent="Apply"}})}async function N(){try{await CartApi.removeCoupon(),Toast.success("Coupon removed."),await s()}catch(E){Toast.error(E.message||"Failed to remove coupon.")}}function V(){n=null}return{init:A,destroy:V}})();window.CartPage=fs;or=fs});var ys={};J(ys,{default:()=>ir});var vs,ir,ws=Q(()=>{vs=(function(){"use strict";let n={},e=1,t=null,o=null,g=!1,b=!1,k=!0,A=[],q=[],R=4;async function Y(){if(g)return;g=!0;let a=I();if(!a)return;let d=document.getElementById("category-header");if(d&&d.querySelector("h1")){oe(),le(),de(),j();return}n=$(),e=parseInt(new URLSearchParams(window.location.search).get("page"))||1,await N(a),oe(),le(),de(),j()}function j(){y(),_(),r(),i(),u(),l()}function y(){let a=document.getElementById("load-more-trigger");if(!a)return;new IntersectionObserver(p=>{p.forEach(x=>{x.isIntersecting&&!b&&k&&M()})},{rootMargin:"200px 0px",threshold:.01}).observe(a)}async function M(){if(b||!k||!t)return;b=!0,e++;let a=document.getElementById("loading-more-indicator");a&&a.classList.remove("hidden");try{let d={category:t.id,page:e,limit:12,...n},p=await ProductsApi.getAll(d),x=p.data||[],w=p.meta||{};x.length===0?k=!1:(A=[...A,...x],D(x),k=e<(w.total_pages||1)),X()}catch(d){console.error("Failed to load more products:",d)}finally{b=!1,a&&a.classList.add("hidden")}}function D(a){let d=document.getElementById("products-grid");if(!d)return;let p=Storage.get("productViewMode")||"grid";a.forEach(x=>{let w=ProductCard.render(x,{layout:p,showCompare:!0,showQuickView:!0}),T=document.createElement("div");T.innerHTML=w;let U=T.firstElementChild;U.classList.add("animate-fadeInUp"),d.appendChild(U)}),ProductCard.bindEvents(d)}function _(){q=JSON.parse(localStorage.getItem("compareProducts")||"[]"),v(),document.addEventListener("click",a=>{let d=a.target.closest("[data-compare]");if(!d)return;a.preventDefault();let p=parseInt(d.dataset.compare);C(p)})}function C(a){let d=q.findIndex(p=>p.id===a);if(d>-1)q.splice(d,1),Toast.info("Removed from compare");else{if(q.length>=R){Toast.warning(`You can compare up to ${R} products`);return}let p=A.find(x=>x.id===a);p&&(q.push({id:p.id,name:p.name,image:p.primary_image||p.image,price:p.price,sale_price:p.sale_price}),Toast.success("Added to compare"))}localStorage.setItem("compareProducts",JSON.stringify(q)),v(),S()}function v(){let a=document.getElementById("compare-bar");if(q.length===0){a?.remove();return}a||(a=document.createElement("div"),a.id="compare-bar",a.className="fixed bottom-0 left-0 right-0 bg-white dark:bg-stone-800 border-t border-stone-200 dark:border-stone-700 shadow-2xl z-40 transform transition-transform duration-300",document.body.appendChild(a)),a.innerHTML=`
        ...
        `,a.querySelectorAll("[data-remove-compare]").forEach(d=>{d.addEventListener("click",()=>{let p=parseInt(d.dataset.removeCompare);C(p)})}),document.getElementById("compare-now-btn")?.addEventListener("click",h),document.getElementById("clear-compare-btn")?.addEventListener("click",L)}function S(){document.querySelectorAll("[data-compare]").forEach(a=>{let d=parseInt(a.dataset.compare);q.some(x=>x.id===d)?(a.classList.add("bg-primary-100","text-primary-600"),a.classList.remove("bg-stone-100","text-stone-600")):(a.classList.remove("bg-primary-100","text-primary-600"),a.classList.add("bg-stone-100","text-stone-600"))})}function L(){q=[],localStorage.removeItem("compareProducts"),v(),S(),Toast.info("Compare list cleared")}async function h(){if(q.length<2)return;let a=document.createElement("div");a.id="compare-modal",a.className="fixed inset-0 z-50 overflow-auto",a.innerHTML=`
        ...
        `,document.body.appendChild(a)}function r(){document.addEventListener("click",async a=>{let d=a.target.closest("[data-quick-view]");if(!d)return;let p=d.dataset.quickView;p&&(a.preventDefault(),await s(p))})}async function s(a){let d=document.createElement("div");d.id="quick-view-modal",d.className="fixed inset-0 z-50 flex items-center justify-center p-4",d.innerHTML=`
        ...
        `,document.body.appendChild(d);try{let p=await ProductsApi.getProduct(a),x=p.data||p,w=d.querySelector(".relative");w.innerHTML=`
            ...
            `;let T=document.getElementById("qv-qty-input"),U=document.getElementById("qv-qty-minus"),G=document.getElementById("qv-qty-plus"),te=document.getElementById("qv-add-to-cart");U?.addEventListener("click",()=>{let ae=parseInt(T.value)||1;ae>1&&(T.value=ae-1)}),G?.addEventListener("click",()=>{let ae=parseInt(T.value)||1,ne=parseInt(T.max)||99;ae<ne&&(T.value=ae+1)}),te?.addEventListener("click",async()=>{let ae=parseInt(T.value)||1;te.disabled=!0,te.innerHTML='<svg class="animate-spin h-5 w-5 mx-auto" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>';try{await CartApi.addItem(x.id,ae),Toast.success("Added to cart"),d.remove()}catch{Toast.error("Failed to add to cart")}finally{te.disabled=!1,te.innerHTML='<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/></svg> Add to Cart'}})}catch(p){console.error("Failed to load product:",p),d.remove(),Toast.error("Failed to load product details")}}function i(){if(!document.getElementById("price-range-slider"))return;let d=document.getElementById("filter-min-price"),p=document.getElementById("filter-max-price");!d||!p||[d,p].forEach(x=>{x.addEventListener("input",()=>{c()})})}function c(){let a=document.getElementById("price-range-display"),d=document.getElementById("filter-min-price")?.value||0,p=document.getElementById("filter-max-price")?.value||"\u221E";a&&(a.textContent=`$${d} - $${p}`)}function u(){m()}function m(){let a=document.getElementById("active-filters");if(!a)return;let d=[];if(n.min_price&&d.push({key:"min_price",label:`Min: $${n.min_price}`}),n.max_price&&d.push({key:"max_price",label:`Max: $${n.max_price}`}),n.in_stock&&d.push({key:"in_stock",label:"In Stock"}),n.on_sale&&d.push({key:"on_sale",label:"On Sale"}),n.ordering){let p={price:"Price: Low to High","-price":"Price: High to Low","-created_at":"Newest First",name:"A-Z","-popularity":"Most Popular"};d.push({key:"ordering",label:p[n.ordering]||n.ordering})}if(d.length===0){a.innerHTML="";return}a.innerHTML=`
        ...
        `,a.querySelectorAll("[data-remove-filter]").forEach(p=>{p.addEventListener("click",()=>{let x=p.dataset.removeFilter;delete n[x],P()})}),document.getElementById("clear-all-active-filters")?.addEventListener("click",()=>{n={},P()})}function l(){f()}function f(a=null){let d=document.getElementById("product-count");d&&a!==null&&(d.textContent=`${a} products`)}function I(){let d=window.location.pathname.match(/\/categories\/([^\/]+)/);return d?d[1]:null}function $(){let a=new URLSearchParams(window.location.search),d={};a.get("min_price")&&(d.min_price=a.get("min_price")),a.get("max_price")&&(d.max_price=a.get("max_price")),a.get("ordering")&&(d.ordering=a.get("ordering")),a.get("in_stock")&&(d.in_stock=a.get("in_stock")==="true"),a.get("on_sale")&&(d.on_sale=a.get("on_sale")==="true");let p=a.getAll("attr");return p.length&&(d.attributes=p),d}async function N(a){let d=document.getElementById("category-header"),p=document.getElementById("category-products"),x=document.getElementById("category-filters");d&&Loader.show(d,"skeleton"),p&&Loader.show(p,"skeleton");try{let w=await CategoriesApi.getCategory(a);if(t=w.data||w,!t){window.location.href="/404/";return}V(t),await E(t),await B(t),await ee(),await se(t)}catch(w){console.error("Failed to load category:",w),d&&(d.innerHTML='<p class="text-red-500">Failed to load category.</p>')}}function V(a){let d=document.getElementById("category-header");d&&(document.title=`${a.name} | Bunoraa`,d.innerHTML=`
        ...
        `)}async function E(a){let d=document.getElementById("breadcrumbs");if(d)try{let x=(await CategoriesApi.getBreadcrumbs(a.id)).data||[],w=[{label:"Home",url:"/"},{label:"Categories",url:"/categories/"},...x.map(T=>({label:T.name,url:`/categories/${T.slug}/`}))];d.innerHTML=Breadcrumb.render(w)}catch(p){console.error("Failed to load breadcrumbs:",p)}}async function B(a){let d=document.getElementById("category-filters");if(d)try{let x=(await ProductsApi.getFilterOptions({category:a.id})).data||{};d.innerHTML=`
                <div class="space-y-6">
                    <!-- Price Range -->
                                    ...
                                    ${w.values.map(T=>`
                                        <label class="flex items-center">
                                            <input 
                                                type="checkbox" 
                                                name="attr-${w.slug}"
                                                value="${Templates.escapeHtml(T.value)}"
                                                ${n.attributes?.includes(`${w.slug}:${T.value}`)?"checked":""}
                                                class="filter-attribute w-4 h-4 text-primary-600 border-gray-300 rounded focus:ring-primary-500"
                                                data-attribute="${w.slug}"
                                            >
                                            <span class="ml-2 text-sm text-gray-600">${Templates.escapeHtml(T.value)}</span>
                                            ${T.count?`<span class="ml-auto text-xs text-gray-400">(${T.count})</span>`:""}
                                        </label>
                                    `).join("")}
                                </div>
                            </div>
            ...
            `,W()}catch(p){console.error("Failed to load filters:",p),d.innerHTML=""}}function W(){let a=document.getElementById("apply-price-filter"),d=document.getElementById("filter-in-stock"),p=document.getElementById("filter-on-sale"),x=document.getElementById("clear-filters"),w=document.querySelectorAll(".filter-attribute");a?.addEventListener("click",()=>{let T=document.getElementById("filter-min-price")?.value,U=document.getElementById("filter-max-price")?.value;T?n.min_price=T:delete n.min_price,U?n.max_price=U:delete n.max_price,P()}),d?.addEventListener("change",T=>{T.target.checked?n.in_stock=!0:delete n.in_stock,P()}),p?.addEventListener("change",T=>{T.target.checked?n.on_sale=!0:delete n.on_sale,P()}),w.forEach(T=>{T.addEventListener("change",()=>{O(),P()})}),x?.addEventListener("click",()=>{n={},e=1,P()})}function O(){let a=document.querySelectorAll(".filter-attribute:checked"),d=[];a.forEach(p=>{d.push(`${p.dataset.attribute}:${p.value}`)}),d.length?n.attributes=d:delete n.attributes}function P(){e=1,X(),ee()}function X(){let a=new URLSearchParams;n.min_price&&a.set("min_price",n.min_price),n.max_price&&a.set("max_price",n.max_price),n.ordering&&a.set("ordering",n.ordering),n.in_stock&&a.set("in_stock","true"),n.on_sale&&a.set("on_sale","true"),n.attributes&&n.attributes.forEach(p=>a.append("attr",p)),e>1&&a.set("page",e);let d=`${window.location.pathname}${a.toString()?"?"+a.toString():""}`;window.history.pushState({},"",d)}async function ee(){let a=document.getElementById("category-products");if(!(!a||!t)){o&&o.abort(),o=new AbortController,Loader.show(a,"skeleton");try{let d={category:t.id,page:e,limit:12,...n};n.attributes&&(delete d.attributes,n.attributes.forEach(T=>{let[U,G]=T.split(":");d[`attr_${U}`]=G}));let p=await ProductsApi.getAll(d),x=p.data||[],w=p.meta||{};A=x,k=e<(w.total_pages||1),re(x,w),m(),f(w.total||x.length)}catch(d){if(d.name==="AbortError")return;console.error("Failed to load products:",d),a.innerHTML='<p class="text-red-500 text-center py-8">Failed to load products. Please try again.</p>'}}}function re(a,d){let p=document.getElementById("category-products");if(!p)return;let x=Storage.get("productViewMode")||"grid",w=x==="list"?"space-y-4":"grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6";if(a.length===0){p.innerHTML=`
            ...
            `,document.getElementById("clear-filters-empty")?.addEventListener("click",()=>{n={},e=1,P()});return}if(p.innerHTML=`
            <div id="active-filters" class="mb-4"></div>
            <div id="products-grid" class="${w}">
                ${a.map(T=>ProductCard.render(T,{layout:x,showCompare:!0,showQuickView:!0})).join("")}
            </div>
        ...
        `,ProductCard.bindEvents(p),m(),S(),y(),d.total_pages>1){let T=document.getElementById("products-pagination");T.innerHTML=Pagination.render({currentPage:d.current_page||e,totalPages:d.total_pages,totalItems:d.total}),T.addEventListener("click",U=>{let G=U.target.closest("[data-page]");G&&(e=parseInt(G.dataset.page),k=!0,X(),ee(),window.scrollTo({top:0,behavior:"smooth"}))})}}async function se(a){let d=document.getElementById("subcategories");if(d)try{let x=(await CategoriesApi.getSubcategories(a.id)).data||[];if(x.length===0){d.innerHTML="";return}d.innerHTML=`
            ...
            `}catch(p){console.error("Failed to load subcategories:",p),d.innerHTML=""}}function oe(){let a=document.getElementById("mobile-filter-btn"),d=document.getElementById("filter-sidebar"),p=document.getElementById("close-filter-btn");a?.addEventListener("click",()=>{d?.classList.remove("hidden"),document.body.classList.add("overflow-hidden")}),p?.addEventListener("click",()=>{d?.classList.add("hidden"),document.body.classList.remove("overflow-hidden")})}function le(){let a=document.getElementById("sort-select");a&&(a.value=n.ordering||"",a.addEventListener("change",d=>{d.target.value?n.ordering=d.target.value:delete n.ordering,P()}))}function de(){let a=document.getElementById("view-grid"),d=document.getElementById("view-list");(Storage.get("productViewMode")||"grid")==="list"&&(a?.classList.remove("bg-gray-200"),d?.classList.add("bg-gray-200")),a?.addEventListener("click",()=>{Storage.set("productViewMode","grid"),a.classList.add("bg-gray-200"),d?.classList.remove("bg-gray-200"),ee()}),d?.addEventListener("click",()=>{Storage.set("productViewMode","list"),d.classList.add("bg-gray-200"),a?.classList.remove("bg-gray-200"),ee()})}function me(){o&&(o.abort(),o=null),n={},e=1,t=null,g=!1,b=!1,k=!0,A=[],document.getElementById("compare-bar")?.remove(),document.getElementById("quick-view-modal")?.remove(),document.getElementById("compare-modal")?.remove()}return{init:Y,destroy:me,toggleCompare:C,clearCompare:L}})();window.CategoryPage=vs;ir=vs});var Cs={};J(Cs,{default:()=>lr});var ks,lr,Es=Q(()=>{ks=(async function(){"use strict";let n=null,e={shipping_address:null,billing_address:null,same_as_shipping:!0,shipping_method:null,payment_method:null,notes:""},t=1;async function o(){if(!AuthApi.isAuthenticated()&&!document.getElementById("guest-checkout")){Toast.info("Please login to continue checkout."),window.location.href="/account/login/?next=/checkout/";return}if(await g(),!n||!n.items||n.items.length===0){Toast.warning("Your cart is empty."),window.location.href="/cart/";return}await k(),q(),s(),h()}async function g(){try{n=(await CartApi.getCart()).data,b()}catch(l){console.error("Failed to load cart:",l),Toast.error("Failed to load cart.")}}function b(){let l=document.getElementById("order-summary");!l||!n||(l.innerHTML=`
        ...
        `)}async function k(){if(AuthApi.isAuthenticated())try{let f=(await AuthApi.getAddresses()).data||[],I=document.getElementById("saved-addresses");I&&f.length>0&&(I.innerHTML=`
                        ...
                        <div class="space-y-2">
                            ${f.map($=>`
                                <label class="flex items-start p-3 border border-gray-200 rounded-lg cursor-pointer hover:border-primary-500 transition-colors">
                                    <input type="radio" name="saved_address" value="${$.id}" class="mt-1 text-primary-600 focus:ring-primary-500">
                                    <div class="ml-3">
                                        <p class="font-medium text-gray-900">${Templates.escapeHtml($.full_name||`${$.first_name} ${$.last_name}`)}</p>
                                        <p class="text-sm text-gray-600">${Templates.escapeHtml($.address_line_1)}</p>
                                        ${$.address_line_2?`<p class="text-sm text-gray-600">${Templates.escapeHtml($.address_line_2)}</p>`:""}
                                        <p class="text-sm text-gray-600">${Templates.escapeHtml($.city)}, ${Templates.escapeHtml($.state||"")} ${Templates.escapeHtml($.postal_code)}</p>
                                        <p class="text-sm text-gray-600">${Templates.escapeHtml($.country)}</p>
                                        ${$.is_default?'<span class="inline-block mt-1 px-2 py-0.5 bg-primary-100 text-primary-700 text-xs rounded">Default</span>':""}
                                    </div>
                                </label>
                            `).join("")}
                ...
                `,A())}catch(l){console.error("Failed to load addresses:",l)}}function A(){let l=document.querySelectorAll('input[name="saved_address"]'),f=document.getElementById("new-address-form");l.forEach(I=>{I.addEventListener("change",$=>{$.target.value==="new"?f?.classList.remove("hidden"):(f?.classList.add("hidden"),e.shipping_address=$.target.value)})})}function q(){let l=document.querySelectorAll("[data-step]"),f=document.querySelectorAll("[data-step-indicator]"),I=document.querySelectorAll("[data-next-step]"),$=document.querySelectorAll("[data-prev-step]");function N(V){l.forEach(E=>{E.classList.toggle("hidden",parseInt(E.dataset.step)!==V)}),f.forEach(E=>{let B=parseInt(E.dataset.stepIndicator);E.classList.toggle("bg-primary-600",B<=V),E.classList.toggle("text-white",B<=V),E.classList.toggle("bg-gray-200",B>V),E.classList.toggle("text-gray-600",B>V)}),t=V}I.forEach(V=>{V.addEventListener("click",async()=>{await R()&&(t===1&&await D(),N(t+1),window.scrollTo({top:0,behavior:"smooth"}))})}),$.forEach(V=>{V.addEventListener("click",()=>{N(t-1),window.scrollTo({top:0,behavior:"smooth"})})}),N(1)}async function R(){switch(t){case 1:return M();case 2:return L();case 3:return r();default:return!0}}function Y(l){l&&(l.querySelectorAll("[data-error-for]").forEach(f=>f.remove()),l.querySelectorAll(".!border-red-500").forEach(f=>f.classList.remove("!border-red-500")))}function j(l,f){if(!l)return;let I=l.getAttribute("name")||l.id||Math.random().toString(36).slice(2,8),$=l.closest("form")?.querySelector(`[data-error-for="${I}"]`);$&&$.remove();let N=document.createElement("p");N.className="text-sm text-red-600 mt-1",N.setAttribute("data-error-for",I),N.textContent=f,l.classList.add("!border-red-500"),l.nextSibling?l.parentNode.insertBefore(N,l.nextSibling):l.parentNode.appendChild(N)}function y(l){if(!l)return;let f=l.querySelector("[data-error-for]");if(!f)return;let I=f.getAttribute("data-error-for"),$=l.querySelector(`[name="${I}"]`)||l.querySelector(`#${I}`)||f.previousElementSibling;if($&&typeof $.focus=="function")try{$.focus({preventScroll:!0})}catch{$.focus()}}function M(){let l=document.querySelector('input[name="saved_address"]:checked');if(l&&l.value!=="new")return Y(document.getElementById("new-address-form")||document.getElementById("information-form")),e.shipping_address=l.value,!0;let f=document.getElementById("shipping-address-form")||document.getElementById("information-form")||document.getElementById("new-address-form");if(!f)return!1;Y(f);let I=new FormData(f),$={first_name:I.get("first_name")||I.get("full_name")?.split(" ")?.[0],last_name:I.get("last_name")||(I.get("full_name")?I.get("full_name").split(" ").slice(1).join(" "):""),email:I.get("email"),phone:I.get("phone"),address_line_1:I.get("address_line1")||I.get("address_line_1"),address_line_2:I.get("address_line2")||I.get("address_line_2"),city:I.get("city"),state:I.get("state"),postal_code:I.get("postal_code"),country:I.get("country")},V=["email","first_name","address_line_1","city","postal_code"].filter(E=>!$[E]);if(V.length>0)return V.forEach(E=>{let B=`[name="${E}"]`;E==="address_line_1"&&(B='[name="address_line1"],[name="address_line_1"]');let W=f.querySelector(B);j(W||f,E.replace("_"," ").replace(/\b\w/g,O=>O.toUpperCase())+" is required.")}),y(f),!1;if($.email&&!/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test($.email)){let E=f.querySelector('[name="email"]');return j(E||f,"Please enter a valid email address."),y(f),!1}return e.shipping_address=$,!0}async function D(){let l=document.getElementById("shipping-methods");if(l){Loader.show(l,"spinner");try{let f=e.shipping_address;if(!f){l.innerHTML='<p class="text-gray-500">Please provide a shipping address to view shipping methods.</p>';return}let I=typeof f=="object"?{country:f.country,postal_code:f.postal_code,city:f.city}:{address_id:f},N=(await ShippingApi.getRates(I)).data||[];if(N.length===0){l.innerHTML='<p class="text-gray-500">No shipping methods available for your location.</p>';return}l.innerHTML=`
                <div class="space-y-3">
                    ${N.map((E,B)=>`
                        <label class="flex items-center justify-between p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-primary-500 transition-colors">
                            <div class="flex items-center">
                                ...
                                >
                                <div class="ml-3">
                                    <p class="font-medium text-gray-900">${Templates.escapeHtml(E.name)}</p>
                                    ${E.description?`<p class="text-sm text-gray-500">${Templates.escapeHtml(E.description)}</p>`:""}
                                    ${E.estimated_days?`<p class="text-sm text-gray-500">Delivery in ${E.estimated_days} days</p>`:""}
                                </div>
                            </div>
                            <span class="font-semibold text-gray-900">${E.price>0?Templates.formatPrice(E.price):"Free"}</span>
                        </label>
                    `).join("")}
                </div>
            `,l.querySelectorAll('input[name="shipping_method"]').forEach((E,B)=>{E.__price=N[B]?N[B].price:0,E.addEventListener("change",()=>{S(parseFloat(E.__price)||0)})}),N.length>0&&(e.shipping_method=N[0].id,S(N[0].price||0))}catch(f){console.error("Failed to load shipping methods:",f),l.innerHTML='<p class="text-red-500">Failed to load shipping methods. Please try again.</p>'}}}async function _(){let l=document.getElementById("payment-methods-container");if(l)try{let f=new URLSearchParams;window.CONFIG&&CONFIG.shippingData&&CONFIG.shippingData.countryCode&&f.set("country",CONFIG.shippingData.countryCode),n&&(n.total||n.total===0)&&f.set("amount",n.total);let $=await(await fetch(`/api/v1/payments/gateways/available/?${f.toString()}`,{credentials:"same-origin"})).json(),N=$&&$.data||[],V=l.querySelectorAll(".payment-option");if(V&&V.length>0){try{let B=Array.from(V).map(P=>P.dataset.gateway).filter(Boolean),W=(N||[]).map(P=>P.code);if(B.length===W.length&&B.every((P,X)=>P===W[X])){s();return}}catch(B){console.warn("Failed to compare existing payment gateways:",B)}if(N.length===0)return}if(!N||N.length===0){l.innerHTML=`
                ...
                `,O.appendChild(P),O.appendChild(X);let ee=document.createElement("div");ee.className="absolute top-4 right-4 opacity-0 peer-checked:opacity-100 transition-opacity duration-300",ee.innerHTML='<svg class="w-6 h-6 text-primary-600" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"></path></svg>',O.appendChild(ee),E.appendChild(O),B.public_key&&B.requires_client&&C(B.public_key).catch(re=>console.error("Failed to load Stripe:",re))}),l.replaceChildren(E),s()}catch(f){console.error("Failed to load payment gateways:",f)}}function C(l){return new Promise((f,I)=>{if(window.Stripe&&window.STRIPE_PUBLISHABLE_KEY===l){f();return}if(window.STRIPE_PUBLISHABLE_KEY=l,window.Stripe){v(l),f();return}let $=document.createElement("script");$.src="https://js.stripe.com/v3/",$.async=!0,$.onload=()=>{try{v(l),f()}catch(N){I(N)}},$.onerror=N=>I(N),document.head.appendChild($)})}function v(l){if(typeof Stripe>"u")throw new Error("Stripe script not loaded");try{let f=Stripe(l),$=f.elements().create("card"),N=document.getElementById("card-element");N&&(N.innerHTML="",$.mount("#card-element"),$.on("change",V=>{let E=document.getElementById("card-errors");E&&(E.textContent=V.error?V.error.message:"")}),window.stripeInstance=f,window.stripeCard=$)}catch(f){throw console.error("Error initializing Stripe elements:",f),f}}(function(){document.addEventListener("DOMContentLoaded",()=>{setTimeout(()=>{_()},50)})})();function S(l){let f=document.getElementById("shipping-cost"),I=document.getElementById("order-total");if(f&&(f.textContent=l>0?Templates.formatPrice(l):"Free"),I&&n){let $=(n.total||0)+l;I.textContent=Templates.formatPrice($)}}function L(){let l=document.querySelector('input[name="shipping_method"]:checked');return l?(e.shipping_method=l.value,!0):(Toast.error("Please select a shipping method."),!1)}function h(){let l=document.getElementById("order-summary-toggle"),f=document.getElementById("order-summary-block");if(!l||!f)return;l.addEventListener("click",()=>{let $=f.classList.toggle("hidden");l.setAttribute("aria-expanded",(!$).toString());let N=l.querySelector("svg");N&&N.classList.toggle("rotate-180",!$)});let I=window.getComputedStyle(f).display==="none"||f.classList.contains("hidden");l.setAttribute("aria-expanded",(!I).toString())}function r(){let l=document.querySelector('input[name="payment_method"]:checked'),f=document.getElementById("payment-form");if(Y(f),!l){let $=document.getElementById("payment-methods-container")||f;return j($,"Please select a payment method."),y($),!1}let I=l.value;if(I==="stripe"){let $=document.getElementById("cardholder-name");if(!$||!$.value.trim())return j($||f,"Cardholder name is required."),y(f),!1;if(!window.stripeCard)return j(document.getElementById("card-element")||f,"Card input not ready. Please wait and try again."),!1}if(I==="bkash"){let $=document.getElementById("bkash-number");if(!$||!$.value.trim())return j($||f,"bKash mobile number is required."),y(f),!1}if(I==="nagad"){let $=document.getElementById("nagad-number");if(!$||!$.value.trim())return j($||f,"Nagad mobile number is required."),y(f),!1}return e.payment_method=I,!0}function s(){let l=document.getElementById("same-as-shipping"),f=document.getElementById("billing-address-form");l?.addEventListener("change",V=>{e.same_as_shipping=V.target.checked,f?.classList.toggle("hidden",V.target.checked)}),document.querySelectorAll('input[name="payment_method"]').forEach(V=>{let E=B=>{document.querySelectorAll("[data-payment-form]").forEach(P=>{P.classList.add("hidden")});let W=B.target?B.target.value:V.value||null;if(!W)return;let O=document.querySelector(`[data-payment-form="${W}"]`);O||(O=document.getElementById(`${W}-form`)),O?.classList.remove("hidden")};V.addEventListener("change",E),V.checked&&E({target:V})});let $=document.getElementById("place-order-btn"),N=document.getElementById("place-order-form");$&&(!N||!N.action||N.action.includes("javascript"))&&$.addEventListener("click",async V=>{V.preventDefault(),await i()})}async function i(){if(!r())return;let l=document.getElementById("place-order-btn");l.disabled=!0,l.innerHTML='<svg class="animate-spin h-5 w-5 mx-auto" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>';try{let f=document.getElementById("order-notes")?.value;if(e.notes=f||"",!e.same_as_shipping){let N=document.getElementById("billing-address-form");if(N){let V=new FormData(N);e.billing_address={first_name:V.get("billing_first_name"),last_name:V.get("billing_last_name"),address_line_1:V.get("billing_address_line_1"),address_line_2:V.get("billing_address_line_2"),city:V.get("billing_city"),state:V.get("billing_state"),postal_code:V.get("billing_postal_code"),country:V.get("billing_country")}}}let $=(await CheckoutApi.createOrder(e)).data;e.payment_method==="stripe"||e.payment_method==="card"?await c($):e.payment_method==="paypal"?await u($):window.location.href=`/orders/${$.id}/confirmation/`}catch(f){console.error("Failed to place order:",f),Toast.error(f.message||"Failed to place order. Please try again."),l.disabled=!1,l.textContent="Place Order"}}async function c(l){try{let f=await CheckoutApi.createPaymentIntent(l.id),{client_secret:I}=f.data,$=f.data.publishable_key||window.STRIPE_PUBLISHABLE_KEY||(window.stripeInstance?window.STRIPE_PUBLISHABLE_KEY:null);if(typeof Stripe>"u"&&!window.stripeInstance)throw new Error("Stripe is not loaded.");let V=await(window.stripeInstance||Stripe($)).confirmCardPayment(I,{payment_method:{card:window.stripeCard,billing_details:{name:`${e.shipping_address.first_name} ${e.shipping_address.last_name}`}}});if(V.error)throw new Error(V.error.message);window.location.href=`/orders/${l.id}/confirmation/`}catch(f){console.error("Stripe payment failed:",f),Toast.error(f.message||"Payment failed. Please try again.");let I=document.getElementById("place-order-btn");I.disabled=!1,I.textContent="Place Order"}}async function u(l){try{let f=await CheckoutApi.createPayPalOrder(l.id),{approval_url:I}=f.data;window.location.href=I}catch(f){console.error("PayPal payment failed:",f),Toast.error(f.message||"Payment failed. Please try again.");let I=document.getElementById("place-order-btn");I.disabled=!1,I.textContent="Place Order"}}function m(){n=null,e={shipping_address:null,billing_address:null,same_as_shipping:!0,shipping_method:null,payment_method:null,notes:""},t=1}return{init:o,destroy:m}})();window.CheckoutPage=ks;lr=ks});var $s={};J($s,{default:()=>dr});var Ls,dr,Ts=Q(()=>{Ls=(function(){"use strict";async function n(){A(),await R(),e()}function e(){t(),o(),g(),b(),k()}function t(){let j=document.getElementById("contact-map");if(!j)return;let y=j.dataset.lat||"0",M=j.dataset.lng||"0",D=j.dataset.address||"Our Location";j.innerHTML=`
        ...
        `,document.getElementById("open-live-chat")?.addEventListener("click",()=>{document.dispatchEvent(new CustomEvent("chat:open"))}))}function g(){let j=document.getElementById("quick-contact");if(!j)return;let y=[{icon:"phone",label:"Call Us",action:"tel:",color:"emerald"},{icon:"whatsapp",label:"WhatsApp",action:"https://wa.me/",color:"green"},{icon:"email",label:"Email",action:"mailto:",color:"blue"}];j.innerHTML=`
        ...
        `,j.querySelectorAll(".faq-trigger").forEach(M=>{M.addEventListener("click",()=>{let D=M.closest(".faq-item"),_=D.querySelector(".faq-answer"),C=D.querySelector(".faq-icon"),v=!_.classList.contains("hidden");j.querySelectorAll(".faq-item").forEach(S=>{S!==D&&(S.querySelector(".faq-answer").classList.add("hidden"),S.querySelector(".faq-icon").classList.remove("rotate-180"))}),_.classList.toggle("hidden"),C.classList.toggle("rotate-180")})})}function k(){let j=document.getElementById("office-status");if(!j)return;let y={start:9,end:18,timezone:"America/New_York",days:[1,2,3,4,5]};function M(){let D=new Date,_=D.getDay(),C=D.getHours(),S=y.days.includes(_)&&C>=y.start&&C<y.end;j.innerHTML=`
            ...
            `}M(),setInterval(M,6e4)}function A(){let j=document.getElementById("contact-form");if(!j)return;let y=FormValidator.create(j,{name:{required:!0,minLength:2,maxLength:100},email:{required:!0,email:!0},subject:{required:!0,minLength:5,maxLength:200},message:{required:!0,minLength:20,maxLength:2e3}});j.addEventListener("submit",async M=>{if(M.preventDefault(),!y.validate()){Toast.error("Please fill in all required fields correctly.");return}let D=j.querySelector('button[type="submit"]'),_=D.textContent;D.disabled=!0,D.innerHTML='<svg class="animate-spin h-5 w-5 mx-auto" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>';try{let C=new FormData(j),v={name:C.get("name"),email:C.get("email"),phone:C.get("phone"),subject:C.get("subject"),message:C.get("message")};await SupportApi.submitContactForm(v),Toast.success("Thank you for your message! We'll get back to you soon."),j.reset(),y.clearErrors(),q()}catch(C){Toast.error(C.message||"Failed to send message. Please try again.")}finally{D.disabled=!1,D.textContent=_}})}function q(){let j=document.getElementById("contact-form"),y=document.getElementById("contact-success");j&&y&&(j.classList.add("hidden"),y.classList.remove("hidden"),y.innerHTML=`
                <div class="text-center py-12">
            ...
            `}catch(y){console.error("Failed to load contact info:",y)}}function Y(){}return{init:n,destroy:Y}})();window.ContactPage=Ls;dr=Ls});var Bs={};J(Bs,{default:()=>cr});var Is,cr,Ss=Q(()=>{Is=(function(){"use strict";let n=[],e=[];async function t(){let r=document.getElementById("faq-list");r&&r.querySelector(".faq-item")?j():await y(),S(),o()}function o(){g(),b(),k(),A(),q(),R(),Y()}function g(){if(!document.querySelector(".faq-search-container")||!("webkitSpeechRecognition"in window||"SpeechRecognition"in window))return;let s=window.SpeechRecognition||window.webkitSpeechRecognition,i=new s;i.continuous=!1,i.lang="en-US";let c=document.createElement("button");c.id="faq-voice-search",c.type="button",c.className="absolute right-12 top-1/2 -translate-y-1/2 p-2 text-stone-400 hover:text-primary-600 dark:hover:text-amber-400 transition-colors",c.innerHTML=`
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z"/></svg>
        `;let u=document.getElementById("faq-search");u&&u.parentElement&&(u.parentElement.style.position="relative",u.parentElement.appendChild(c));let m=!1;c.addEventListener("click",()=>{m?i.stop():(i.start(),c.classList.add("text-red-500","animate-pulse")),m=!m}),i.onresult=l=>{let f=l.results[0][0].transcript;u&&(u.value=f,u.dispatchEvent(new Event("input"))),c.classList.remove("text-red-500","animate-pulse"),m=!1},i.onerror=()=>{c.classList.remove("text-red-500","animate-pulse"),m=!1}}function b(){document.querySelectorAll(".faq-content, .accordion-content, .faq-answer").forEach(r=>{if(r.querySelector(".faq-rating"))return;let i=(r.closest(".faq-item")||r.closest("[data-accordion]"))?.dataset.id||Math.random().toString(36).substr(2,9),c=`
            ...
            `;r.insertAdjacentHTML("beforeend",c)}),document.addEventListener("click",r=>{let s=r.target.closest(".faq-rate-btn");if(!s)return;let i=s.dataset.helpful==="yes",c=s.dataset.question,u=s.closest(".faq-rating"),m=JSON.parse(localStorage.getItem("faqRatings")||"{}");m[c]=i,localStorage.setItem("faqRatings",JSON.stringify(m)),u.innerHTML=`
            ...
            `,typeof analytics<"u"&&analytics.track("faq_rated",{questionId:c,helpful:i})})}function k(){let r=document.getElementById("faq-contact-promo");r&&(r.innerHTML=`
        ...
        `,document.getElementById("open-chat-faq")?.addEventListener("click",()=>{document.dispatchEvent(new CustomEvent("chat:open"))}))}function A(){let r=document.getElementById("popular-questions");if(!r)return;let s=JSON.parse(localStorage.getItem("faqRatings")||"{}"),i=Object.entries(s).filter(([u,m])=>m).slice(0,5).map(([u])=>u),c=[];document.querySelectorAll(".faq-item, [data-accordion]").forEach(u=>{let m=u.dataset.id;if(i.includes(m)||c.length<3){let l=u.querySelector("button span, .accordion-toggle span")?.textContent?.trim();l&&c.push({id:m,question:l,element:u})}}),c.length!==0&&(r.innerHTML=`
        ...
        `,r.querySelectorAll(".popular-q-link").forEach(u=>{u.addEventListener("click",()=>{let m=u.dataset.target,l=document.querySelector(`[data-id="${m}"], .faq-item`);if(l){l.scrollIntoView({behavior:"smooth",block:"center"});let f=l.querySelector(".faq-trigger, .accordion-toggle");f&&f.click()}})}))}function q(){document.querySelectorAll(".faq-content, .accordion-content, .faq-answer").forEach(r=>{if(r.querySelector(".faq-share"))return;let i=(r.closest(".faq-item")||r.closest("[data-accordion]"))?.querySelector("button span, .accordion-toggle span")?.textContent?.trim();if(!i)return;let c=`
            ...
            `;r.insertAdjacentHTML("beforeend",c)}),document.addEventListener("click",r=>{let s=r.target.closest('.faq-share-btn[data-platform="copy"]');s&&navigator.clipboard.writeText(window.location.href).then(()=>{let i=s.innerHTML;s.innerHTML='<svg class="w-4 h-4 text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>',setTimeout(()=>{s.innerHTML=i},2e3)})})}function R(){let r=document.querySelectorAll(".faq-item, [data-accordion]"),s=-1;document.addEventListener("keydown",i=>{if(document.querySelector("#faq-container, #faq-list")){if(i.key==="ArrowDown"||i.key==="ArrowUp"){i.preventDefault(),i.key==="ArrowDown"?s=Math.min(s+1,r.length-1):s=Math.max(s-1,0);let c=r[s];if(c){c.scrollIntoView({behavior:"smooth",block:"center"});let u=c.querySelector(".faq-trigger, .accordion-toggle, button");u&&u.focus()}}if(i.key==="Enter"&&s>=0){let u=r[s]?.querySelector(".faq-trigger, .accordion-toggle");u&&u.click()}i.key==="/"&&document.activeElement?.tagName!=="INPUT"&&(i.preventDefault(),document.getElementById("faq-search")?.focus())}})}function Y(){let r=new IntersectionObserver(s=>{s.forEach(i=>{if(i.isIntersecting){let c=i.target,u=c.querySelector("button span, .accordion-toggle span")?.textContent?.trim(),m=JSON.parse(localStorage.getItem("faqViews")||"{}"),l=c.dataset.id||u?.substring(0,30);l&&(m[l]=(m[l]||0)+1,localStorage.setItem("faqViews",JSON.stringify(m)))}})},{threshold:.5});document.querySelectorAll(".faq-item, [data-accordion]").forEach(s=>{r.observe(s)}),document.addEventListener("click",s=>{let i=s.target.closest(".faq-trigger, .accordion-toggle");if(i){let c=i.closest(".faq-item, [data-accordion]"),u=i.querySelector("span")?.textContent?.trim();typeof analytics<"u"&&analytics.track("faq_opened",{question:u?.substring(0,100)})}})}function j(){let r=document.querySelectorAll(".category-tab"),s=document.querySelectorAll(".faq-category");r.forEach(c=>{c.addEventListener("click",u=>{u.preventDefault(),r.forEach(f=>{f.classList.remove("bg-primary-600","dark:bg-amber-600","text-white"),f.classList.add("bg-stone-100","dark:bg-stone-800","text-stone-700","dark:text-stone-300")}),c.classList.add("bg-primary-600","dark:bg-amber-600","text-white"),c.classList.remove("bg-stone-100","dark:bg-stone-800","text-stone-700","dark:text-stone-300");let m=c.dataset.category;m==="all"?s.forEach(f=>f.classList.remove("hidden")):s.forEach(f=>{f.classList.toggle("hidden",f.dataset.category!==m)});let l=document.getElementById("faq-search");l&&(l.value=""),document.querySelectorAll(".faq-item").forEach(f=>f.classList.remove("hidden"))})}),document.querySelectorAll(".accordion-toggle").forEach(c=>{c.addEventListener("click",()=>{let u=c.closest("[data-accordion]"),m=u.querySelector(".accordion-content"),l=u.querySelector(".accordion-icon"),f=!m.classList.contains("hidden");document.querySelectorAll("[data-accordion]").forEach(I=>{I!==u&&(I.querySelector(".accordion-content")?.classList.add("hidden"),I.querySelector(".accordion-icon")?.classList.remove("rotate-180"))}),f?(m.classList.add("hidden"),l.classList.remove("rotate-180")):(m.classList.remove("hidden"),l.classList.add("rotate-180"))})})}async function y(){let r=document.getElementById("faq-container");if(r){Loader.show(r,"skeleton");try{let i=(await PagesApi.getFAQs()).data||[];if(e=i,i.length===0){r.innerHTML=`
                    <div class="text-center py-12">
            ...
            `}}}function M(r){let s={};return r.forEach(i=>{let c=i.category||"General";s[c]||(s[c]=[]),s[c].push(i)}),s}function D(r,s=""){let i=document.getElementById("faq-container");if(!i)return;let c=Object.keys(r);if(c.length===0){i.innerHTML=`
                <div class="text-center py-12">
                    <svg class="w-16 h-16 text-stone-300 dark:text-stone-600 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
            ...
            <div id="faq-list" class="space-y-6">
                ${c.map(u=>`
                    <div class="faq-category" data-category="${Templates.escapeHtml(u)}">
                        ...
                        <div class="space-y-3">
                            ${r[u].map(m=>_(m,s)).join("")}
                        </div>
                    </div>
                `).join("")}
            </div>
        `,C(),v(),b(),q()}function _(r,s=""){let i=Templates.escapeHtml(r.question),c=r.answer;if(s){let u=new RegExp(`(${s.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")})`,"gi");i=i.replace(u,'<mark class="bg-yellow-200 dark:bg-yellow-800">$1</mark>'),c=c.replace(u,'<mark class="bg-yellow-200 dark:bg-yellow-800">$1</mark>')}return`
        ...
        `}function C(){let r=document.querySelectorAll(".faq-category-btn"),s=document.querySelectorAll(".faq-category");r.forEach(i=>{i.addEventListener("click",()=>{r.forEach(u=>{u.classList.remove("bg-primary-600","dark:bg-amber-600","text-white"),u.classList.add("bg-stone-100","dark:bg-stone-800","text-stone-600","dark:text-stone-300")}),i.classList.add("bg-primary-600","dark:bg-amber-600","text-white"),i.classList.remove("bg-stone-100","dark:bg-stone-800","text-stone-600","dark:text-stone-300");let c=i.dataset.category;s.forEach(u=>{c==="all"||u.dataset.category===c?u.classList.remove("hidden"):u.classList.add("hidden")})})})}function v(){document.querySelectorAll(".faq-trigger").forEach(s=>{s.addEventListener("click",()=>{let i=s.closest(".faq-item"),c=i.querySelector(".faq-content"),u=i.querySelector(".faq-icon"),m=!c.classList.contains("hidden");document.querySelectorAll(".faq-item").forEach(l=>{l!==i&&(l.querySelector(".faq-content")?.classList.add("hidden"),l.querySelector(".faq-icon")?.classList.remove("rotate-180"))}),c.classList.toggle("hidden"),u.classList.toggle("rotate-180")})})}function S(){let r=document.getElementById("faq-search");if(!r)return;let s=null;r.addEventListener("input",c=>{let u=c.target.value.trim().toLowerCase();clearTimeout(s),s=setTimeout(()=>{if(document.querySelector(".accordion-toggle"))L(u);else if(n&&Object.keys(n).length>0){if(u.length<2){D(n);return}let l={};Object.entries(n).forEach(([f,I])=>{let $=I.filter(N=>N.question.toLowerCase().includes(u)||N.answer.toLowerCase().includes(u));$.length>0&&(l[f]=$)}),D(l,u)}},300)});let i=document.createElement("span");i.className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-stone-400 dark:text-stone-500 hidden md:block",i.textContent="Press / to search",r.parentElement&&(r.parentElement.style.position="relative",r.parentElement.appendChild(i),r.addEventListener("focus",()=>i.classList.add("hidden")),r.addEventListener("blur",()=>i.classList.remove("hidden")))}function L(r){let s=document.querySelectorAll(".faq-item"),i=document.querySelectorAll(".faq-category"),c=document.getElementById("no-results"),u=0;s.forEach(m=>{let l=m.querySelector(".accordion-toggle span, button span"),f=m.querySelector(".accordion-content"),I=l?l.textContent.toLowerCase():"",$=f?f.textContent.toLowerCase():"";!r||I.includes(r)||$.includes(r)?(m.classList.remove("hidden"),u++):m.classList.add("hidden")}),i.forEach(m=>{let l=m.querySelectorAll(".faq-item:not(.hidden)");m.classList.toggle("hidden",l.length===0)}),c&&c.classList.toggle("hidden",u>0)}function h(){n=[],e=[]}return{init:t,destroy:h}})();window.FAQPage=Is;cr=Is});var _s={};J(_s,{CategoryCard:()=>ur});function ur(n){let e=document.createElement("a");e.href=`/categories/${n.slug}/`,e.className="group block";let t=document.createElement("div");t.className="relative aspect-square rounded-xl overflow-hidden bg-gray-100";let o="";if(typeof n.image_url=="string"&&n.image_url?o=n.image_url:typeof n.image=="string"&&n.image?o=n.image:n.image&&typeof n.image=="object"?o=n.image.url||n.image.src||n.image_url||"":typeof n.banner_image=="string"&&n.banner_image?o=n.banner_image:n.banner_image&&typeof n.banner_image=="object"?o=n.banner_image.url||n.banner_image.src||"":typeof n.hero_image=="string"&&n.hero_image?o=n.hero_image:n.hero_image&&typeof n.hero_image=="object"?o=n.hero_image.url||n.hero_image.src||"":typeof n.thumbnail=="string"&&n.thumbnail?o=n.thumbnail:n.thumbnail&&typeof n.thumbnail=="object"&&(o=n.thumbnail.url||n.thumbnail.src||""),o){let k=document.createElement("img");k.src=o,k.alt=n.name||"",k.className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300",k.loading="lazy",k.decoding="async",k.onerror=A=>{try{k.remove();let q=document.createElement("div");q.className="w-full h-full flex items-center justify-center bg-gradient-to-br from-primary-100 to-primary-200",q.innerHTML='<svg class="w-12 h-12 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>',t.appendChild(q)}catch{}},t.appendChild(k)}else{let k=document.createElement("div");k.className="w-full h-full flex items-center justify-center bg-gradient-to-br from-primary-100 to-primary-200",k.innerHTML='<svg class="w-12 h-12 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>',t.appendChild(k)}let g=document.createElement("div");g.className="absolute inset-0 bg-gradient-to-t from-black/30 dark:from-black/60 to-transparent",t.appendChild(g),e.appendChild(t);let b=document.createElement("h3");if(b.className="mt-3 text-sm font-medium text-stone-900 group-hover:text-primary-600 transition-colors text-center dark:text-white",b.textContent=n.name,e.appendChild(b),n.product_count){let k=document.createElement("p");k.className="text-xs text-stone-600 dark:text-white/60 text-center",k.textContent=`${n.product_count} products`,e.appendChild(k)}return e}var As=Q(()=>{});var qs={};J(qs,{default:()=>mr});var Ms,mr,Hs=Q(()=>{Ms=(function(){"use strict";let n=null,e=0,t=null,o=null;async function g(){await Promise.all([M(),_(),C(),v(),S(),L(),y(),j()]),h(),b(),k(),A(),q(),initArtisanSpotlight(),R(),Y()}function b(){let s=document.getElementById("live-visitors");if(!s)return;e=Math.floor(Math.random()*50)+25;function i(){let c=Math.random()>.5?1:-1;e=Math.max(15,Math.min(100,e+c)),s.innerHTML=`
            ...
            `}i(),setInterval(i,8e3)}function k(){let s=[{type:"purchase",location:"Dhaka",time:"2 min ago",product:"Handcrafted Leather Bag"},{type:"purchase",location:"Sylhet",time:"5 min ago",product:"Artisan Ceramic Vase"},{type:"review",location:"Dhaka",time:"8 min ago",rating:5,product:"Woven Basket Set"},{type:"signup",location:"Rangpur",time:"12 min ago"},{type:"purchase",location:"Chattogram",time:"15 min ago",product:"Custom Jewelry Box"}],i=0,c=0,u=10;function m(){if(c>=u)return;let l=s[i],f=document.createElement("div");f.className="social-proof-popup fixed bottom-4 left-4 z-50 max-w-xs bg-white dark:bg-stone-800 rounded-xl shadow-2xl border border-stone-200 dark:border-stone-700 p-4 transform translate-y-full opacity-0 transition-all duration-500";let I="";l.type==="purchase"?I=`
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-sm font-medium text-stone-900 dark:text-white">Someone in ${l.location} purchased</p>
                            <p class="text-sm text-stone-600 dark:text-stone-400">${l.product}</p>
                            <p class="text-xs text-stone-400 dark:text-stone-500 mt-1">${l.time}</p>
                        </div>
                    </div>
                `:l.type==="review"?I=`
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-sm font-medium text-stone-900 dark:text-white">New 5-star review from ${l.location}</p>
                            <p class="text-sm text-stone-600 dark:text-stone-400">"${l.product}"</p>
                            <p class="text-xs text-stone-400 dark:text-stone-500 mt-1">${l.time}</p>
                        </div>
                    </div>
                `:l.type==="signup"&&(I=`
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-stone-600 dark:text-stone-400">Someone in ${l.location} signed up</p>
                            <p class="text-xs text-stone-400 dark:text-stone-500 mt-1">${l.time}</p>
                        </div>
                    </div>
                `),f.innerHTML=`
            ...
            `,document.body.appendChild(f),c++,requestAnimationFrame(()=>{f.classList.remove("translate-y-full","opacity-0")}),setTimeout(()=>{f.classList.add("translate-y-full","opacity-0"),setTimeout(()=>f.remove(),500)},5e3),i=(i+1)%s.length,c>=u&&t&&clearInterval(t)}setTimeout(()=>{m(),t=setInterval(()=>{c<u?m():clearInterval(t)},3e4)},1e4)}function A(){let s=document.getElementById("recently-viewed-section"),i=document.getElementById("recently-viewed"),c=document.getElementById("clear-recently-viewed");if(!s||!i)return;let u=JSON.parse(localStorage.getItem("recentlyViewed")||"[]");if(u.length===0){s.classList.add("hidden");return}s.classList.remove("hidden"),i.innerHTML=u.slice(0,5).map(m=>{let l=null;return m.discount_percent&&m.discount_percent>0&&(l=`-${m.discount_percent}%`),ProductCard.render(m,{showBadge:!!l,badge:l,priceSize:"small"})}).join(""),ProductCard.bindEvents(i),c?.addEventListener("click",()=>{localStorage.removeItem("recentlyViewed"),s.classList.add("hidden"),Toast.success("Recently viewed items cleared")})}function q(){let s=document.getElementById("flash-sale-section"),i=document.getElementById("flash-sale-countdown");if(!s||!i)return;if(!localStorage.getItem("flashSaleEnd")){let l=new Date().getTime()+144e5;localStorage.setItem("flashSaleEnd",l.toString())}let u=parseInt(localStorage.getItem("flashSaleEnd"));function m(){let l=new Date().getTime(),f=u-l;if(f<=0){s.classList.add("hidden"),clearInterval(o),localStorage.removeItem("flashSaleEnd");return}s.classList.remove("hidden");let I=Math.floor(f%(1e3*60*60*24)/(1e3*60*60)),$=Math.floor(f%(1e3*60*60)/(1e3*60)),N=Math.floor(f%(1e3*60)/1e3);i.innerHTML=`
                <div class="flex items-center gap-2 text-white">
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <span class="bg-white/20 px-2 py-1 rounded font-mono font-bold">${$.toString().padStart(2,"0")}</span>
                        <span class="font-bold">:</span>
                        <span class="bg-white/20 px-2 py-1 rounded font-mono font-bold">${N.toString().padStart(2,"0")}</span>
                    </div>
                </div>
            `}m(),o=setInterval(m,1e3)}function R(){let s=document.querySelectorAll("[data-animate]");if(!s.length)return;let i=new IntersectionObserver(c=>{c.forEach(u=>{if(u.isIntersecting){let m=u.target.dataset.animate||"fadeInUp";u.target.classList.add("animate-"+m),u.target.classList.remove("opacity-0"),i.unobserve(u.target)}})},{threshold:.1,rootMargin:"0px 0px -50px 0px"});s.forEach(c=>{c.classList.add("opacity-0"),i.observe(c)})}function Y(){document.addEventListener("click",async s=>{let i=s.target.closest("[data-quick-view]");if(!i)return;let c=i.dataset.quickView;if(!c)return;s.preventDefault();let u=document.createElement("div");u.id="quick-view-modal",u.className="fixed inset-0 z-50 flex items-center justify-center p-4",u.innerHTML=`
                <div class="absolute inset-0 bg-black/50 backdrop-blur-sm" onclick="document.getElementById('quick-view-modal').remove()"></div>
                <div class="relative bg-white dark:bg-stone-800 rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-auto">
                    <button class="absolute top-4 right-4 z-10 w-10 h-10 bg-stone-100 dark:bg-stone-700 rounded-full flex items-center justify-center hover:bg-stone-200 dark:hover:bg-stone-600 transition-colors" onclick="document.getElementById('quick-view-modal').remove()">
                        <svg class="w-5 h-5 text-stone-600 dark:text-stone-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
            ...
            `,document.body.appendChild(u);try{let m=await ProductsApi.getProduct(c),l=m.data||m,f=u.querySelector(".relative");f.innerHTML=`
                    <button class="absolute top-4 right-4 z-10 w-10 h-10 bg-stone-100 dark:bg-stone-700 rounded-full flex items-center justify-center hover:bg-stone-200 dark:hover:bg-stone-600 transition-colors" onclick="document.getElementById('quick-view-modal').remove()">
                        <svg class="w-5 h-5 text-stone-600 dark:text-stone-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
                    </button>
                    <div class="grid md:grid-cols-2 gap-8 p-8">
                        <div class="aspect-square rounded-xl overflow-hidden bg-stone-100 dark:bg-stone-700">
                            <img src="${l.primary_image||l.image||"/static/images/placeholder.jpg"}" alt="${Templates.escapeHtml(l.name)}" class="w-full h-full object-cover">
                        </div>
                        <div class="flex flex-col">
                            ...
                            <div class="mt-auto space-y-3">
                                <button class="w-full py-3 px-6 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-xl transition-colors" onclick="CartApi.addItem(${l.id}, 1).then(() => { Toast.success('Added to cart'); document.getElementById('quick-view-modal').remove(); })">
                                    Add to Cart
                                </button>
                                <a href="/products/${l.slug||l.id}/" class="block w-full py-3 px-6 border-2 border-stone-200 dark:border-stone-600 text-stone-700 dark:text-stone-300 font-semibold rounded-xl text-center hover:bg-stone-50 dark:hover:bg-stone-700 transition-colors">
                                    View Full Details
                                </a>
                            </div>
                        </div>
                    </div>
                `}catch(m){console.error("Failed to load product:",m),u.remove(),Toast.error("Failed to load product details")}})}async function j(){let s=document.getElementById("testimonials-grid");if(s){Loader.show(s,"skeleton");try{let i=await CategoriesApi.getCategories({pageSize:6,featured:!0}),c=i?.data?.results||i?.data||i?.results||[],u=[];for(let m of c){let l=await ProductsApi.getProducts({category:m.id,featured:!0,pageSize:3}),f=l?.data?.results||l?.data||l?.results||[];for(let I of f){let $=await ProductsApi.getReviews(I.id,{pageSize:2}),N=$?.data?.results||$?.data||$?.results||[];N.forEach(V=>{V._product=I,V._category=m}),u.push(...N)}}if(s.innerHTML="",!u.length){s.innerHTML='<p class="text-gray-500 text-center py-8">No user reviews available.</p>';return}u=u.slice(0,6),u.forEach(m=>{let l=document.createElement("div");l.className="rounded-2xl bg-white dark:bg-stone-800 shadow p-6 flex flex-col gap-3",l.innerHTML=`
                        ...
                        <div class="mt-2 text-xs text-primary-700 dark:text-amber-400 font-semibold">${m._category?Templates.escapeHtml(m._category.name):""}${m._product?" - "+Templates.escapeHtml(m._product.name):""}</div>
                    `,s.appendChild(l)})}catch(i){console.error("Failed to load testimonials:",i),s.innerHTML='<p class="text-red-500 text-center py-8">Failed to load testimonials. Please try again later.</p>'}}}async function y(){let s=document.getElementById("best-sellers");if(!s)return;let i=s.querySelector(".products-grid")||s;Loader.show(i,"skeleton");try{let c=await ProductsApi.getProducts({bestseller:!0,pageSize:5}),u=c.data?.results||c.data||c.results||[];if(u.length===0){i.innerHTML='<p class="text-gray-500 text-center py-8">No best sellers available.</p>';return}i.innerHTML=u.map(m=>{let l=null;return m.discount_percent&&m.discount_percent>0&&(l=`-${m.discount_percent}%`),ProductCard.render(m,{showBadge:!!l,badge:l,priceSize:"small"})}).join(""),ProductCard.bindEvents(i)}catch(c){console.error("Failed to load best sellers:",c),i.innerHTML='<p class="text-red-500 text-center py-8">Failed to load products. Please try again later.</p>'}}async function M(){let s=document.getElementById("hero-slider");if(s)try{let i=await PagesApi.getBanners("home_hero"),c=i.data?.results||i.data||i.results||[];if(c.length===0){s.innerHTML="";return}s.innerHTML=`
                <div class="relative overflow-hidden w-full h-[55vh] sm:h-[70vh] md:h-[80vh]">
                    <div class="hero-slides relative w-full h-full">
                        ${c.map((u,m)=>`
                            <div class="hero-slide ${m===0?"":"hidden"} w-full h-full" data-index="${m}">
                    ...
                    ${c.length>1?`
                        ...
                        <div class="hero-dots absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2">
                            ${c.map((u,m)=>`
                                <button class="w-3 h-3 rounded-full transition-colors ${m===0?"bg-white dark:bg-stone-200":"bg-white/50 dark:bg-stone-600/60 hover:bg-white/75 dark:hover:bg-stone-500/80"}" data-slide="${m}" aria-label="Go to slide ${m+1}"></button>
                            `).join("")}
                        </div>
                    `:""}
                </div>
            `,c.length>1&&D(c.length)}catch(i){console.warn("Hero banners unavailable:",i?.status||i)}}function D(s){let i=0,c=document.querySelectorAll(".hero-slide"),u=document.querySelectorAll(".hero-dots button"),m=document.querySelector(".hero-prev"),l=document.querySelector(".hero-next");function f($){c[i].classList.add("hidden"),u[i]?.classList.remove("bg-stone-100"),u[i]?.classList.add("bg-white/50"),i=($+s)%s,c[i].classList.remove("hidden"),u[i]?.classList.add("bg-stone-100"),u[i]?.classList.remove("bg-white/50")}m?.addEventListener("click",()=>{f(i-1),I()}),l?.addEventListener("click",()=>{f(i+1),I()}),u.forEach(($,N)=>{$.addEventListener("click",()=>{f(N),I()})});function I(){n&&clearInterval(n),n=setInterval(()=>f(i+1),5e3)}try{let $=document.querySelector(".hero-slides"),N=0;$?.addEventListener("touchstart",V=>{N=V.touches[0].clientX},{passive:!0}),$?.addEventListener("touchend",V=>{let B=V.changedTouches[0].clientX-N;Math.abs(B)>50&&(B<0?f(i+1):f(i-1),I())})}catch{}I()}async function _(){let s=document.getElementById("featured-products");if(!s)return;let i=s.querySelector(".products-grid")||s;Loader.show(i,"skeleton");try{let c=await ProductsApi.getFeatured(8),u=c.data?.results||c.data||c.results||[];if(u.length===0){i.innerHTML='<p class="text-gray-500 text-center py-8">No featured products available.</p>';return}i.innerHTML=u.map(m=>{let l=null;return m.discount_percent&&m.discount_percent>0&&(l=`-${m.discount_percent}%`),ProductCard.render(m,{showBadge:!!l,badge:l,priceSize:"small"})}).join(""),ProductCard.bindEvents(i)}catch(c){console.error("Failed to load featured products:",c),i.innerHTML='<p class="text-red-500 text-center py-8">Failed to load products. Please try again later.</p>'}}async function C(){let s=document.getElementById("categories-showcase");if(s){Loader.show(s,"skeleton");try{try{window.ApiClient?.clearCache("/api/v1/catalog/categories/")}catch{}let i=await window.ApiClient.get("/catalog/categories/",{page_size:6,is_featured:!0},{useCache:!1}),c=i.data?.results||i.data||i.results||[];if(c.length===0){s.innerHTML="";return}let u;try{u=(await Promise.resolve().then(()=>(As(),_s))).CategoryCard}catch(m){console.error("Failed to import CategoryCard:",m);return}s.innerHTML="",c.forEach(m=>{let l=u(m);try{let f=l.querySelector("img");console.info("[Home] card image for",m.name,f?f.src:"NO_IMAGE")}catch{}s.appendChild(l)}),s.classList.add("grid","grid-cols-2","sm:grid-cols-2","md:grid-cols-3","lg:grid-cols-6","gap-4","lg:gap-6")}catch(i){console.error("Failed to load categories:",i),s.innerHTML=""}}}async function v(){let s=document.getElementById("new-arrivals");if(!s)return;let i=s.querySelector(".products-grid")||s;Loader.show(i,"skeleton");try{let c=await ProductsApi.getNewArrivals(4),u=c.data?.results||c.data||c.results||[];if(u.length===0){i.innerHTML='<p class="text-gray-500 text-center py-8">No new products available.</p>';return}i.innerHTML=u.map(m=>{let l=null;return m.discount_percent&&m.discount_percent>0&&(l=`-${m.discount_percent}%`),ProductCard.render(m,{showBadge:!!l,badge:l,priceSize:"small"})}).join(""),ProductCard.bindEvents(i)}catch(c){console.error("Failed to load new arrivals:",c),i.innerHTML='<p class="text-red-500 text-center py-8">Failed to load products.</p>'}}async function S(){let s=document.getElementById("promotions-banner")||document.getElementById("promotion-banners");if(s)try{let i=await PagesApi.getPromotions(),c=i?.data?.results??i?.results??i?.data??[];if(Array.isArray(c)||(c&&typeof c=="object"?c=Array.isArray(c.items)?c.items:[c]:c=[]),c.length===0){s.innerHTML="";return}let u=c[0]||{};s.innerHTML=`
        ...
        `;let i=window.BUNORAA_ROUTES||{},c=i.preordersWizard||"/preorders/create/",u=i.preordersLanding||"/preorders/";try{let m=[];if(typeof PreordersApi<"u"&&PreordersApi.getCategories)try{let l=await PreordersApi.getCategories({featured:!0,pageSize:4});m=l?.data?.results||l?.data||l?.results||[]}catch(l){console.warn("Pre-order categories unavailable:",l)}s.innerHTML=`
                        ...
                        <div class="text-stone-900 dark:text-white">
                            ...
                            ${m.length>0?`
                                <div class="mb-8">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        ${m.slice(0,4).map(l=>`
                                            <a href="${u}category/${l.slug}/" class="inline-flex items-center gap-2 px-4 py-2 bg-white/10 dark:bg-stone-800/30 hover:bg-white/20 dark:hover:bg-stone-700 rounded-full text-sm text-stone-900 dark:text-white transition-colors">
                                                ${l.icon?`<span>${l.icon}</span>`:""}
                                                ${Templates.escapeHtml(l.name)}
                                            </a>
                                        `).join("")}
                                    </div>
                                </div>
                            ...
                            <div class="flex flex-wrap gap-4">
                                <a href="${c}" class="cta-unlock inline-flex items-center gap-2 px-8 py-4 bg-amber-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:text-black dark:hover:text-black transition-colors group dark:bg-amber-600 dark:text-white">
            ...
            `}catch(m){console.warn("Custom order CTA failed to load:",m),s.innerHTML=`
            ...
            `}}function h(){let s=document.getElementById("newsletter-form");s&&s.addEventListener("submit",async i=>{i.preventDefault();let c=s.querySelector('input[type="email"]'),u=s.querySelector('button[type="submit"]'),m=c?.value?.trim();if(!m){Toast.error("Please enter your email address.");return}let l=u.textContent;u.disabled=!0,u.innerHTML='<svg class="animate-spin h-5 w-5 mx-auto" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>';try{await SupportApi.submitContactForm({email:m,type:"newsletter"}),Toast.success("Thank you for subscribing!"),c.value=""}catch(f){Toast.error(f.message||"Failed to subscribe. Please try again.")}finally{u.disabled=!1,u.textContent=l}})}function r(){n&&(clearInterval(n),n=null),t&&(clearInterval(t),t=null),o&&(clearInterval(o),o=null),document.getElementById("quick-view-modal")?.remove(),document.querySelectorAll(".social-proof-popup").forEach(s=>s.remove())}return{init:g,destroy:r,initRecentlyViewed:A,initFlashSaleCountdown:q}})();window.HomePage=Ms;mr=Ms});var js={};J(js,{default:()=>pr});var Ps,pr,Ns=Q(()=>{Ps=(function(){"use strict";let n=1,e="all";async function t(){if(!AuthGuard.protectPage())return;let y=o();y?await A(y):(await g(),Y())}function o(){let M=window.location.pathname.match(/\/orders\/([^\/]+)/);return M?M[1]:null}async function g(){let y=document.getElementById("orders-list");if(y){Loader.show(y,"skeleton");try{let M={page:n,limit:10};e!=="all"&&(M.status=e);let D=await OrdersApi.getAll(M),_=D.data||[],C=D.meta||{};b(_,C)}catch(M){console.error("Failed to load orders:",M),y.innerHTML='<p class="text-red-500 text-center py-8">Failed to load orders.</p>'}}}function b(y,M){let D=document.getElementById("orders-list");if(!D)return;if(y.length===0){D.innerHTML=`
                <div class="text-center py-16">
                    <svg class="w-24 h-24 text-gray-300 mx-auto mb-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            `:""}
        `,document.getElementById("orders-pagination")?.addEventListener("click",C=>{let v=C.target.closest("[data-page]");v&&(n=parseInt(v.dataset.page),g(),window.scrollTo({top:0,behavior:"smooth"}))})}function k(y){let D={pending:"bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400",processing:"bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400",shipped:"bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400",delivered:"bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400",cancelled:"bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400",refunded:"bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-400"}[y.status]||"bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-400",_=y.items||[],C=_.slice(0,3),v=_.length-3,S=["pending","processing","shipped","delivered"],L=S.indexOf(y.status),h=y.status==="cancelled"||y.status==="refunded";return`
                ...
                <div class="p-6">
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-100 flex justify-between items-center">
                        <p class="text-sm text-gray-600">
                            ${_.length} ${_.length===1?"item":"items"}
                        </p>
                        <p class="font-semibold text-gray-900">Total: ${Templates.formatPrice(y.total)}</p>
                    </div>
                </div>
            </div>
        `}async function A(y){let M=document.getElementById("order-detail");if(M){Loader.show(M,"skeleton");try{let _=(await OrdersApi.getById(y)).data;if(!_){window.location.href="/orders/";return}q(_)}catch(D){console.error("Failed to load order:",D),M.innerHTML='<p class="text-red-500 text-center py-8">Failed to load order details.</p>'}}}function q(y){let M=document.getElementById("order-detail");if(!M)return;let _={pending:"bg-yellow-100 text-yellow-700",processing:"bg-blue-100 text-blue-700",shipped:"bg-indigo-100 text-indigo-700",delivered:"bg-green-100 text-green-700",cancelled:"bg-red-100 text-red-700",refunded:"bg-gray-100 text-gray-700"}[y.status]||"bg-gray-100 text-gray-700",C=y.items||[];M.innerHTML=`
            <div class="mb-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100">
                    <div class="flex flex-wrap items-center justify-between gap-4">
                        ...
                        <span class="px-4 py-1.5 rounded-full text-sm font-medium ${_}">
                            ${Templates.escapeHtml(y.status_display||y.status)}
                        </span>
                    </div>
                </div>
        ...
        `,R(y)}function R(y){let M=document.getElementById("reorder-btn"),D=document.getElementById("cancel-order-btn"),_=document.getElementById("print-invoice-btn");M?.addEventListener("click",async()=>{try{await OrdersApi.reorder(y.id),Toast.success("Items added to cart!"),document.dispatchEvent(new CustomEvent("cart:updated")),window.location.href="/cart/"}catch(C){Toast.error(C.message||"Failed to reorder.")}}),D?.addEventListener("click",async()=>{if(await Modal.confirm({title:"Cancel Order",message:"Are you sure you want to cancel this order? This action cannot be undone.",confirmText:"Cancel Order",cancelText:"Keep Order"}))try{await OrdersApi.cancel(y.id),Toast.success("Order cancelled."),window.location.reload()}catch(v){Toast.error(v.message||"Failed to cancel order.")}}),_?.addEventListener("click",()=>{window.print()})}function Y(){let y=document.querySelectorAll("[data-filter-status]");y.forEach(M=>{M.addEventListener("click",()=>{y.forEach(D=>{D.classList.remove("bg-primary-100","text-primary-700"),D.classList.add("text-gray-600")}),M.classList.add("bg-primary-100","text-primary-700"),M.classList.remove("text-gray-600"),e=M.dataset.filterStatus,n=1,g()})})}function j(){n=1,e="all"}return{init:t,destroy:j}})();window.OrdersPage=Ps;pr=Ps});var Fs=Je(()=>{var gr=(function(){"use strict";let n=window.BUNORAA_ROUTES||{},e=n.preordersWizard||"/preorders/create/",t=n.preordersLanding||"/preorders/";async function o(){await Promise.all([g(),k(),A()])}async function g(){let _=document.getElementById("preorder-categories");if(_)try{let C=await PreordersApi.getCategories({featured:!0,pageSize:8}),v=C?.data?.results||C?.data||C?.results||[];if(v.length===0){_.innerHTML=`
                ...
                `;return}_.innerHTML=v.map(S=>b(S)).join("")}catch(C){console.error("Failed to load pre-order categories:",C),_.innerHTML=`
                <div class="col-span-full text-center py-12">
                    <svg class="w-16 h-16 mx-auto text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" 
                              d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
            ...
            `}}function b(_){let C=_.image?.url||_.image||_.thumbnail||"",v=C&&C.length>0,S=Templates?.escapeHtml||(h=>h),L=Templates?.formatPrice||(h=>`${window.BUNORAA_CURRENCY?.symbol||"\u09F3"}${h}`);return`
            <a href="${t}category/${_.slug}/" 
               class="group bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-200 dark:border-gray-700">
                ...
                `:`
                    <div class="aspect-video bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center">
                        ${_.icon?`<span class="text-5xl">${_.icon}</span>`:`
                ...
                <div class="p-6">
                    <div class="flex items-start justify-between mb-3">
                        ...
                        ${_.icon?`<span class="text-2xl">${_.icon}</span>`:""}
                    </div>
                    ...
                    <div class="flex items-center justify-between text-sm">
                        ${_.base_price?`
                            <span class="text-gray-500 dark:text-gray-500">
                                Starting from <span class="font-semibold text-purple-600">${L(_.base_price)}</span>
                            </span>
                        `:"<span></span>"}
                        ${_.min_production_days&&_.max_production_days?`
                            <span class="text-gray-500 dark:text-gray-500">
                                ${_.min_production_days}-${_.max_production_days} days
                            </span>
                        `:""}
                    </div>
        ...
        `}async function k(){let _=document.getElementById("preorder-templates");_&&_.closest("section")?.classList.add("hidden")}async function A(){let _=document.getElementById("preorder-stats");if(!_)return;let C={totalOrders:"500+",happyCustomers:"450+",avgRating:"4.9"};_.innerHTML=`
        ...
        `}async function q(_){let C=document.getElementById("category-options");if(!(!C||!_))try{let v=await PreordersApi.getCategory(_),S=await PreordersApi.getCategoryOptions(v.id);R(C,S)}catch(v){console.error("Failed to load category options:",v)}}function R(_,C){if(!C||C.length===0){_.innerHTML='<p class="text-gray-500">No customization options available.</p>';return}_.innerHTML=C.map(v=>`
        ...
        `).join("")}async function Y(){let _=document.getElementById("my-preorders-list");if(_){Loader.show(_,"skeleton");try{let C=await PreordersApi.getMyPreorders(),v=C?.data?.results||C?.data||C?.results||[];if(v.length===0){_.innerHTML=`
                    <div class="text-center py-12">
                ...
                `;return}_.innerHTML=v.map(S=>j(S)).join("")}catch(C){console.error("Failed to load pre-orders:",C),_.innerHTML=`
                <div class="text-center py-12">
                    <p class="text-red-500">Failed to load your orders. Please try again.</p>
                </div>
            `}}}function j(_){let C={pending:"bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400",quoted:"bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400",accepted:"bg-indigo-100 text-indigo-800 dark:bg-indigo-900/30 dark:text-indigo-400",in_progress:"bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400",review:"bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400",approved:"bg-teal-100 text-teal-800 dark:bg-teal-900/30 dark:text-teal-400",completed:"bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400",cancelled:"bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400",refunded:"bg-gray-100 text-gray-800 dark:bg-gray-900/30 dark:text-gray-400"},v={pending:"Pending Review",quoted:"Quote Sent",accepted:"Quote Accepted",in_progress:"In Progress",review:"Under Review",approved:"Approved",completed:"Completed",cancelled:"Cancelled",refunded:"Refunded"},S=C[_.status]||"bg-gray-100 text-gray-800",L=v[_.status]||_.status;return`
            <a href="${t}order/${_.preorder_number}/" class="block bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-shadow">
                <div class="flex items-start justify-between gap-4 mb-4">
                    <div>
                        <p class="text-sm text-gray-500 dark:text-gray-400">${_.preorder_number}</p>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">${Templates.escapeHtml(_.title||_.category?.name||"Custom Order")}</h3>
                    </div>
                    <span class="px-3 py-1 text-xs font-medium rounded-full ${S}">${L}</span>
                </div>
                ${_.description?`
                    <p class="text-gray-600 dark:text-gray-400 text-sm mb-4 line-clamp-2">${Templates.escapeHtml(_.description)}</p>
                `:""}
                <div class="flex items-center justify-between text-sm">
                    <span class="text-gray-500 dark:text-gray-400">
                        ${new Date(_.created_at).toLocaleDateString()}
                    </span>
                    ${_.final_price||_.estimated_price?`
                        <span class="font-semibold text-purple-600 dark:text-purple-400">
                            ${Templates.formatPrice(_.final_price||_.estimated_price)}
                        </span>
                    `:""}
                </div>
            </a>
        `}async function y(_){_&&await Promise.all([M(_),D(_)])}async function M(_){if(document.getElementById("preorder-status"))try{let v=await PreordersApi.getPreorderStatus(_)}catch{}}function D(_){let C=document.getElementById("message-form");C&&C.addEventListener("submit",async v=>{v.preventDefault();let S=C.querySelector('textarea[name="message"]'),L=C.querySelector('button[type="submit"]'),h=S?.value?.trim();if(!h){Toast.error("Please enter a message");return}let r=L.innerHTML;L.disabled=!0,L.innerHTML='<svg class="animate-spin h-5 w-5 mx-auto" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>';try{await PreordersApi.sendMessage(_,h),Toast.success("Message sent successfully"),S.value="",location.reload()}catch(s){Toast.error(s.message||"Failed to send message")}finally{L.disabled=!1,L.innerHTML=r}})}return{initLanding:o,initCategoryDetail:q,initMyPreorders:Y,initDetail:y,loadFeaturedCategories:g,renderCategoryCard:b,renderPreorderCard:j}})();window.PreordersPage=gr});var Os={};J(Os,{default:()=>hr});var zs,hr,Rs=Q(()=>{zs=(function(){"use strict";let n=null,e=null,t=null,o=!1,g=!1,b=!1,k=null;async function A(){if(o)return;o=!0;let a=document.getElementById("product-detail");if(!a)return;let d=a.querySelector("h1")||a.dataset.productId;if(g=!!d,d){n={id:a.dataset.productId,slug:a.dataset.productSlug},S(),q();return}let p=c();if(!p){window.location.href="/products/";return}await u(p),q()}function q(){R(),Y(),j(),y(),M(),D(),_(),C(),v()}function R(){let a=document.getElementById("main-product-image")||document.getElementById("main-image"),d=a?.parentElement;if(!a||!d)return;let p=document.createElement("div");p.className="zoom-lens absolute w-32 h-32 border-2 border-primary-500 bg-white/30 pointer-events-none opacity-0 transition-opacity duration-200 z-10",p.style.backgroundRepeat="no-repeat";let x=document.createElement("div");x.className="zoom-result fixed right-8 top-1/2 -translate-y-1/2 w-96 h-96 border border-stone-200 dark:border-stone-700 rounded-xl shadow-2xl bg-white dark:bg-stone-800 opacity-0 pointer-events-none transition-opacity duration-200 z-50 hidden lg:block",x.style.backgroundRepeat="no-repeat",d.classList.add("relative"),d.appendChild(p),document.body.appendChild(x),d.addEventListener("mouseenter",()=>{window.innerWidth<1024||(p.classList.remove("opacity-0"),x.classList.remove("opacity-0"),b=!0)}),d.addEventListener("mouseleave",()=>{p.classList.add("opacity-0"),x.classList.add("opacity-0"),b=!1}),d.addEventListener("mousemove",w=>{if(!b||window.innerWidth<1024)return;let T=d.getBoundingClientRect(),U=w.clientX-T.left,G=w.clientY-T.top,te=U-p.offsetWidth/2,ae=G-p.offsetHeight/2;p.style.left=`${Math.max(0,Math.min(T.width-p.offsetWidth,te))}px`,p.style.top=`${Math.max(0,Math.min(T.height-p.offsetHeight,ae))}px`;let ne=3,Gs=-U*ne+x.offsetWidth/2,Js=-G*ne+x.offsetHeight/2;x.style.backgroundImage=`url(${a.src})`,x.style.backgroundSize=`${T.width*ne}px ${T.height*ne}px`,x.style.backgroundPosition=`${Gs}px ${Js}px`})}function Y(){let a=document.getElementById("size-guide-btn");a&&a.addEventListener("click",()=>{let d=document.createElement("div");d.id="size-guide-modal",d.className="fixed inset-0 z-50 flex items-center justify-center p-4",d.innerHTML=`
            ...
            `,document.body.appendChild(p),document.getElementById("stock-alert-form")?.addEventListener("submit",async x=>{x.preventDefault();let w=document.getElementById("stock-alert-email")?.value;if(w)try{k=w,Toast.success("You will be notified when this product is back in stock!"),p.remove()}catch{Toast.error("Failed to subscribe. Please try again.")}})})}function y(){document.querySelectorAll(".share-btn").forEach(a=>{a.addEventListener("click",()=>{let d=a.dataset.platform,p=encodeURIComponent(window.location.href),x=encodeURIComponent(document.title),w=document.querySelector("h1")?.textContent||"",T={facebook:`https://www.facebook.com/sharer/sharer.php?u=${p}`,twitter:`https://twitter.com/intent/tweet?url=${p}&text=${encodeURIComponent(w)}`,pinterest:`https://pinterest.com/pin/create/button/?url=${p}&description=${encodeURIComponent(w)}`,whatsapp:`https://api.whatsapp.com/send?text=${encodeURIComponent(w+" "+window.location.href)}`,copy:null};d==="copy"?navigator.clipboard.writeText(window.location.href).then(()=>{Toast.success("Link copied to clipboard!")}).catch(()=>{Toast.error("Failed to copy link")}):T[d]&&window.open(T[d],"_blank","width=600,height=400")})})}function M(){let a=document.getElementById("qa-section");if(!a||!document.getElementById("product-detail")?.dataset.productId)return;let p=[{question:"Is this product machine washable?",answer:"Yes, we recommend washing on a gentle cycle with cold water.",askedBy:"John D.",date:"2 days ago"},{question:"What materials is this made from?",answer:"This product is crafted from 100% organic cotton sourced from sustainable farms.",askedBy:"Sarah M.",date:"1 week ago"}];a.innerHTML=`
            <div class="space-y-6">
                <div class="flex items-center justify-between">
        ...
        `,document.getElementById("ask-question-btn")?.addEventListener("click",()=>{let x=document.createElement("div");x.id="ask-question-modal",x.className="fixed inset-0 z-50 flex items-center justify-center p-4",x.innerHTML=`
            ...
            <div class="flex items-start gap-3 p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl">
                ...
                <div>
                    ...
                    <p class="text-emerald-600 dark:text-emerald-400 font-semibold">${U(w)} - ${U(T)}</p>
                    <p class="text-xs text-emerald-600 dark:text-emerald-400 mt-1">Free shipping on orders over $50</p>
                </div>
            </div>
        `}function _(){let a=document.getElementById("product-detail")?.dataset.productId,d=document.getElementById("product-detail")?.dataset.productSlug,p=document.querySelector("h1")?.textContent,x=document.getElementById("main-product-image")?.src||document.getElementById("main-image")?.src,w=document.getElementById("product-price")?.textContent;if(!a)return;let T=JSON.parse(localStorage.getItem("recentlyViewed")||"[]"),U=T.findIndex(G=>G.id===a);U>-1&&T.splice(U,1),T.unshift({id:a,slug:d,name:p,image:x,price:w,viewedAt:new Date().toISOString()}),localStorage.setItem("recentlyViewed",JSON.stringify(T.slice(0,20)))}function C(){if(document.getElementById("mobile-sticky-atc")||document.getElementById("mobile-sticky-atc-js")||window.innerWidth>=1024)return;let d=n;if(!d)return;let p=document.createElement("div");p.id="mobile-sticky-atc-enhanced",p.className="fixed bottom-0 inset-x-0 z-40 lg:hidden bg-white dark:bg-stone-800 border-t border-stone-200 dark:border-stone-700 shadow-2xl p-3 transform translate-y-full transition-transform duration-300",p.innerHTML=`
            <div class="flex items-center gap-3">
                <div class="flex-1 min-w-0">
        ...
        `,document.body.appendChild(p);let x=document.getElementById("add-to-cart-btn");x&&new IntersectionObserver(T=>{T.forEach(U=>{U.isIntersecting?p.classList.add("translate-y-full"):p.classList.remove("translate-y-full")})},{threshold:0}).observe(x),document.getElementById("sticky-add-to-cart")?.addEventListener("click",()=>{document.getElementById("add-to-cart-btn")?.click()})}function v(){document.querySelectorAll("[data-video-url]").forEach(d=>{d.addEventListener("click",()=>{let p=d.dataset.videoUrl;if(!p)return;let x=document.createElement("div");x.id="video-player-modal",x.className="fixed inset-0 z-50 flex items-center justify-center bg-black/90",x.innerHTML=`
                ...
                `,document.body.appendChild(x)})})}function S(){$(),h(),r(),a();async function a(){let d=document.getElementById("add-to-wishlist-btn");if(!d)return;let p=document.getElementById("product-detail")?.dataset.productId;if(p&&!(typeof WishlistApi>"u"))try{let x=await WishlistApi.getWishlist({pageSize:100});x.success&&x.data?.items&&(x.data.items.some(T=>T.product_id===p||T.product===p)?(d.querySelector("svg")?.setAttribute("fill","currentColor"),d.classList.add("text-red-500")):(d.querySelector("svg")?.setAttribute("fill","none"),d.classList.remove("text-red-500")))}catch{}}s(),i(),W(),L()}function L(){let a=document.querySelectorAll(".tab-btn"),d=document.querySelectorAll(".tab-content");a.forEach(p=>{p.addEventListener("click",()=>{let x=p.dataset.tab;a.forEach(w=>{w.classList.remove("border-primary-500","text-primary-600"),w.classList.add("border-transparent","text-gray-500")}),p.classList.add("border-primary-500","text-primary-600"),p.classList.remove("border-transparent","text-gray-500"),d.forEach(w=>{w.id===`${x}-tab`?w.classList.remove("hidden"):w.classList.add("hidden")})})})}function h(){let a=document.getElementById("add-to-cart-btn");a&&a.addEventListener("click",async()=>{let d=document.getElementById("product-detail")?.dataset.productId,p=parseInt(document.getElementById("quantity")?.value)||1,w=!!document.querySelector('input[name="variant"]'),T=document.querySelector('input[name="variant"]:checked')?.value;if(!d)return;if(w&&!T){Toast.warning("Please select a variant before adding to cart.");return}a.disabled=!0;let U=a.innerHTML;a.innerHTML='<svg class="animate-spin h-5 w-5 mx-auto" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>';try{await CartApi.addItem(d,p,T||null),Toast.success("Added to cart!"),document.dispatchEvent(new CustomEvent("cart:updated"))}catch(G){Toast.error(G.message||"Failed to add to cart.")}finally{a.disabled=!1,a.innerHTML=U}})}function r(){let a=document.getElementById("add-to-wishlist-btn");a&&a.addEventListener("click",async()=>{let d=document.getElementById("product-detail")?.dataset.productId;if(d){if(typeof AuthApi<"u"&&!AuthApi.isAuthenticated()){Toast.warning("Please login to add items to your wishlist."),window.location.href="/account/login/?next="+encodeURIComponent(window.location.pathname);return}try{let p=!1;if(typeof WishlistApi<"u"){let x=await WishlistApi.getWishlist({pageSize:100});x.success&&x.data?.items&&(p=x.data.items.some(w=>w.product_id===d||w.product===d))}if(p){let w=(await WishlistApi.getWishlist({pageSize:100})).data.items.find(T=>T.product_id===d||T.product===d);w&&(await WishlistApi.removeItem(w.id),Toast.success("Removed from wishlist!"),a.querySelector("svg")?.setAttribute("fill","none"),a.classList.remove("text-red-500"),a.setAttribute("aria-pressed","false"))}else await WishlistApi.addItem(d),Toast.success("Added to wishlist!"),a.querySelector("svg")?.setAttribute("fill","currentColor"),a.classList.add("text-red-500"),a.setAttribute("aria-pressed","true")}catch(p){Toast.error(p.message||"Wishlist action failed.")}}})}function s(){document.querySelectorAll('input[name="variant"]').forEach(d=>{d.addEventListener("change",()=>{e=d.value;let p=d.dataset.price,x=parseInt(d.dataset.stock||"0");if(p){let te=document.getElementById("product-price");te&&window.Templates?.formatPrice&&(te.textContent=window.Templates.formatPrice(parseFloat(p)))}let w=document.getElementById("stock-status"),T=document.getElementById("add-to-cart-btn"),U=document.getElementById("mobile-stock"),G=document.getElementById("mobile-add-to-cart");w&&(x>10?w.innerHTML='<span class="text-green-600">In Stock</span>':x>0?w.innerHTML=`<span class="text-orange-500">Only ${x} left</span>`:w.innerHTML='<span class="text-red-600">Out of Stock</span>'),T&&(T.disabled=x<=0),G&&(G.disabled=x<=0),U&&(U.textContent=x>0?x>10?"In stock":`${x} available`:"Out of stock")})})}function i(){document.getElementById("main-image")?.addEventListener("click",()=>{})}function c(){let d=window.location.pathname.match(/\/products\/([^\/]+)/);return d?d[1]:null}async function u(a){let d=document.getElementById("product-detail");if(d){Loader.show(d,"skeleton");try{if(n=(await ProductsApi.getProduct(a)).data,!n){window.location.href="/404/";return}document.title=`${n.name} | Bunoraa`,m(n),re(n),se(n),await Promise.all([O(n),P(n),X(n),oe(n)]),le(),de(n)}catch(p){console.error("Failed to load product:",p),d.innerHTML='<p class="text-red-500 text-center py-8">Failed to load product. Please try again.</p>'}}}document.addEventListener("currency:changed",async a=>{try{!g&&n&&n.slug?await u(n.slug):location.reload()}catch{}});function m(a){let d=document.getElementById("product-detail");if(!d)return;let p=a.images||[],x=a.image||p[0]?.image||"",w=a.variants&&a.variants.length>0,T=a.stock_quantity>0||a.in_stock,U=a.sale_price&&a.sale_price<a.price;d.innerHTML=`
        ...
        `,I(),$(),N(),V(),B(),E(),Tabs.init(),l(a)}function l(a){let d=document.getElementById("mobile-sticky-atc-js");if(d){let p=d.querySelector(".font-semibold");p&&(p.innerHTML=a.sale_price?Templates.formatPrice(a.sale_price)+' <span class="text-sm line-through text-gray-400">'+Templates.formatPrice(a.price)+"</span>":Templates.formatPrice(a.price));let x=document.getElementById("mobile-stock-js");x&&(x.textContent=a.stock_quantity>0?a.stock_quantity>10?"In stock":a.stock_quantity+" available":"Out of stock");let w=document.getElementById("mobile-add-to-cart-js");w&&(w.disabled=a.stock_quantity<=0)}else{d=document.createElement("div"),d.id="mobile-sticky-atc-js",d.className="fixed inset-x-4 bottom-4 z-40 lg:hidden",d.innerHTML=`
            ...
            `,document.body.appendChild(d);let p=document.getElementById("mobile-add-to-cart-js");p&&p.addEventListener("click",()=>document.getElementById("add-to-cart-btn")?.click())}}function f(a){let d={};return a.forEach(p=>{d[p.attribute_name]||(d[p.attribute_name]=[]),d[p.attribute_name].push(p)}),Object.entries(d).map(([p,x])=>`
            <div class="mt-6">
        ...
        `).join("")}function I(){let a=document.querySelectorAll(".thumbnail"),d=document.getElementById("main-product-image"),p=0;a.forEach((x,w)=>{x.setAttribute("tabindex","0"),x.addEventListener("click",()=>{a.forEach(T=>T.classList.remove("border-primary-500")),x.classList.add("border-primary-500"),d.src=x.dataset.image||x.dataset.src,p=w}),x.addEventListener("keydown",T=>{if(T.key==="Enter"||T.key===" ")T.preventDefault(),x.click();else if(T.key==="ArrowRight"){T.preventDefault();let U=a[(w+1)%a.length];U.focus(),U.click()}else if(T.key==="ArrowLeft"){T.preventDefault();let U=a[(w-1+a.length)%a.length];U.focus(),U.click()}})}),d?.addEventListener("click",()=>{let x=n.images?.map(G=>G.image)||[n.image],w=parseInt(document.querySelector(".thumbnail.border-primary-500")?.dataset.index)||0,U=(n.images||[]).map(G=>({type:G.type||(G.video_url?"video":"image"),src:G.video_url||G.model_url||G.image})).map(G=>{if(G.type==="video")return`<div class="w-full h-full max-h-[70vh]"><video controls class="w-full h-full object-contain"><source src="${G.src}" type="video/mp4">Your browser does not support video.</video></div>`;if(G.type==="model"){if(!window.customElements||!window["model-viewer"]){let te=document.createElement("script");te.type="module",te.src="https://unpkg.com/@google/model-viewer/dist/model-viewer.min.js",document.head.appendChild(te)}return`<div class="w-full h-full max-h-[70vh]"><model-viewer src="${G.src}" camera-controls ar ar-modes="webxr scene-viewer quick-look" class="w-full h-full"></model-viewer></div>`}return`<div class="w-full h-full max-h-[70vh] flex items-center justify-center"><img src="${G.src}" class="max-w-full max-h-[70vh] object-contain" alt="${Templates.escapeHtml(n.name)}"></div>`}).join("");Modal.open({title:Templates.escapeHtml(n.name),content:`<div class="space-y-2">${U}</div>`,size:"xl"})})}function $(){let a=document.getElementById("product-quantity"),d=document.querySelector(".qty-decrease"),p=document.querySelector(".qty-increase");d?.addEventListener("click",()=>{let w=parseInt(a.value)||1;w>1&&(a.value=w-1)}),p?.addEventListener("click",()=>{let w=parseInt(a.value)||1,T=parseInt(a.max)||99;w<T&&(a.value=w+1)});let x=document.querySelectorAll(".variant-btn");if(x.forEach(w=>{w.addEventListener("click",()=>{if(x.forEach(ne=>{ne.classList.remove("border-primary-500","bg-primary-50","text-primary-700"),ne.classList.add("border-gray-300"),ne.setAttribute("aria-checked","false")}),w.classList.add("border-primary-500","bg-primary-50","text-primary-700"),w.classList.remove("border-gray-300"),w.setAttribute("aria-checked","true"),e=w.dataset.variantId,w.dataset.price){let ne=document.querySelector(".product-info .mt-4");ne&&(ne.innerHTML=Price.render({price:parseFloat(w.dataset.price),size:"large"}))}let T=parseInt(w.dataset.stock||"0"),U=document.getElementById("stock-status"),G=document.getElementById("add-to-cart-btn"),te=document.getElementById("mobile-stock"),ae=document.getElementById("mobile-add-to-cart");U&&(T>10?U.innerHTML='<span class="text-green-600 flex items-center"><svg class="w-5 h-5 mr-1" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>In Stock</span>':T>0?U.innerHTML=`<span class="text-orange-500 flex items-center"><svg class="w-5 h-5 mr-1" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg>Only ${T} left</span>`:U.innerHTML='<span class="text-red-600 flex items-center"><svg class="w-5 h-5 mr-1" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"></path></svg>Out of Stock</span>'),a&&(a.max=Math.max(T,1),parseInt(a.value)>parseInt(a.max)&&(a.value=a.max)),te&&(te.textContent=T>0?T>10?"In stock":`${T} available`:"Out of stock"),G&&(G.disabled=T<=0),ae&&(ae.disabled=T<=0)})}),x.length>0){let w=x[0];w.setAttribute("aria-checked","true"),e=w.dataset.variantId}}function N(){let a=document.getElementById("add-to-cart-btn"),d=document.getElementById("mobile-add-to-cart");if(!a&&!d)return;let p=async x=>{let w=parseInt(document.getElementById("product-quantity")?.value)||1,T=document.getElementById("stock-status");if(!!document.querySelector(".variant-btn")&&!e){Toast.warning("Please select a variant before adding to cart.");return}x.disabled=!0;let G=x.innerHTML;x.innerHTML='<svg class="animate-spin h-5 w-5" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>';try{let te=document.querySelector(`.variant-btn[data-variant-id="${e}"]`);if((te?parseInt(te.dataset.stock||"0"):n.stock_quantity||0)<=0){Toast.error("This variant is out of stock.");return}await CartApi.addItem(n.id,w,e||null),Toast.success("Added to cart!"),document.dispatchEvent(new CustomEvent("cart:updated"))}catch(te){Toast.error(te.message||"Failed to add to cart.")}finally{x.disabled=!1,x.innerHTML=G}};a?.addEventListener("click",()=>p(a)),d?.addEventListener("click",()=>p(d))}function V(){let a=document.getElementById("add-to-wishlist-btn");a&&a.addEventListener("click",async()=>{if(!AuthApi.isAuthenticated()){Toast.warning("Please login to add items to your wishlist."),window.location.href="/account/login/?next="+encodeURIComponent(window.location.pathname);return}try{await WishlistApi.addItem(n.id),Toast.success("Added to wishlist!"),a.querySelector("svg").setAttribute("fill","currentColor"),a.classList.add("text-red-500"),a.setAttribute("aria-pressed","true")}catch(d){d.message?.includes("already")?Toast.info("This item is already in your wishlist."):Toast.error(d.message||"Failed to add to wishlist.")}})}function E(){let a=document.querySelectorAll(".share-btn"),d=encodeURIComponent(window.location.href),p=encodeURIComponent(n?.name||document.title);a.forEach(x=>{x.addEventListener("click",()=>{let w=x.dataset.platform,T="";switch(w){case"facebook":T=`https://www.facebook.com/sharer/sharer.php?u=${d}`;break;case"twitter":T=`https://twitter.com/intent/tweet?url=${d}&text=${p}`;break;case"pinterest":let U=encodeURIComponent(n?.image||"");T=`https://pinterest.com/pin/create/button/?url=${d}&media=${U}&description=${p}`;break;case"copy":navigator.clipboard.writeText(window.location.href).then(()=>Toast.success("Link copied to clipboard!")).catch(()=>Toast.error("Failed to copy link."));return}T&&window.open(T,"_blank","width=600,height=400")})})}function B(){let a=document.getElementById("add-to-compare-btn");a&&a.addEventListener("click",async()=>{if(typeof AuthApi<"u"&&!AuthApi.isAuthenticated()){Toast.warning("Please login to compare products."),window.location.href="/account/login/?next="+encodeURIComponent(window.location.pathname);return}let d=n?.id||document.getElementById("product-detail")?.dataset.productId;if(d)try{let p=await ApiClient.post("/compare/",{product_id:d},{requiresAuth:!0});p.success?(Toast.success(p.message||"Added to compare"),a.setAttribute("aria-pressed","true"),a.classList.add("text-primary-600"),a.querySelector("svg")?.setAttribute("fill","currentColor")):Toast.error(p.message||"Failed to add to compare")}catch(p){try{let x="b_compare",w=JSON.parse(localStorage.getItem(x)||"[]");if(!w.includes(d)){w.push(d),localStorage.setItem(x,JSON.stringify(w)),Toast.success("Added to compare (local)"),a.setAttribute("aria-pressed","true"),a.classList.add("text-primary-600");return}Toast.info("Already in compare list")}catch{Toast.error(p.message||"Failed to add to compare")}}})}function W(){let a=document.getElementById("add-to-compare-btn");a&&a.addEventListener("click",async d=>{d.preventDefault();let p=document.getElementById("product-detail")?.dataset.productId;if(p)try{if(typeof AuthApi<"u"&&!AuthApi.isAuthenticated()){Toast.warning("Please login to compare products."),window.location.href="/account/login/?next="+encodeURIComponent(window.location.pathname);return}let x=await ApiClient.post("/compare/",{product_id:p},{requiresAuth:!0});x.success?(Toast.success(x.message||"Added to compare"),a.setAttribute("aria-pressed","true"),a.classList.add("text-primary-600"),a.querySelector("svg")?.setAttribute("fill","currentColor")):Toast.error(x.message||"Failed to add to compare")}catch(x){try{let w="b_compare",T=JSON.parse(localStorage.getItem(w)||"[]");if(!T.includes(p)){T.push(p),localStorage.setItem(w,JSON.stringify(T)),Toast.success("Added to compare (local)"),a.setAttribute("aria-pressed","true"),a.classList.add("text-primary-600");return}Toast.info("Already in compare list")}catch{Toast.error(x.message||"Failed to add to compare")}}})}async function O(a){let d=document.getElementById("breadcrumbs");if(!d)return;let p=[{label:"Home",url:"/"},{label:"Products",url:"/products/"}];if(a.category)try{((await CategoriesAPI.getBreadcrumbs(a.category.id)).data||[]).forEach(T=>{p.push({label:T.name,url:`/categories/${T.slug}/`})})}catch{p.push({label:a.category.name,url:`/categories/${a.category.slug}/`})}p.push({label:a.name}),d.innerHTML=Breadcrumb.render(p)}async function P(a){let d=document.getElementById("related-products");if(d)try{let x=(await ProductsAPI.getRelated(a.id,{limit:4})).data||[];if(x.length===0){d.innerHTML="";return}d.innerHTML=`
                <h2 class="text-2xl font-bold text-gray-900 mb-6">You may also like</h2>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                    ${x.map(w=>ProductCard.render(w)).join("")}
                </div>
            `,ProductCard.bindEvents(d)}catch(p){console.error("Failed to load related products:",p),d.innerHTML=""}}async function X(a){let d=document.getElementById("reviews-container");if(d){Loader.show(d,"spinner");try{let x=(await ProductsAPI.getReviews(a.id)).data||[];d.innerHTML=`
                <!-- Review Summary -->
                ...
                `}
            `,document.getElementById("write-review-btn")?.addEventListener("click",()=>{ee(a)})}catch(p){console.error("Failed to load reviews:",p),d.innerHTML='<p class="text-red-500">Failed to load reviews.</p>'}}}function ee(a){Modal.open({title:"Write a Review",content:`
            ...
            `,confirmText:"Submit Review",onConfirm:async()=>{let x=parseInt(document.getElementById("review-rating").value),w=document.getElementById("review-title").value.trim(),T=document.getElementById("review-comment").value.trim();if(!x||x<1)return Toast.error("Please select a rating."),!1;if(!T)return Toast.error("Please write a review."),!1;try{return await ProductsAPI.createReview(a.id,{rating:x,title:w,comment:T}),Toast.success("Thank you for your review!"),X(a),!0}catch(U){return Toast.error(U.message||"Failed to submit review."),!1}}});let d=document.querySelectorAll(".rating-star"),p=document.getElementById("review-rating");d.forEach(x=>{x.addEventListener("click",()=>{let w=parseInt(x.dataset.rating);p.value=w,d.forEach((T,U)=>{U<w?(T.classList.remove("text-gray-300"),T.classList.add("text-yellow-400")):(T.classList.add("text-gray-300"),T.classList.remove("text-yellow-400"))})})})}function re(a){try{document.title=`${a.name} | Bunoraa`;let d=a.meta_description||a.short_description||"";document.querySelector('meta[name="description"]')?.setAttribute("content",d),document.querySelector('meta[property="og:title"]')?.setAttribute("content",a.meta_title||a.name),document.querySelector('meta[property="og:description"]')?.setAttribute("content",d);let p=a.images?.[0]?.image||a.image;p&&document.querySelector('meta[property="og:image"]')?.setAttribute("content",p),document.querySelector('meta[name="twitter:title"]')?.setAttribute("content",a.meta_title||a.name),document.querySelector('meta[name="twitter:description"]')?.setAttribute("content",d)}catch{}}function se(a){try{let d=document.querySelector('script[type="application/ld+json"][data-ld="product"]');if(!d)return;let p={"@context":"https://schema.org","@type":"Product",name:a.name,image:(a.images||[]).map(x=>x.image||x),description:a.short_description||a.description||"",sku:a.sku||"",offers:{"@type":"Offer",url:window.location.href,priceCurrency:a.currency||window.BUNORAA_PRODUCT?.currency||"BDT",price:a.current_price||a.price}};d.textContent=JSON.stringify(p)}catch{}}async function oe(a){let d=document.getElementById("related-products");if(d)try{let[p,x,w]=await Promise.all([ProductsApi.getRecommendations(a.id,"frequently_bought_together",3),ProductsApi.getRecommendations(a.id,"similar",4),ProductsApi.getRecommendations(a.id,"you_may_also_like",6)]);if(p.success&&p.data?.length){let T=`
                    <section class="mt-8">
                        <h3 class="text-lg font-semibold mb-4">Frequently Bought Together</h3>
                        <div class="grid grid-cols-3 gap-3">${(p.data||[]).map(U=>ProductCard.render(U)).join("")}</div>
                    </section>
                `;d.insertAdjacentHTML("beforeend",T)}if(x.success&&x.data?.length){let T=`
                    <section class="mt-8">
                ...
                `;d.insertAdjacentHTML("beforeend",T)}if(w.success&&w.data?.length){let T=`
                    <section class="mt-8">
                ...
                `;d.insertAdjacentHTML("beforeend",T)}ProductCard.bindEvents(d)}catch{}}function le(){if(!document.getElementById("product-detail")||typeof IntersectionObserver>"u")return;let d=new IntersectionObserver(p=>{p.forEach(x=>{if(!x.isIntersecting)return;let w=x.target;w.id,w.id==="reviews"||w.id,d.unobserve(w)})},{rootMargin:"200px"});document.querySelectorAll("#related-products, #reviews").forEach(p=>{d.observe(p)})}async function de(a){try{await ProductsAPI.trackView(a.id)}catch{}}function me(){n=null,e=null,t=null,o=!1}return{init:A,destroy:me}})();window.ProductPage=zs;hr=zs});var Vs={};J(Vs,{default:()=>fr});var Ds,fr,Us=Q(()=>{Ds=(function(){"use strict";let n="",e=1,t={},o=null,g=!1;async function b(){if(g)return;g=!0;let h=document.getElementById("search-results")||document.getElementById("products-grid");if(h&&h.querySelector(".product-card, [data-product-id]")){j(),C(),v(),k();return}n=R(),t=Y(),e=parseInt(new URLSearchParams(window.location.search).get("page"))||1,await A(),j(),C(),v(),k()}function k(){let h=document.getElementById("view-grid"),r=document.getElementById("view-list");h?.addEventListener("click",()=>{h.classList.add("bg-primary-100","text-primary-700"),h.classList.remove("text-gray-400"),r?.classList.remove("bg-primary-100","text-primary-700"),r?.classList.add("text-gray-400"),Storage?.set("productViewMode","grid"),A()}),r?.addEventListener("click",()=>{r.classList.add("bg-primary-100","text-primary-700"),r.classList.remove("text-gray-400"),h?.classList.remove("bg-primary-100","text-primary-700"),h?.classList.add("text-gray-400"),Storage?.set("productViewMode","list"),A()})}async function A(){let h=document.getElementById("search-results")||document.getElementById("products-grid"),r=document.getElementById("results-count")||document.getElementById("product-count");if(h){o&&o.abort(),o=new AbortController,Loader.show(h,"skeleton");try{let s={page:e,pageSize:12,...t};if(n&&(s.search=n),window.location.pathname==="/categories/"){await q();return}let c=await ProductsApi.getProducts(s),u=Array.isArray(c)?c:c.data||c.results||[],m=c.meta||{};r&&(n?r.textContent=`${m.total||u.length} results for "${Templates.escapeHtml(n)}"`:r.textContent=`${m.total||u.length} products`),M(u,m),await D()}catch(s){if(s.name==="AbortError")return;console.error("Failed to load products:",s),h.innerHTML='<p class="text-red-500 text-center py-8">Failed to load products. Please try again.</p>'}}}async function q(){let h=document.getElementById("search-results")||document.getElementById("products-grid"),r=document.getElementById("results-count")||document.getElementById("product-count"),s=document.getElementById("page-title");if(h)try{let i=await CategoriesApi.getCategories({limit:50}),c=Array.isArray(i)?i:i.data||i.results||[];if(s&&(s.textContent="All Categories"),r&&(r.textContent=`${c.length} categories`),c.length===0){h.innerHTML=`
                    <div class="text-center py-16">
                        <svg class="w-24 h-24 text-gray-300 mx-auto mb-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            `}catch(i){console.error("Failed to load categories:",i),h.innerHTML='<p class="text-red-500 text-center py-8">Failed to load categories. Please try again.</p>'}}function R(){return new URLSearchParams(window.location.search).get("q")||""}function Y(){let h=new URLSearchParams(window.location.search),r={};return h.get("category")&&(r.category=h.get("category")),h.get("min_price")&&(r.minPrice=h.get("min_price")),h.get("max_price")&&(r.maxPrice=h.get("max_price")),h.get("ordering")&&(r.ordering=h.get("ordering")),h.get("in_stock")&&(r.inStock=h.get("in_stock")==="true"),h.get("sale")&&(r.onSale=h.get("sale")==="true"),h.get("featured")&&(r.featured=h.get("featured")==="true"),r}function j(){let h=document.getElementById("search-form"),r=document.getElementById("search-input");r&&(r.value=n),h?.addEventListener("submit",c=>{c.preventDefault();let u=r?.value.trim();u&&(n=u,e=1,S(),y())});let s=document.getElementById("search-suggestions"),i=null;r?.addEventListener("input",c=>{let u=c.target.value.trim();if(clearTimeout(i),u.length<2){s&&(s.innerHTML="",s.classList.add("hidden"));return}i=setTimeout(async()=>{try{let l=(await ProductsApi.search({q:u,limit:5})).data||[];s&&l.length>0&&(s.innerHTML=`
                            <div class="py-2">
                                ${l.map(f=>`
                        ...
                        `,s.classList.remove("hidden"))}catch(m){console.error("Search suggestions failed:",m)}},300)}),r?.addEventListener("blur",()=>{setTimeout(()=>{s&&s.classList.add("hidden")},200)})}async function y(){await A()}function M(h,r){let s=document.getElementById("search-results");if(!s)return;if(h.length===0){s.innerHTML=`
                <div class="text-center py-16">
                    <svg class="w-24 h-24 text-gray-300 mx-auto mb-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            `;return}let i=Storage.get("productViewMode")||"grid",c=i==="list"?"space-y-4":"grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6";s.innerHTML=`
            <div class="${c}">
                ${h.map(m=>ProductCard.render(m,{layout:i})).join("")}
            </div>
            ${r.total_pages>1?`
            ...
            `:""}
        `,ProductCard.bindEvents(s),document.getElementById("search-pagination")?.addEventListener("click",m=>{let l=m.target.closest("[data-page]");l&&(e=parseInt(l.dataset.page),S(),y(),window.scrollTo({top:0,behavior:"smooth"}))})}async function D(){let h=document.getElementById("filter-categories");if(h)try{let s=(await CategoriesAPI.getAll({has_products:!0,limit:20})).data||[];h.innerHTML=`
                <div class="space-y-2">
                    <label class="flex items-center">
            ...
            `,_()}catch{}}function _(){document.querySelectorAll('input[name="category"]').forEach(r=>{r.addEventListener("change",s=>{s.target.value?t.category=s.target.value:delete t.category,e=1,S(),y()})})}function C(){let h=document.getElementById("apply-price-filter"),r=document.getElementById("filter-in-stock"),s=document.getElementById("clear-filters");h?.addEventListener("click",()=>{let u=document.getElementById("filter-min-price")?.value,m=document.getElementById("filter-max-price")?.value;u?t.min_price=u:delete t.min_price,m?t.max_price=m:delete t.max_price,e=1,S(),y()}),r?.addEventListener("change",u=>{u.target.checked?t.in_stock=!0:delete t.in_stock,e=1,S(),y()}),s?.addEventListener("click",()=>{t={},e=1,document.querySelectorAll('input[name="category"]').forEach(l=>{l.checked=l.value===""});let u=document.getElementById("filter-min-price"),m=document.getElementById("filter-max-price");u&&(u.value=""),m&&(m.value=""),r&&(r.checked=!1),S(),y()});let i=document.getElementById("filter-min-price"),c=document.getElementById("filter-max-price");i&&t.min_price&&(i.value=t.min_price),c&&t.max_price&&(c.value=t.max_price),r&&t.in_stock&&(r.checked=!0)}function v(){let h=document.getElementById("sort-select");h&&(h.value=t.ordering||"",h.addEventListener("change",r=>{r.target.value?t.ordering=r.target.value:delete t.ordering,e=1,S(),y()}))}function S(){let h=new URLSearchParams;n&&h.set("q",n),t.category&&h.set("category",t.category),t.min_price&&h.set("min_price",t.min_price),t.max_price&&h.set("max_price",t.max_price),t.ordering&&h.set("ordering",t.ordering),t.in_stock&&h.set("in_stock","true"),e>1&&h.set("page",e);let r=`${window.location.pathname}?${h.toString()}`;window.history.pushState({},"",r)}function L(){o&&(o.abort(),o=null),n="",e=1,t={},g=!1}return{init:b,destroy:L}})();window.SearchPage=Ds;fr=Ds});var Ys={};J(Ys,{default:()=>xr});var Ws,xr,Qs=Q(()=>{Ws=(function(){"use strict";let n=1,e="added_desc",t="all";function o(){return window.BUNORAA_CURRENCY?.symbol||"\u09F3"}let g={get CURRENCY_SYMBOL(){return o()},PRIORITY_LEVELS:{low:{label:"Low",color:"gray",icon:"\u25CB"},normal:{label:"Normal",color:"blue",icon:"\u25D0"},high:{label:"High",color:"amber",icon:"\u25CF"},urgent:{label:"Urgent",color:"red",icon:"\u2605"}}};async function b(){AuthGuard.protectPage()&&(await q(),j())}function k(C={}){let v=C.product||C||{},S=[C.product_image,v.product_image,v.primary_image,v.image,Array.isArray(v.images)?v.images[0]:null,v.image_url,v.thumbnail],L=h=>{if(!h)return"";if(typeof h=="string")return h;if(typeof h=="object"){if(typeof h.image=="string"&&h.image)return h.image;if(h.image&&typeof h.image=="object"){if(typeof h.image.url=="string"&&h.image.url)return h.image.url;if(typeof h.image.src=="string"&&h.image.src)return h.image.src}if(typeof h.url=="string"&&h.url)return h.url;if(typeof h.src=="string"&&h.src)return h.src}return""};for(let h of S){let r=L(h);if(r)return r}return""}function A(C={}){let v=C.product||C||{},S=l=>{if(l==null)return null;let f=Number(l);return Number.isFinite(f)?f:null},L=[C.product_price,v.price,C.price,C.current_price,C.price_at_add],h=null;for(let l of L)if(h=S(l),h!==null)break;let r=[C.product_sale_price,v.sale_price,C.sale_price],s=null;for(let l of r)if(s=S(l),s!==null)break;let i=S(C.lowest_price_seen),c=S(C.highest_price_seen),u=S(C.target_price),m=S(C.price_at_add);return{price:h!==null?h:0,salePrice:s!==null?s:null,lowestPrice:i,highestPrice:c,targetPrice:u,priceAtAdd:m}}async function q(){let C=document.getElementById("wishlist-container");if(C){Loader.show(C,"skeleton");try{let v=await WishlistApi.getWishlist({page:n,sort:e}),S=[],L={};Array.isArray(v)?S=v:v&&typeof v=="object"&&(S=v.data||v.results||v.items||[],!Array.isArray(S)&&v.data&&typeof v.data=="object"?(S=v.data.items||v.data.results||[],L=v.data.meta||v.meta||{}):L=v.meta||{}),Array.isArray(S)||(S=S&&typeof S=="object"?[S]:[]);let h=S;t==="on_sale"?h=S.filter(r=>{let s=A(r);return s.salePrice&&s.salePrice<s.price}):t==="in_stock"?h=S.filter(r=>r.is_in_stock!==!1):t==="price_drop"?h=S.filter(r=>{let s=A(r);return s.priceAtAdd&&s.price<s.priceAtAdd}):t==="at_target"&&(h=S.filter(r=>{let s=A(r);return s.targetPrice&&s.price<=s.targetPrice})),R(h,S,L)}catch(v){let S=v&&(v.message||v.detail)||"Failed to load wishlist.";if(v&&v.status===401){AuthGuard.redirectToLogin();return}C.innerHTML=`<p class="text-red-500 text-center py-8">${Templates.escapeHtml(S)}</p>`}}}function R(C,v,S){let L=document.getElementById("wishlist-container");if(!L)return;let h=v.length,r=v.filter(c=>{let u=A(c);return u.salePrice&&u.salePrice<u.price}).length,s=v.filter(c=>{let u=A(c);return u.priceAtAdd&&u.price<u.priceAtAdd}).length,i=v.filter(c=>{let u=A(c);return u.targetPrice&&u.price<=u.targetPrice}).length;if(h===0){L.innerHTML=`
                <div class="text-center py-16">
                    <svg class="w-24 h-24 text-gray-300 mx-auto mb-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        `,S&&S.total_pages>1){let c=document.getElementById("wishlist-pagination");if(c&&window.Pagination){let u=new window.Pagination({totalPages:S.total_pages,currentPage:S.current_page||n,className:"justify-center",onChange:m=>{n=m,q(),window.scrollTo({top:0,behavior:"smooth"})}});c.innerHTML="",c.appendChild(u.create())}}y()}function Y(C){try{let v=C.product||C||{},S=C.product_name||v.name||"",L=C.product_slug||v.slug||"",h=C.is_in_stock!==void 0?C.is_in_stock:v.is_in_stock!==void 0?v.is_in_stock:v.stock_quantity>0,r=k(C||{}),s=!!C.product_has_variants,i={price:0,salePrice:null,lowestPrice:null,highestPrice:null,targetPrice:null,priceAtAdd:null};try{i=A(C||{})}catch{i={price:0,salePrice:null}}let{price:c,salePrice:u,lowestPrice:m,highestPrice:l,targetPrice:f,priceAtAdd:I}=i,$=u||c,N=I&&$<I,V=I?Math.round(($-I)/I*100):0,E=f&&$<=f,B=u&&u<c,W=C.priority||"normal",O=g.PRIORITY_LEVELS[W]||g.PRIORITY_LEVELS.normal,P=se=>{try{return Templates.escapeHtml(se||"")}catch{return String(se||"")}},X=se=>{try{return Price.render({price:se.price,salePrice:se.salePrice})}catch{return`<span class="font-bold">${g.CURRENCY_SYMBOL}${se.price||0}</span>`}},ee=se=>{try{return Templates.formatPrice(se)}catch{return`${g.CURRENCY_SYMBOL}${se}`}},re=v&&v.aspect&&(v.aspect.css||(v.aspect.width&&v.aspect.height?`${v.aspect.width}/${v.aspect.height}`:null))||"1/1";return`
                <div class="wishlist-item relative bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden group" 
                     ...
                     data-product-id="${v&&v.id?v.id:C&&C.product?C.product:""}" 
                    ...
                    <div class="relative" style="aspect-ratio: ${re};">
                        ...
                        <div class="absolute top-2 right-12 z-10">
                            <button class="priority-btn w-8 h-8 rounded-full bg-white dark:bg-gray-700 shadow-md flex items-center justify-center text-${O.color}-500 hover:scale-110 transition-transform" title="Priority: ${O.label}" data-item-id="${C.id}">
                    ...
                    <div class="p-4">
                            ...
                            <div class="mt-2 text-xs space-y-1">
                                ${m?`
                                    <div class="flex items-center justify-between text-gray-500 dark:text-gray-400">
                                        <span>Lowest:</span>
                                        <span class="font-medium text-green-600 dark:text-green-400">${ee(m)}</span>
                                    </div>
                                `:""}
                                ${f?`
                                    <div class="flex items-center justify-between text-gray-500 dark:text-gray-400">
                        ...
                        <div class="mt-4 flex gap-2">
                            ...
                            >
                                ...
                                ${s?"Options":h?"Add":"Sold Out"}
                            </button>
                            <button class="set-target-btn px-3 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-sm" title="Set target price" data-item-id="${C.id}" data-current-price="${$}">
            ...
            `}catch(v){return console.error("Failed to render wishlist item:",v),'<div class="p-4 bg-white dark:bg-gray-800 rounded shadow text-gray-500 dark:text-gray-400">Failed to render item</div>'}}function j(){document.getElementById("wishlist-sort")?.addEventListener("change",C=>{e=C.target.value,q()}),document.querySelectorAll(".filter-btn").forEach(C=>{C.addEventListener("click",()=>{t=C.dataset.filter,q()})})}function y(){let C=document.getElementById("clear-wishlist-btn"),v=document.getElementById("add-all-to-cart-btn"),S=document.getElementById("share-wishlist-btn"),L=document.querySelectorAll(".wishlist-item"),h=document.getElementById("wishlist-sort"),r=document.querySelectorAll(".filter-btn");h?.addEventListener("change",s=>{e=s.target.value,q()}),r.forEach(s=>{s.addEventListener("click",()=>{t=s.dataset.filter,q()})}),C?.addEventListener("click",async()=>{if(await Modal.confirm({title:"Clear Wishlist",message:"Are you sure you want to remove all items from your wishlist?",confirmText:"Clear All",cancelText:"Cancel"}))try{await WishlistApi.clear(),Toast.success("Wishlist cleared."),await q()}catch(i){Toast.error(i.message||"Failed to clear wishlist.")}}),v?.addEventListener("click",async()=>{let s=v;s.disabled=!0,s.innerHTML='<svg class="animate-spin w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>Adding...';try{let i=document.querySelectorAll('.wishlist-item:not([data-product-has-variants="true"])'),c=0,u=0;for(let m of i){let l=m.dataset.productId;if(l)try{await CartApi.addItem(l,1),c++}catch{u++}}c>0&&(Toast.success(`Added ${c} items to cart!`),document.dispatchEvent(new CustomEvent("cart:updated"))),u>0&&Toast.warning(`${u} items could not be added (may require variant selection).`)}catch(i){Toast.error(i.message||"Failed to add items to cart.")}finally{s.disabled=!1,s.innerHTML='<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>Add All to Cart'}}),S?.addEventListener("click",async()=>{try{let s=`${window.location.origin}/wishlist/share/`;navigator.share?await navigator.share({title:"My Wishlist",text:"Check out my wishlist!",url:s}):(await navigator.clipboard.writeText(s),Toast.success("Wishlist link copied to clipboard!"))}catch(s){s.name!=="AbortError"&&Toast.error("Failed to share wishlist.")}}),L.forEach(s=>{let i=s.dataset.itemId,c=s.dataset.productId,u=s.dataset.productSlug;s.querySelector(".remove-btn")?.addEventListener("click",async()=>{try{await WishlistApi.removeItem(i),Toast.success("Removed from wishlist."),s.remove(),document.querySelectorAll(".wishlist-item").length===0&&await q()}catch(m){Toast.error(m.message||"Failed to remove item.")}}),s.querySelector(".priority-btn")?.addEventListener("click",async()=>{let m=["low","normal","high","urgent"],l=s.dataset.priority||"normal",f=m.indexOf(l),I=m[(f+1)%m.length];try{WishlistApi.updateItem&&await WishlistApi.updateItem(i,{priority:I}),s.dataset.priority=I;let $=s.querySelector(".priority-btn"),N=g.PRIORITY_LEVELS[I];$.title=`Priority: ${N.label}`,$.innerHTML=`<span class="text-sm">${N.icon}</span>`,$.className=`priority-btn w-8 h-8 rounded-full bg-white dark:bg-gray-700 shadow-md flex items-center justify-center text-${N.color}-500 hover:scale-110 transition-transform`,Toast.success(`Priority set to ${N.label}`)}catch{Toast.error("Failed to update priority.")}}),s.querySelector(".set-target-btn")?.addEventListener("click",async()=>{let m=parseFloat(s.querySelector(".set-target-btn").dataset.currentPrice)||0,l=`
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="text-lg font-bold text-gray-900 dark:text-white">${g.CURRENCY_SYMBOL}${m.toLocaleString()}</div>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Target Price</label>
                            <div class="flex items-center">
                                <span class="text-gray-500 mr-2">${g.CURRENCY_SYMBOL}</span>
                                <input type="number" id="target-price-input" value="${Math.round(m*.9)}" min="1" max="${m}" class="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-primary-500 focus:border-primary-500">
                            </div>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Suggested: ${g.CURRENCY_SYMBOL}${Math.round(m*.9).toLocaleString()} (10% off)</p>
                        </div>
                    </div>
                `,f=await Modal.open({title:"Set Target Price",content:l,confirmText:"Set Alert",cancelText:"Cancel",onConfirm:async()=>{let I=parseFloat(document.getElementById("target-price-input").value);if(!I||I<=0)return Toast.error("Please enter a valid target price."),!1;try{return WishlistApi.updateItem&&await WishlistApi.updateItem(i,{target_price:I}),Toast.success(`Price alert set for ${g.CURRENCY_SYMBOL}${I.toLocaleString()}`),await q(),!0}catch{return Toast.error("Failed to set price alert."),!1}}})}),s.querySelector(".add-to-cart-btn")?.addEventListener("click",async m=>{let l=m.target.closest(".add-to-cart-btn");if(l.disabled)return;l.disabled=!0;let f=l.innerHTML;if(l.innerHTML='<svg class="animate-spin w-4 h-4" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>',s.dataset.productHasVariants==="true"||s.dataset.productHasVariants==="True"||s.dataset.productHasVariants==="1"){D(s),l.disabled=!1,l.innerHTML=f;return}try{await CartApi.addItem(c,1),Toast.success("Added to cart!"),document.dispatchEvent(new CustomEvent("cart:updated"))}catch($){if(!!($&&($.errors&&$.errors.variant_id||$.message&&typeof $.message=="string"&&$.message.toLowerCase().includes("variant")))&&(Toast.info("This product requires selecting a variant."),u)){window.location.href=`/products/${u}/`;return}Toast.error($.message||"Failed to add to cart.")}finally{l.disabled=!1,l.innerHTML=f}})})}function M(C){let v={};return C.forEach(S=>{v[S.attribute_name]||(v[S.attribute_name]=[]),v[S.attribute_name].push(S)}),Object.entries(v).map(([S,L])=>`
            <div class="mt-4">
                ...
                <div class="flex flex-wrap gap-2 mt-2" id="wishlist-variant-group-${Templates.slugify(S)}">
                    ${L.map((h,r)=>`
                        <button type="button" class="wishlist-modal-variant-btn px-3 py-2 border rounded-lg text-sm transition-colors ${r===0?"border-primary-500 bg-primary-50 text-primary-700":"border-gray-300 hover:border-gray-400"}" data-variant-id="${h.id}" data-price="${h.price_converted??h.price??""}" data-stock="${h.stock_quantity||0}">
        ...
        `).join("")}async function D(C){let v=C.product_slug||C.dataset?.productSlug||"",S=C.product||C.dataset?.productId||"";try{let L;if(typeof ProductsApi<"u"&&ProductsApi.getProduct)L=await ProductsApi.getProduct(v||S);else{let u=window.BUNORAA_CURRENCY&&window.BUNORAA_CURRENCY.code||void 0;L=await ApiClient.get(`/catalog/products/${v||S}/`,{currency:u})}if(!L||!L.success||!L.data){let u=L&&L.message?L.message:"Failed to load product variants.";Toast.error(u);return}let h=L.data,r=h.variants||[];if(!r.length){window.location.href=`/products/${h.slug||v||S}/`;return}let s=h.images?.[0]?.image||h.primary_image||h.image||"",i=`
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="col-span-1">
                        ${s?`<img src="${s}" class="w-full h-48 object-cover rounded" alt="${Templates.escapeHtml(h.name)}">`:'<div class="w-full h-48 bg-gray-100 rounded"></div>'}
                    </div>
                    <div class="col-span-2">
                        <h3 class="text-lg font-semibold">${Templates.escapeHtml(h.name)}</h3>
                        <div id="wishlist-variant-price" class="mt-2 text-lg font-bold">${Templates.formatPrice(r?.[0]?.price_converted??r?.[0]?.price??h.price)}</div>
            ...
            `,c=await Modal.open({title:"Select Variant",content:i,confirmText:"Add to Cart",cancelText:"Cancel",size:"md",onConfirm:async()=>{let m=document.querySelector(".wishlist-modal-variant-btn.border-primary-500")||document.querySelector(".wishlist-modal-variant-btn");if(!m)return Toast.error("Please select a variant."),!1;let l=m.dataset.variantId,f=parseInt(document.getElementById("wishlist-variant-qty")?.value)||1;try{return await CartApi.addItem(h.id,f,l),Toast.success("Added to cart!"),document.dispatchEvent(new CustomEvent("cart:updated")),!0}catch(I){return Toast.error(I.message||"Failed to add to cart."),!1}}});setTimeout(()=>{let u=document.querySelectorAll(".wishlist-modal-variant-btn");u.forEach(l=>{l.addEventListener("click",()=>{u.forEach(I=>I.classList.remove("border-primary-500","bg-primary-50","text-primary-700")),l.classList.add("border-primary-500","bg-primary-50","text-primary-700");let f=l.dataset.price;if(f!==void 0){let I=document.getElementById("wishlist-variant-price");I&&(I.textContent=Templates.formatPrice(f))}})});let m=document.querySelector(".wishlist-modal-variant-btn");m&&m.click()},20)}catch{Toast.error("Failed to load variants.")}}function _(){n=1}return{init:b,destroy:_}})();window.WishlistPage=Ws;xr=Ws});var br,Ye=Q(()=>{br=Ge({"./pages/account.js":()=>Promise.resolve().then(()=>(hs(),gs)),"./pages/cart.js":()=>Promise.resolve().then(()=>(bs(),xs)),"./pages/category.js":()=>Promise.resolve().then(()=>(ws(),ys)),"./pages/checkout.js":()=>Promise.resolve().then(()=>(Es(),Cs)),"./pages/contact.js":()=>Promise.resolve().then(()=>(Ts(),$s)),"./pages/faq.js":()=>Promise.resolve().then(()=>(Ss(),Bs)),"./pages/home.js":()=>Promise.resolve().then(()=>(Hs(),qs)),"./pages/orders.js":()=>Promise.resolve().then(()=>(Ns(),js)),"./pages/preorders.js":()=>Promise.resolve().then(()=>rr(Fs())),"./pages/product.js":()=>Promise.resolve().then(()=>(Rs(),Os)),"./pages/search.js":()=>Promise.resolve().then(()=>(Us(),Vs)),"./pages/wishlist.js":()=>Promise.resolve().then(()=>(Qs(),Ys))})});var vr=Je(()=>{ms();Ye();var Qe=(function(){"use strict";let n={},e=null,t=null;async function o(L){try{let h=await br(`./pages/${L}.js`);return h.default||h}catch{return null}}function g(){q(),R(),Y(),j(),b(),D(),C(),v();try{let L=performance.getEntriesByType?performance.getEntriesByType("navigation"):[],h=L&&L[0]||null;h&&h.type==="navigate"&&!window.location.hash&&setTimeout(()=>{let r=document.scrollingElement||document.documentElement;if(!r)return;let s=r.scrollTop||window.pageYOffset||0,i=Math.max(0,r.scrollHeight-window.innerHeight);s>Math.max(100,i*.6)&&window.scrollTo({top:0,behavior:"auto"})},60)}catch{}}async function b(){try{if(!AuthApi.isAuthenticated()){let s=localStorage.getItem("wishlist");if(s){let i=JSON.parse(s);WishlistApi.updateBadge(i);let c=i.items||i.data&&i.data.items||[];A(c)}else A([]);return}let h=(await WishlistApi.getWishlist({pageSize:200})).data||{},r=h.items||h.data||[];WishlistApi.updateBadge(h),A(r)}catch{try{let h=localStorage.getItem("wishlist");if(h){let r=JSON.parse(h);WishlistApi.updateBadge(r);let s=r.items||r.data&&r.data.items||[];A(s)}}catch{}}}let k=[];function A(L){try{k=L||[];let h={},r={};(L||[]).forEach(s=>{let i=s.product||s.product_id||s.product&&s.product.id||null,c=s.product_slug||s.product&&s.product.slug||null,u=s.id||s.pk||s.uuid||s.item||null;i&&(h[String(i)]=u||!0),c&&(r[String(c)]=u||!0)}),document.querySelectorAll(".wishlist-btn").forEach(s=>{try{let i=s.querySelector("svg"),c=i?.querySelector(".heart-fill"),u=s.dataset.productId||s.closest("[data-product-id]")?.dataset.productId,m=s.dataset.productSlug||s.closest("[data-product-slug]")?.dataset.productSlug,l=null;u&&h.hasOwnProperty(String(u))?l=h[String(u)]:m&&r.hasOwnProperty(String(m))&&(l=r[String(m)]),l?(s.dataset.wishlistItemId=l,s.classList.add("text-red-500"),s.setAttribute("aria-pressed","true"),i?.classList.add("fill-current"),c&&(c.style.opacity="1")):(s.removeAttribute("data-wishlist-item-id"),s.classList.remove("text-red-500"),s.setAttribute("aria-pressed","false"),i?.classList.remove("fill-current"),c&&(c.style.opacity="0"))}catch{}})}catch{}}(function(){if(typeof MutationObserver>"u")return;let L=null;new MutationObserver(function(r){let s=!1;for(let i of r){if(i.addedNodes&&i.addedNodes.length){for(let c of i.addedNodes)if(c.nodeType===1&&(c.matches?.(".product-card")||c.querySelector?.(".product-card")||c.querySelector?.(".wishlist-btn"))){s=!0;break}}if(s)break}s&&(clearTimeout(L),L=setTimeout(()=>{try{A(k)}catch{}},150))}).observe(document.body,{childList:!0,subtree:!0})})();function q(){let L=window.location.pathname,h=document.body;if(h.dataset.page){e=h.dataset.page;return}if((L.startsWith("/accounts/")||L.startsWith("/account/"))&&!(L.startsWith("/accounts/profile")||L.startsWith("/account/profile"))){e=null;return}L==="/"||L==="/home/"?e="home":L==="/categories/"||L==="/products/"?e="search":L.startsWith("/categories/")&&L!=="/categories/"?e="category":L.startsWith("/products/")&&L!=="/products/"?e="product":L==="/search/"||L.startsWith("/search")?e="search":L.startsWith("/cart")?e="cart":L.startsWith("/checkout")?e="checkout":L==="/account"||L.startsWith("/account/")||L.startsWith("/accounts/profile")?e="account":L.startsWith("/orders")?e="orders":L.startsWith("/wishlist")?e="wishlist":L.startsWith("/contact")&&(e="contact")}function R(){typeof Tabs<"u"&&document.querySelector("[data-tabs]")&&Tabs.init(),typeof Dropdown<"u"&&document.querySelectorAll("[data-dropdown-trigger]").forEach(L=>{let h=L.dataset.dropdownTarget,r=document.getElementById(h);r&&Dropdown.create(L,{content:r.innerHTML})});try{us()}catch{}}async function Y(){if(!e)return;try{t&&typeof t.destroy=="function"&&t.destroy()}catch{}let L=await o(e);if(L&&typeof L.init=="function"){t=L;try{await t.init()}catch(h){console.error("failed to init page controller",h)}}}try{"serviceWorker"in navigator&&navigator.serviceWorker.register("/static/js/sw.js").catch(()=>{})}catch{}async function j(){if(document.querySelectorAll("[data-cart-count]").length)try{let r=(await CartApi.getCart()).data?.item_count||0;try{localStorage.setItem("cart",JSON.stringify({item_count:r,savedAt:Date.now()}))}catch{}M(r)}catch{try{let r=localStorage.getItem("cart");if(r){let i=JSON.parse(r)?.item_count||0;M(i);return}}catch(r){console.error("Failed to get cart count fallback:",r)}}}async function y(L){try{return(((await WishlistApi.getWishlist({pageSize:200})).data||{}).items||[]).find(c=>String(c.product)===String(L))?.id||null}catch{return null}}function M(L){document.querySelectorAll("[data-cart-count]").forEach(r=>{r.textContent=L>99?"99+":L,r.classList.toggle("hidden",L===0)})}function D(){document.addEventListener("cart:updated",async()=>{await j()}),document.addEventListener("wishlist:updated",async()=>{await b()}),document.addEventListener("auth:login",()=>{_(!0)}),document.addEventListener("auth:logout",()=>{_(!1)}),document.querySelectorAll(".wishlist-btn").forEach(h=>{try{let r=h.querySelector("svg"),s=r?.querySelector(".heart-fill");h.classList.contains("text-red-500")?(r?.classList.add("fill-current"),s&&(s.style.opacity="1")):s&&(s.style.opacity="0")}catch{}}),document.addEventListener("click",async h=>{let r=h.target.closest("[data-quick-add], [data-add-to-cart], .add-to-cart-btn");if(r){h.preventDefault();let s=r.dataset.productId||r.dataset.quickAdd||r.dataset.addToCart;if(!s)return;r.disabled=!0;let i=r.innerHTML;r.innerHTML='<svg class="animate-spin h-4 w-4 mx-auto" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>';try{await CartApi.addItem(s,1),Toast.success("Added to cart!"),document.dispatchEvent(new CustomEvent("cart:updated"))}catch(c){Toast.error(c.message||"Failed to add to cart.")}finally{r.disabled=!1,r.innerHTML=i}}}),document.addEventListener("click",async h=>{let r=h.target.closest("[data-wishlist-toggle], .wishlist-btn");if(r){if(h.preventDefault(),!AuthApi.isAuthenticated()){Toast.warning("Please login to add items to your wishlist."),window.location.href="/account/login/?next="+encodeURIComponent(window.location.pathname);return}let s=r.dataset.wishlistToggle||r.dataset.productId||r.closest("[data-product-id]")?.dataset.productId;r.disabled=!0;let i=r.dataset.wishlistItemId||"";!i&&r.classList.contains("text-red-500")&&(i=await y(s)||"");let u=r.classList.contains("text-red-500")&&i;try{if(u){let m=await WishlistApi.removeItem(i);r.classList.remove("text-red-500"),r.setAttribute("aria-pressed","false"),r.querySelector("svg")?.classList.remove("fill-current");let l=r.querySelector("svg")?.querySelector(".heart-fill");l&&(l.style.opacity="0"),r.removeAttribute("data-wishlist-item-id"),Toast.success("Removed from wishlist.")}else{let m=await WishlistApi.addItem(s),l=m.data?.id||m.data?.item?.id||await y(s);l&&(r.dataset.wishlistItemId=l),r.classList.add("text-red-500"),r.setAttribute("aria-pressed","true"),r.querySelector("svg")?.classList.add("fill-current");let f=r.querySelector("svg")?.querySelector(".heart-fill");f&&(f.style.opacity="1"),Toast.success(m.message||"Added to wishlist!")}}catch(m){console.error("wishlist:error",m),Toast.error(m.message||"Failed to update wishlist.")}finally{r.disabled=!1}}}),document.addEventListener("click",h=>{let r=h.target.closest("[data-quick-view], .quick-view-btn");if(r){h.preventDefault();let s=r.dataset.quickView||r.dataset.productId,i=r.dataset.productSlug;i?window.location.href=`/products/${i}/`:s&&(typeof Modal<"u"&&Modal.showQuickView?Modal.showQuickView(s):window.location.href=`/products/${s}/`)}}),document.addEventListener("click",async h=>{if(h.target.closest("[data-logout]")){h.preventDefault();try{await AuthApi.logout(),Toast.success("Logged out successfully."),document.dispatchEvent(new CustomEvent("auth:logout")),window.location.href="/"}catch{Toast.error("Failed to logout.")}}});let L=document.getElementById("back-to-top");L&&(window.addEventListener("scroll",Debounce.throttle(()=>{window.scrollY>500?L.classList.remove("opacity-0","pointer-events-none"):L.classList.add("opacity-0","pointer-events-none")},100)),L.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})}))}function _(L){document.querySelectorAll("[data-auth-state]").forEach(r=>{let s=r.dataset.authState;s==="logged-in"?r.classList.toggle("hidden",!L):s==="logged-out"&&r.classList.toggle("hidden",L)})}function C(){let L=document.getElementById("mobile-menu-btn"),h=document.getElementById("close-mobile-menu"),r=document.getElementById("mobile-menu"),s=document.getElementById("mobile-menu-overlay");function i(){r?.classList.remove("translate-x-full"),s?.classList.remove("hidden"),document.body.classList.add("overflow-hidden")}function c(){r?.classList.add("translate-x-full"),s?.classList.add("hidden"),document.body.classList.remove("overflow-hidden")}L?.addEventListener("click",i),h?.addEventListener("click",c),s?.addEventListener("click",c)}function v(){let L=document.querySelector("[data-language-selector]"),h=document.getElementById("language-dropdown");L&&h&&(Dropdown.create(L,h),h.querySelectorAll("[data-language]").forEach(r=>{r.addEventListener("click",async()=>{let s=r.dataset.language;try{await LocalizationApi.setLanguage(s),Storage.set("language",s),window.location.reload()}catch{Toast.error("Failed to change language.")}})}))}function S(){t&&typeof t.destroy=="function"&&t.destroy(),e=null,t=null}return{init:g,destroy:S,getCurrentPage:()=>e,updateCartBadge:M}})();document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Qe.init):Qe.init();window.App=Qe});vr();})();
